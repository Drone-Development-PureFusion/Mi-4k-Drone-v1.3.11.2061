...
public class C10847a {

    /* renamed from: a */
    static String f34729a = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";

    /* renamed from: b */
    static char f34730b = SignatureVisitor.INSTANCEOF;
    ...
    public static void m3143a(InputStream inputStream, OutputStream outputStream, int i) {
        C10849c c10849c = new C10849c(outputStream, i);
        m3133c(inputStream, c10849c);
        c10849c.m3131a();
    }
    ...
    public static void m3137b(InputStream inputStream, OutputStream outputStream) {
        m3133c(new C10848b(inputStream), outputStream);
    }
