...
public final class C10887a {
    ...
    /* renamed from: a */
    private static final Random f34896a = new Random();

    /* renamed from: b */
    private static final float f34897b = 0.017453292f;

    /* renamed from: c */
    private static final float f34898c = 57.295784f;
    ...
    public static int m2968a(int i) {
        return (int) (f34896a.nextFloat() * i);
    }
    ...
    public static int m2955c(int i, int i2) {
        return i >= i2 ? i : (int) ((f34896a.nextFloat() * (i2 - i)) + i);
    }
    ...
    public static float m2946f(float f, float f2) {
        return f >= f2 ? f : f + (f34896a.nextFloat() * (f2 - f));
    }
