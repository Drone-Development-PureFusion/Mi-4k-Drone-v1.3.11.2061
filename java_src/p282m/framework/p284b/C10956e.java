...
public class C10956e {
    ...
    /* renamed from: a */
    private static Handler f35335a;

    /* renamed from: a */
    public static void m2500a() {
        if (f35335a == null) {
            f35335a = new Handler(new Handler.Callback() { // from class: m.framework.b.e.1
                @Override // android.os.Handler.Callback
                public boolean handleMessage(Message message) {
                    C10956e.m2492b(message);
                    return false;
                }
            });
        }
    ...
    public static boolean m2494b(int i, long j, Handler.Callback callback) {
        return f35335a.sendMessageDelayed(m2493b(i, callback), j);
    }

    /* renamed from: b */
    public static boolean m2491b(Message message, long j, Handler.Callback callback) {
        return f35335a.sendMessageAtTime(m2489c(message, callback), j);
    }

    /* renamed from: b */
    public static boolean m2490b(Message message, Handler.Callback callback) {
        return f35335a.sendMessageAtFrontOfQueue(m2489c(message, callback));
    }
