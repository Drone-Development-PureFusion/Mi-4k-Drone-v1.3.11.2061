...
public class C10958f {

    /* renamed from: a */
    private static float f35336a;
    ...
    public static int m2487a(Context context, int i) {
        if (f35336a <= 0.0f) {
            f35336a = context.getResources().getDisplayMetrics().density;
        }
        return (int) ((i * f35336a) + 0.5f);
    }
    ...
    public static String m2486a(Context context, String str) {
        ...
        if (new C10953b(context).m2525u()) {
            str2 = String.valueOf(c10953b.m2524v()) + "/mFramework/" + c10953b.m2531o() + "/cache/";
        }
