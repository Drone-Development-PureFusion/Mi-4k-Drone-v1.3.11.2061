...
public class C10952a {
    ...
    /* renamed from: a */
    private static final String f35330a = "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";

    /* renamed from: b */
    private static C10955d f35331b = new C10955d();
    ...
    public static String m2561a(long j) {
        ...
        while (j > 0) {
            j /= 62;
            str = String.valueOf(f35330a.charAt((int) (j % 62))) + str;
        }
        return str;
    }
