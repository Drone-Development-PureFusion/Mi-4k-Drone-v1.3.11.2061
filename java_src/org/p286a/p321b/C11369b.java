...
public final class C11369b {
    ...
    /* renamed from: a */
    private static final Comparator f36461a = new C11370a();

    /* renamed from: org.a.b.b$a */
    /* loaded from: classes2.dex */
    private static class C11370a implements Comparator {
        private C11370a() {
        }
        ...
        public int compare(Object obj, Object obj2) {
            ...
            return obj instanceof List ? C11369b.m1273a((List) obj, (List) obj2) : obj instanceof Set ? C11369b.m1271a((Set) obj, (Set) obj2) : obj instanceof Map ? C11369b.m1272a((Map) obj, (Map) obj2) : obj instanceof byte[] ? C11369b.m1268a((byte[]) obj, (byte[]) obj2) : C11369b.m1278a((Comparable) obj, (Comparable) obj2);
        }
    }
    ...
    public static int m1273a(List list, List list2) {
        ...
        for (int i = 0; i < list.size(); i++) {
            int compare = f36461a.compare(list.get(i), list2.get(i));
            if (compare != 0) {
                return compare;
            }
        }
    ...
    public static int m1272a(Map map, Map map2) {
        ...
        TreeMap treeMap = new TreeMap(f36461a);
        treeMap.putAll(map);
        Iterator it2 = treeMap.entrySet().iterator();
        TreeMap treeMap2 = new TreeMap(f36461a);
        treeMap2.putAll(map2);
        Iterator it3 = treeMap2.entrySet().iterator();
        while (it2.hasNext() && it3.hasNext()) {
            Map.Entry entry = (Map.Entry) it2.next();
            Map.Entry entry2 = (Map.Entry) it3.next();
            int compare = f36461a.compare(entry.getKey(), entry2.getKey());
            if (compare != 0) {
                return compare;
            }
            int compare2 = f36461a.compare(entry.getValue(), entry2.getValue());
            if (compare2 != 0) {
                return compare2;
            }
        }
    ...
    public static int m1271a(Set set, Set set2) {
        ...
        TreeSet treeSet = new TreeSet(f36461a);
        treeSet.addAll(set);
        TreeSet treeSet2 = new TreeSet(f36461a);
        treeSet2.addAll(set2);
        Iterator it2 = treeSet.iterator();
        Iterator it3 = treeSet2.iterator();
        while (it2.hasNext() && it3.hasNext()) {
            int compare = f36461a.compare(it2.next(), it3.next());
            if (compare != 0) {
                return compare;
            }
        }
    ...
    public static String m1283a(byte b) {
        return Integer.toHexString((b | 256) & AbstractC0877l.f1839e).toUpperCase().substring(1);
    }
