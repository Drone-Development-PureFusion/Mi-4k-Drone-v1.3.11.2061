...
public final class C11357d {
    ...
    public static String m1305a(HttpEntity httpEntity, Charset charset) {
        ...
        boolean z = false;
        C11354a.m1321a(httpEntity, "Entity");
        ...
        if (content != null) {
            try {
                ...
                C11354a.m1319a(z, "HTTP entity too large to be buffered in memory");
    ...
    public static void m1304a(HttpResponse httpResponse, HttpEntity httpEntity) {
        C11354a.m1321a(httpResponse, "Response");
