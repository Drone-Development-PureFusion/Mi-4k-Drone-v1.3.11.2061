...
public abstract class AbstractC11111a implements X509HostnameVerifier {

    /* renamed from: a */
    private static final String[] f35774a = {"ac", C10445j.f32459ae, "com", "ed", "edu", "go", "gouv", "gov", C10445j.f32461ag, "lg", "ne", "net", "or", "org"};

    /* renamed from: b */
    private static final String f35775b = "HttpClient";
    ...
    public static boolean m2011a(String str) {
        ...
        return (split.length == 3 && split[2].length() == 2 && Arrays.binarySearch(f35774a, split[1]) >= 0) ? false : true;
    }
    ...
    static String[] m2006c(String str) {
        ...
        List<NameValuePair> m2001a = C11114d.f35776a.m2001a(str);
        int i = 0;
        while (true) {
            int i2 = i;
            if (i2 >= m2001a.size()) {
    ...
    private static boolean m2004e(String str) {
        return str != null && (C11129a.m1963a(str) || C11129a.m1959e(str));
    }

    /* renamed from: f */
    private String m2003f(String str) {
        if (str == null || !C11129a.m1959e(str)) {
            return str;
        }
        try {
            return InetAddress.getByName(str).getHostAddress();
        } catch (UnknownHostException e) {
            Log.e(f35775b, "Unexpected error converting " + str, e);
            return str;
        }
    }
    ...
    public final void m2010a(String str, String[] strArr, String[] strArr2, boolean z) {
        ...
        while (it2.hasNext()) {
            ...
            if (split.length >= 3 && split[0].endsWith(AbstractC11759f.f37104a) && mo2002b(lowerCase) && !m2004e(str)) {
                String str3 = split[0];
                if (str3.length() > 1) {
