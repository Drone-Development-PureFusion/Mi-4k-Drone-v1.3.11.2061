...
public class C11326d implements LineParser {
    @Deprecated

    /* renamed from: a */
    public static final C11326d f36377a = new C11326d();

    /* renamed from: b */
    public static final C11326d f36378b = new C11326d();

    /* renamed from: c */
    protected final ProtocolVersion f36379c;

    public C11326d() {
        this(null);
    }

    public C11326d(ProtocolVersion protocolVersion) {
        this.f36379c = protocolVersion == null ? HttpVersion.HTTP_1_1 : protocolVersion;
    }

    /* renamed from: a */
    public static ProtocolVersion m1434a(String str, LineParser lineParser) {
        C11354a.m1321a(str, "Value");
    ...
    protected ProtocolVersion m1436a(int i, int i2) {
        return this.f36379c.forVersion(i, i2);
    }
    ...
    public boolean hasProtocolVersion(CharArrayBuffer charArrayBuffer, ParserCursor parserCursor) {
        ...
        int pos = parserCursor.getPos();
        String protocol = this.f36379c.getProtocol();
