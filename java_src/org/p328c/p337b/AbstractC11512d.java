...
public abstract class AbstractC11512d {
    /* renamed from: a */
    private int m895a(Object obj, Object obj2, String str) {
        if (obj == null) {
            C11565c.m757a(str + "expected array was null");
        }
        if (obj2 == null) {
            C11565c.m757a(str + "actual array was null");
        }
        int length = Array.getLength(obj2);
        int length2 = Array.getLength(obj);
        if (length != length2) {
            C11565c.m757a(str + "array lengths differed, expected.length=" + length2 + " actual.length=" + length);
        }
        return length2;
    }
