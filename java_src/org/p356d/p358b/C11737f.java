...
public final class C11737f {

    /* renamed from: a */
    static final char f37043a = '{';

    /* renamed from: b */
    static final char f37044b = '}';

    /* renamed from: c */
    static final String f37045c = "{}";

    /* renamed from: d */
    private static final char f37046d = '\\';
    ...
    /* renamed from: a */
    public static final C11735d m156a(String str, Object obj) {
        return m154a(str, new Object[]{obj});
    }

    /* renamed from: a */
    public static final C11735d m155a(String str, Object obj, Object obj2) {
        return m154a(str, new Object[]{obj, obj2});
    }

    /* renamed from: a */
    public static final C11735d m154a(String str, Object[] objArr) {
    ...
    /* renamed from: a */
    public static final C11735d m153a(String str, Object[] objArr, Throwable th) {
        int i = 0;
        if (str == null) {
            return new C11735d(null, objArr, th);
        }
        if (objArr == null) {
            return new C11735d(str);
        }
        StringBuilder sb = new StringBuilder(str.length() + 50);
        int i2 = 0;
        while (i < objArr.length) {
            int indexOf = str.indexOf(f37045c, i2);
            if (indexOf == -1) {
                if (i2 == 0) {
                    return new C11735d(str, objArr, th);
                }
                sb.append((CharSequence) str, i2, str.length());
                return new C11735d(sb.toString(), objArr, th);
            }
    ...
    private static void m152a(StringBuilder sb, Object obj) {
        try {
            ...
            C11744m.m123a("SLF4J: Failed toString() invocation on an object of type [" + obj.getClass().getName() + "]", th);
