...
public class ClassReader {
    ...
    /* renamed from: b */
    public final byte[] f36863b;

    /* renamed from: c */
    private final String[] f36864c;

    /* renamed from: d */
    private final int f36865d;
    ...
    public ClassReader(String str) {
        this(ClassLoader.getSystemResourceAsStream(new StringBuffer().append(str.replace(C0494h.f686G, '/')).append(".class").toString()));
    }
    ...
    public ClassReader(byte[] bArr, int i, int i2) {
        ...
        this.f36863b = bArr;
        this.f36862a = new int[readUnsignedShort(i + 8)];
        int length = this.f36862a.length;
        this.f36864c = new String[length];
        int i3 = 0;
        int i4 = 1;
        int i5 = i + 10;
        while (i4 < length) {
            this.f36862a[i4] = i5 + 1;
            switch (bArr[i5]) {
                case 1:
    ...
    private int m264a(int i, char[] cArr, String str, AnnotationVisitor annotationVisitor) {
        ...
        if (annotationVisitor == null) {
            switch (this.f36863b[i] & SmileConstants.BYTE_MARKER_END_OF_CONTENT) {
                case 64:
        ...
        switch (this.f36863b[i] & SmileConstants.BYTE_MARKER_END_OF_CONTENT) {
            ...
            case 66:
                annotationVisitor.visit(str, new Byte((byte) readInt(this.f36862a[readUnsignedShort(i3)])));
                return i3 + 2;
            case 67:
                annotationVisitor.visit(str, new Character((char) readInt(this.f36862a[readUnsignedShort(i3)])));
                return i3 + 2;
            case 68:
            case 70:
            case 73:
            case 74:
                ...
                return i3 + 2;
            case 83:
                annotationVisitor.visit(str, new Short((short) readInt(this.f36862a[readUnsignedShort(i3)])));
                return i3 + 2;
            case 90:
                annotationVisitor.visit(str, readInt(this.f36862a[readUnsignedShort(i3)]) == 0 ? Boolean.FALSE : Boolean.TRUE);
                return i3 + 2;
            case 91:
                ...
                int i5 = i4 + 1;
                switch (this.f36863b[i4] & SmileConstants.BYTE_MARKER_END_OF_CONTENT) {
                    case 66:
                        byte[] bArr = new byte[readUnsignedShort];
                        while (i2 < readUnsignedShort) {
                            bArr[i2] = (byte) readInt(this.f36862a[readUnsignedShort(i5)]);
                            i5 += 3;
                            i2++;
                        }
                    ...
                    case 67:
                        ...
                        while (i2 < readUnsignedShort) {
                            cArr2[i2] = (char) readInt(this.f36862a[readUnsignedShort(i5)]);
                            i5 += 3;
                            i2++;
                        }
                    ...
                    case 68:
                        ...
                        while (i2 < readUnsignedShort) {
                            dArr[i2] = Double.longBitsToDouble(readLong(this.f36862a[readUnsignedShort(i5)]));
                            i5 += 3;
                            i2++;
                        }
                    ...
                    case 70:
                        ...
                        while (i2 < readUnsignedShort) {
                            fArr[i2] = Float.intBitsToFloat(readInt(this.f36862a[readUnsignedShort(i5)]));
                            i5 += 3;
                            i2++;
                        }
                    ...
                    case 73:
                        ...
                        while (i2 < readUnsignedShort) {
                            iArr[i2] = readInt(this.f36862a[readUnsignedShort(i5)]);
                            i5 += 3;
                            i2++;
                        }
                    ...
                    case 74:
                        ...
                        while (i2 < readUnsignedShort) {
                            jArr[i2] = readLong(this.f36862a[readUnsignedShort(i5)]);
                            i5 += 3;
                            i2++;
                        }
                    ...
                    case 83:
                        ...
                        while (i2 < readUnsignedShort) {
                            sArr[i2] = (short) readInt(this.f36862a[readUnsignedShort(i5)]);
                            i5 += 3;
                            i2++;
                        }
                    ...
                    case 90:
                        ...
                        for (int i7 = 0; i7 < readUnsignedShort; i7++) {
                            zArr[i7] = readInt(this.f36862a[readUnsignedShort(i6)]) != 0;
                            i6 += 3;
                        }
    ...
    private int m260a(Object[] objArr, int i, int i2, char[] cArr, Label[] labelArr) {
        int i3 = i2 + 1;
        switch (this.f36863b[i2] & SmileConstants.BYTE_MARKER_END_OF_CONTENT) {
            case 0:
    ...
    private void m265a(int i, String str, char[] cArr, boolean z, MethodVisitor methodVisitor) {
        int i2 = i + 1;
        int i3 = this.f36863b[i] & SmileConstants.BYTE_MARKER_END_OF_CONTENT;
    ...
    public void m261a(ClassWriter classWriter) {
        int i;
        char[] cArr = new char[this.f36865d];
        int length = this.f36862a.length;
        Item[] itemArr = new Item[length];
        int i2 = 1;
        while (i2 < length) {
            int i3 = this.f36862a[i2];
            byte b = this.f36863b[i3 - 1];
            Item item = new Item(i2);
            switch (b) {
                case 1:
                    String str = this.f36864c[i2];
                    if (str == null) {
                        int i4 = this.f36862a[i2];
                        String[] strArr = this.f36864c;
                ...
                case 10:
                case 11:
                    int i5 = this.f36862a[readUnsignedShort(i3 + 2)];
            ...
            int length2 = item.f36936j % itemArr.length;
            item.f36937k = itemArr[length2];
            itemArr[length2] = item;
            i2 = i + 1;
        }
        int i6 = this.f36862a[1] - 1;
        classWriter.f36878d.putByteArray(this.f36863b, i6, this.header - i6);
        classWriter.f36879e = itemArr;
        classWriter.f36880f = (int) (0.75d * length);
        classWriter.f36877c = length;
    }
    ...
    public void accept(ClassVisitor classVisitor, Attribute[] attributeArr, int i) {
        ...
        int i37 = this.f36862a[readUnsignedShort(i36 + 4)];
        ...
        while (readUnsignedShort7 > 0) {
            ...
            if ("SourceFile".equals(readUTF82)) {
                ...
                if (readUnsignedShort8 != 0) {
                    str2 = readUTF8(this.f36862a[readUnsignedShort8], cArr);
                    str = readUTF8(this.f36862a[readUnsignedShort8] + 2, cArr);
                } else {
                    str = str11;
                    str2 = str10;
                }
        ...
        while (attribute5 != null) {
            Attribute attribute6 = attribute5.f36857a;
            attribute5.f36857a = null;
        ...
        for (int readUnsignedShort11 = readUnsignedShort(i2); readUnsignedShort11 > 0; readUnsignedShort11--) {
            ...
            if (visitField != null) {
                ...
                while (attribute7 != null) {
                    Attribute attribute8 = attribute7.f36857a;
                    attribute7.f36857a = null;
        ...
        for (int readUnsignedShort15 = readUnsignedShort(i49); readUnsignedShort15 > 0; readUnsignedShort15--) {
            ...
            if (visitMethod != null) {
                if (visitMethod instanceof MethodWriter) {
                    ...
                    if (methodWriter.f36970b.f36875J == this && str13 == methodWriter.f36975g) {
                        boolean z6 = false;
                        if (strArr == null) {
                            z2 = methodWriter.f36978j == 0;
                        } else {
                            if (strArr.length == methodWriter.f36978j) {
                                z6 = true;
                                int i68 = i3;
                                for (int length = strArr.length - 1; length >= 0; length--) {
                                    i68 -= 2;
                                    if (methodWriter.f36979k[length] != readUnsignedShort(i68)) {
                                        z2 = false;
                                    }
                                }
                            }
                        ...
                        if (z2) {
                            methodWriter.f36976h = i57;
                            methodWriter.f36977i = i56 - i57;
                        }
                    }
                }
                if (i60 != 0) {
                ...
                while (attribute9 != null) {
                    Attribute attribute10 = attribute9.f36857a;
                    attribute9.f36857a = null;
            ...
            if (visitMethod != null && i63 != 0) {
                ...
                while (i74 < i73) {
                    int i75 = i74 - i72;
                    switch (ClassWriter.f36866a[bArr[i74] & SmileConstants.BYTE_MARKER_END_OF_CONTENT]) {
                        case 0:
                        case 4:
                            i18 = i74 + 1;
                            break;
                ...
                for (int readUnsignedShort21 = readUnsignedShort(i74); readUnsignedShort21 > 0; readUnsignedShort21--) {
                    ...
                    if (readUnsignedShort22 == 0) {
                        ...
                        visitMethod.visitTryCatchBlock(readLabel, readLabel2, readLabel3, readUTF8(this.f36862a[readUnsignedShort22], cArr));
                    }
                    i78 += 8;
                }
                int i79 = 0;
                            ...
                            if (!z4) {
                                ...
                                for (int readUnsignedShort27 = readUnsignedShort(i85 + 6); readUnsignedShort27 > 0; readUnsignedShort27--) {
                                    ...
                                    if (labelArr[readUnsignedShort28] == null) {
                                        readLabel(readUnsignedShort28, labelArr).f36938a |= 1;
                                    }
                                    labelArr[readUnsignedShort28].f36939b = readUnsignedShort(i88 + 2);
                                    i88 += 4;
                                }
                            }
                ...
                for (int i103 = i72; i103 < i73; i103 = i5) {
                    ...
                    if (label != null) {
                        ...
                        if (!z4 && label.f36939b > 0) {
                            visitMethod.visitLineNumber(label.f36939b, label);
                        }
                    }
                    int i105 = i101;
                    ...
                    switch (ClassWriter.f36866a[i118]) {
                        case 0:
                        ...
                        case 6:
                        case 7:
                            int i121 = this.f36862a[readUnsignedShort(i103 + 1)];
                            if (i118 == 186) {
                                readClass = Opcodes.INVOKEDYNAMIC_OWNER;
                            } else {
                                readClass = readClass(i121, cArr);
                                i121 = this.f36862a[readUnsignedShort(i121 + 2)];
                            }
                ...
                while (attribute11 != null) {
                    Attribute attribute13 = attribute11.f36857a;
                    attribute11.f36857a = null;
    ...
    public String getClassName() {
        return readClass(this.header + 2, new char[this.f36865d]);
    }
    ...
    public int getItem(int i) {
        return this.f36862a[i];
    }

    public String getSuperName() {
        int i = this.f36862a[readUnsignedShort(this.header + 4)];
        if (i == 0) {
            return null;
        }
        return readUTF8(i, new char[this.f36865d]);
    }

    public int readByte(int i) {
        return this.f36863b[i] & SmileConstants.BYTE_MARKER_END_OF_CONTENT;
    }

    public String readClass(int i, char[] cArr) {
        return readUTF8(this.f36862a[readUnsignedShort(i)], cArr);
    }

    public Object readConst(int i, char[] cArr) {
        int i2 = this.f36862a[i];
        switch (this.f36863b[i2 - 1]) {
            case 3:
    ...
    public String readUTF8(int i, char[] cArr) {
        int readUnsignedShort = readUnsignedShort(i);
        String str = this.f36864c[readUnsignedShort];
        if (str != null) {
            return str;
        }
        int i2 = this.f36862a[readUnsignedShort];
        String[] strArr = this.f36864c;
