...
public class Type {
    ...
    private void m193a(StringBuffer stringBuffer) {
        if (this.f36996b == null) {
            stringBuffer.append((char) ((this.f36997c & ViewCompat.MEASURED_STATE_MASK) >>> 24));
        } else if (this.f36995a == 9) {
            stringBuffer.append(this.f36996b, this.f36997c, this.f36998d);
        } else {
    ...
    public static Type[] getArgumentTypes(String str) {
        ...
        while (charArray[i] != ')') {
            ...
            i += (typeArr[i6].f36995a == 10 ? 2 : 0) + typeArr[i6].f36998d;
            i6++;
        }
        return typeArr;
    }
    ...
    public boolean equals(Object obj) {
        ...
        Type type = (Type) obj;
        if (this.f36995a != type.f36995a) {
            return false;
        }
        if (this.f36995a != 10 && this.f36995a != 9) {
            return true;
        }
        if (this.f36998d != type.f36998d) {
            return false;
        }
        int i = this.f36997c;
        int i2 = type.f36997c;
        int i3 = this.f36998d + i;
        while (i < i3) {
            if (this.f36996b[i] != type.f36996b[i2]) {
                return false;
            }
            i++;
            i2++;
    ...
    public String getClassName() {
        switch (this.f36995a) {
            ...
            case 9:
                ...
                return stringBuffer.toString();
            default:
                return new String(this.f36996b, this.f36997c, this.f36998d).replace('/', C0494h.f686G);
        }
    }
    ...
    public int getDimensions() {
        int i = 1;
        while (this.f36996b[this.f36997c + i] == '[') {
            i++;
        }
        return i;
    }
    ...
    public Type getElementType() {
        return m191a(this.f36996b, this.f36997c + getDimensions());
    }

    public String getInternalName() {
        return new String(this.f36996b, this.f36997c, this.f36998d);
    }
    ...
    public int getOpcode(int i) {
        ...
        if (i == 46 || i == 79) {
            if (this.f36996b == null) {
                i2 = (this.f36997c & MotionEventCompat.ACTION_POINTER_INDEX_MASK) >> 8;
            }
            return i2 + i;
        }
        if (this.f36996b == null) {
            i2 = (this.f36997c & 16711680) >> 16;
        }
        return i2 + i;
    }
    ...
    public int hashCode() {
        int i = this.f36995a * 13;
        if (this.f36995a == 10 || this.f36995a == 9) {
            int i2 = this.f36997c;
            int i3 = i2 + this.f36998d;
            while (i2 < i3) {
                int i4 = (i + this.f36996b[i2]) * 17;
                i2++;
                i = i4;
            }
        }
