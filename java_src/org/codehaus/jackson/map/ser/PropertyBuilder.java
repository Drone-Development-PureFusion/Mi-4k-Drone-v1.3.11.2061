...
public class PropertyBuilder {
    ...
    public BeanPropertyWriter buildWriter(String str, JavaType javaType, JsonSerializer<Object> jsonSerializer, TypeSerializer typeSerializer, TypeSerializer typeSerializer2, AnnotatedMember annotatedMember, boolean z) {
        Method mo40267getAnnotated;
        Field field;
        JavaType javaType2;
        if (annotatedMember instanceof AnnotatedField) {
            mo40267getAnnotated = null;
            field = ((AnnotatedField) annotatedMember).mo40267getAnnotated();
        } else {
            mo40267getAnnotated = ((AnnotatedMethod) annotatedMember).mo40267getAnnotated();
            field = null;
        }
        ...
        if (typeSerializer2 != null) {
            ...
            javaType2 = findSerializationType.mo40283withContentTypeHandler(typeSerializer2);
        ...
        if (findSerializationInclusion != null) {
            switch (findSerializationInclusion) {
                case NON_DEFAULT:
                    obj = getDefaultValue(str, mo40267getAnnotated, field);
                    if (obj == null) {
                        z2 = true;
                        break;
                    }
        ...
        return new BeanPropertyWriter(annotatedMember, this._beanDesc.getClassAnnotations(), str, javaType, jsonSerializer, typeSerializer, javaType2, mo40267getAnnotated, field, z2, obj);
    }
    ...
    protected Object getDefaultBean() {
        if (this._defaultBean == null) {
            ...
            if (this._defaultBean == null) {
                throw new IllegalArgumentException("Class " + this._beanDesc.getClassInfo().mo40267getAnnotated().getName() + " has no default constructor; can not instantiate default bean value to support 'properties=JsonSerialize.Inclusion.NON_DEFAULT' annotation");
            }
        }
