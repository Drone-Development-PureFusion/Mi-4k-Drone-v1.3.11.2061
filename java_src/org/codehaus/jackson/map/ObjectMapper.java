...
import org.codehaus.jackson.p354io.SegmentedStringWriter;
...
public class ObjectMapper extends ObjectCodec implements Versioned {
    ...
    protected Object _readMapAndClose(JsonParser jsonParser, JavaType javaType) {
        ...
        try {
            ...
            if (_initForReading == JsonToken.VALUE_NULL || _initForReading == JsonToken.END_ARRAY || _initForReading == JsonToken.END_OBJECT) {
                ...
                obj = _findRootDeserializer(copyDeserializationConfig, javaType).mo40306deserialize(jsonParser, _createDeserializationContext(jsonParser, copyDeserializationConfig));
            }
    ...
    protected Object _readValue(DeserializationConfig deserializationConfig, JsonParser jsonParser, JavaType javaType) {
        ...
        if (_initForReading == JsonToken.VALUE_NULL || _initForReading == JsonToken.END_ARRAY || _initForReading == JsonToken.END_OBJECT) {
            ...
            obj = _findRootDeserializer(deserializationConfig, javaType).mo40306deserialize(jsonParser, _createDeserializationContext(jsonParser, deserializationConfig));
        }
        jsonParser.clearCurrentToken();
        return obj;
    }
    ...
    public DeserializationConfig copyDeserializationConfig() {
        return this._deserializationConfig.mo40192createUnshared(this._subtypeResolver);
    }

    public SerializationConfig copySerializationConfig() {
        return this._serializationConfig.mo40192createUnshared(this._subtypeResolver);
    }

    @Override // org.codehaus.jackson.ObjectCodec
    /* renamed from: createArrayNode  reason: collision with other method in class */
    public ArrayNode mo40190createArrayNode() {
        return this._deserializationConfig.getNodeFactory().arrayNode();
    }

    @Override // org.codehaus.jackson.ObjectCodec
    /* renamed from: createObjectNode  reason: collision with other method in class */
    public ObjectNode mo40191createObjectNode() {
    ...
    public ObjectMapper enableDefaultTyping(DefaultTyping defaultTyping) {
        return enableDefaultTyping(defaultTyping, JsonTypeInfo.EnumC11698As.WRAPPER_ARRAY);
    }

    public ObjectMapper enableDefaultTyping(DefaultTyping defaultTyping, JsonTypeInfo.EnumC11698As enumC11698As) {
        return setDefaultTyping(new DefaultTypeResolverBuilder(defaultTyping).init(JsonTypeInfo.EnumC11699Id.CLASS, (TypeIdResolver) null).inclusion(enumC11698As));
    }

    public ObjectMapper enableDefaultTypingAsProperty(DefaultTyping defaultTyping, String str) {
        return setDefaultTyping(new DefaultTypeResolverBuilder(defaultTyping).init(JsonTypeInfo.EnumC11699Id.CLASS, (TypeIdResolver) null).inclusion(JsonTypeInfo.EnumC11698As.PROPERTY).typeProperty(str));
    }
    ...
    public <T> T readValue(File file, Class<T> cls) {
        return (T) _readMapAndClose(this._jsonFactory.mo40299createJsonParser(file), this._typeFactory.constructType(cls));
    }

    public <T> T readValue(File file, JavaType javaType) {
        return (T) _readMapAndClose(this._jsonFactory.mo40299createJsonParser(file), javaType);
    }

    public <T> T readValue(File file, TypeReference typeReference) {
        return (T) _readMapAndClose(this._jsonFactory.mo40299createJsonParser(file), this._typeFactory.constructType(typeReference));
    }

    public <T> T readValue(InputStream inputStream, Class<T> cls) {
        return (T) _readMapAndClose(this._jsonFactory.mo40300createJsonParser(inputStream), this._typeFactory.constructType(cls));
    }

    public <T> T readValue(InputStream inputStream, JavaType javaType) {
        return (T) _readMapAndClose(this._jsonFactory.mo40300createJsonParser(inputStream), javaType);
    }

    public <T> T readValue(InputStream inputStream, TypeReference typeReference) {
        return (T) _readMapAndClose(this._jsonFactory.mo40300createJsonParser(inputStream), this._typeFactory.constructType(typeReference));
    }
    ...
    public <T> T readValue(URL url, Class<T> cls) {
        return (T) _readMapAndClose(this._jsonFactory.mo40301createJsonParser(url), this._typeFactory.constructType(cls));
    }

    public <T> T readValue(URL url, JavaType javaType) {
        return (T) _readMapAndClose(this._jsonFactory.mo40301createJsonParser(url), javaType);
    }

    public <T> T readValue(URL url, TypeReference typeReference) {
        return (T) _readMapAndClose(this._jsonFactory.mo40301createJsonParser(url), this._typeFactory.constructType(typeReference));
    }
    ...
    public <T> T readValue(byte[] bArr, int i, int i2, Class<T> cls) {
        return (T) _readMapAndClose(this._jsonFactory.mo40303createJsonParser(bArr, i, i2), this._typeFactory.constructType(cls));
    }

    public <T> T readValue(byte[] bArr, int i, int i2, JavaType javaType) {
        return (T) _readMapAndClose(this._jsonFactory.mo40303createJsonParser(bArr, i, i2), javaType);
    }

    public <T> T readValue(byte[] bArr, int i, int i2, TypeReference typeReference) {
        return (T) _readMapAndClose(this._jsonFactory.mo40303createJsonParser(bArr, i, i2), this._typeFactory.constructType(typeReference));
    }

    public <T> T readValue(byte[] bArr, Class<T> cls) {
        return (T) _readMapAndClose(this._jsonFactory.mo40302createJsonParser(bArr), this._typeFactory.constructType(cls));
    }

    public <T> T readValue(byte[] bArr, JavaType javaType) {
        return (T) _readMapAndClose(this._jsonFactory.mo40302createJsonParser(bArr), javaType);
    }

    public <T> T readValue(byte[] bArr, TypeReference typeReference) {
        return (T) _readMapAndClose(this._jsonFactory.mo40302createJsonParser(bArr), this._typeFactory.constructType(typeReference));
    }
    ...
    public ObjectMapper setAnnotationIntrospector(AnnotationIntrospector annotationIntrospector) {
        this._serializationConfig = this._serializationConfig.mo40194withAnnotationIntrospector(annotationIntrospector);
        this._deserializationConfig = this._deserializationConfig.mo40194withAnnotationIntrospector(annotationIntrospector);
        return this;
    }

    public void setDateFormat(DateFormat dateFormat) {
        this._deserializationConfig = this._deserializationConfig.mo40196withDateFormat(dateFormat);
        this._serializationConfig = this._serializationConfig.mo40196withDateFormat(dateFormat);
    }

    public ObjectMapper setDefaultTyping(TypeResolverBuilder<?> typeResolverBuilder) {
        this._deserializationConfig = this._deserializationConfig.mo40201withTypeResolverBuilder(typeResolverBuilder);
        this._serializationConfig = this._serializationConfig.mo40201withTypeResolverBuilder(typeResolverBuilder);
        return this;
    }
    ...
    public void setHandlerInstantiator(HandlerInstantiator handlerInstantiator) {
        this._deserializationConfig = this._deserializationConfig.mo40197withHandlerInstantiator(handlerInstantiator);
        this._serializationConfig = this._serializationConfig.mo40197withHandlerInstantiator(handlerInstantiator);
    }
    ...
    public ObjectMapper setPropertyNamingStrategy(PropertyNamingStrategy propertyNamingStrategy) {
        this._serializationConfig = this._serializationConfig.mo40198withPropertyNamingStrategy(propertyNamingStrategy);
        this._deserializationConfig = this._deserializationConfig.mo40198withPropertyNamingStrategy(propertyNamingStrategy);
        return this;
    }
    ...
    public ObjectMapper setTypeFactory(TypeFactory typeFactory) {
        ...
        this._deserializationConfig = this._deserializationConfig.mo40200withTypeFactory(typeFactory);
        this._serializationConfig = this._serializationConfig.mo40200withTypeFactory(typeFactory);
        return this;
    }

    public void setVisibilityChecker(VisibilityChecker<?> visibilityChecker) {
        this._deserializationConfig = this._deserializationConfig.mo40202withVisibilityChecker(visibilityChecker);
        this._serializationConfig = this._serializationConfig.mo40202withVisibilityChecker(visibilityChecker);
    }
    ...
    public void writeValue(OutputStream outputStream, Object obj) {
        _configAndWriteValue(this._jsonFactory.mo40298createJsonGenerator(outputStream, JsonEncoding.UTF8), obj);
    }
    ...
    public byte[] writeValueAsBytes(Object obj) {
        ...
        _configAndWriteValue(this._jsonFactory.mo40298createJsonGenerator(byteArrayBuilder, JsonEncoding.UTF8), obj);
    ...
    public void writeValueUsingView(OutputStream outputStream, Object obj, Class<?> cls) {
        _configAndWriteValue(this._jsonFactory.mo40298createJsonGenerator(outputStream, JsonEncoding.UTF8), obj, cls);
    }
