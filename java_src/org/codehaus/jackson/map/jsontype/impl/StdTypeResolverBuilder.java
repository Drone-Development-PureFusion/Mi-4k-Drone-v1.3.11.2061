...
public class StdTypeResolverBuilder implements TypeResolverBuilder<StdTypeResolverBuilder> {
    ...
    protected JsonTypeInfo.EnumC11699Id _idType;
    protected JsonTypeInfo.EnumC11698As _includeAs;
    ...
    @Override // org.codehaus.jackson.map.jsontype.TypeResolverBuilder
    public StdTypeResolverBuilder inclusion(JsonTypeInfo.EnumC11698As enumC11698As) {
        if (enumC11698As == null) {
            throw new IllegalArgumentException("includeAs can not be null");
        }
        this._includeAs = enumC11698As;
        return this;
    }

    @Override // org.codehaus.jackson.map.jsontype.TypeResolverBuilder
    public StdTypeResolverBuilder init(JsonTypeInfo.EnumC11699Id enumC11699Id, TypeIdResolver typeIdResolver) {
        if (enumC11699Id == null) {
            throw new IllegalArgumentException("idType can not be null");
        }
        this._idType = enumC11699Id;
        this._customIdResolver = typeIdResolver;
        this._typeProperty = enumC11699Id.getDefaultPropertyName();
        return this;
    }
