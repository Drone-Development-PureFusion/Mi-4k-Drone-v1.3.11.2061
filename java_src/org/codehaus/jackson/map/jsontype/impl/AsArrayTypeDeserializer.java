...
public class AsArrayTypeDeserializer extends TypeDeserializerBase {
    ...
    private final Object _deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
        Object mo40306deserialize = _findDeserializer(deserializationContext, _locateTypeId(jsonParser, deserializationContext)).mo40306deserialize(jsonParser, deserializationContext);
    ...
    public JsonTypeInfo.EnumC11698As getTypeInclusion() {
        return JsonTypeInfo.EnumC11698As.WRAPPER_ARRAY;
    }
}
