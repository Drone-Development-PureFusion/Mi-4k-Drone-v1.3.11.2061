...
public class ObjectReader extends ObjectCodec implements Versioned {
    ...
    protected Object _bind(JsonParser jsonParser) {
        ...
        if (_initForReading == JsonToken.VALUE_NULL || _initForReading == JsonToken.END_ARRAY || _initForReading == JsonToken.END_OBJECT) {
            ...
            if (this._valueToUpdate == null) {
                obj = _findRootDeserializer(this._config, this._valueType).mo40306deserialize(jsonParser, _createDeserializationContext);
            } else {
    ...
    protected JsonNode _bindAsTree(JsonParser jsonParser) {
        ...
        if (_initForReading == JsonToken.VALUE_NULL || _initForReading == JsonToken.END_ARRAY || _initForReading == JsonToken.END_OBJECT) {
            ...
            jsonNode = (JsonNode) _findRootDeserializer(this._config, JSON_NODE_TYPE).mo40306deserialize(jsonParser, _createDeserializationContext(jsonParser, this._config));
        }
        jsonParser.clearCurrentToken();
        return jsonNode;
    }
    ...
    public JsonNode mo40190createArrayNode() {
        return this._config.getNodeFactory().arrayNode();
    }

    @Override // org.codehaus.jackson.ObjectCodec
    /* renamed from: createObjectNode */
    public JsonNode mo40191createObjectNode() {
        return this._config.getNodeFactory().objectNode();
    }

    public JsonNode readTree(InputStream inputStream) {
        return _bindAndCloseAsTree(this._jsonFactory.mo40300createJsonParser(inputStream));
    }
    ...
    public <T> T readValue(File file) {
        return (T) _bindAndClose(this._jsonFactory.mo40299createJsonParser(file));
    }

    public <T> T readValue(InputStream inputStream) {
        return (T) _bindAndClose(this._jsonFactory.mo40300createJsonParser(inputStream));
    }
    ...
    public <T> T readValue(URL url) {
        return (T) _bindAndClose(this._jsonFactory.mo40301createJsonParser(url));
    }
    ...
    public <T> T readValue(byte[] bArr) {
        return (T) _bindAndClose(this._jsonFactory.mo40302createJsonParser(bArr));
    }

    public <T> T readValue(byte[] bArr, int i, int i2) {
        return (T) _bindAndClose(this._jsonFactory.mo40303createJsonParser(bArr, i, i2));
    }

    public <T> MappingIterator<T> readValues(File file) {
        JsonParser mo40299createJsonParser = this._jsonFactory.mo40299createJsonParser(file);
        if (this._schema != null) {
            mo40299createJsonParser.setSchema(this._schema);
        }
        return new MappingIterator<>(this._valueType, mo40299createJsonParser, _createDeserializationContext(mo40299createJsonParser, this._config), _findRootDeserializer(this._config, this._valueType));
    }

    public <T> MappingIterator<T> readValues(InputStream inputStream) {
        JsonParser mo40300createJsonParser = this._jsonFactory.mo40300createJsonParser(inputStream);
        if (this._schema != null) {
            mo40300createJsonParser.setSchema(this._schema);
        }
        return new MappingIterator<>(this._valueType, mo40300createJsonParser, _createDeserializationContext(mo40300createJsonParser, this._config), _findRootDeserializer(this._config, this._valueType));
    }
    ...
    public <T> MappingIterator<T> readValues(URL url) {
        JsonParser mo40301createJsonParser = this._jsonFactory.mo40301createJsonParser(url);
        if (this._schema != null) {
            mo40301createJsonParser.setSchema(this._schema);
        }
        return new MappingIterator<>(this._valueType, mo40301createJsonParser, _createDeserializationContext(mo40301createJsonParser, this._config), _findRootDeserializer(this._config, this._valueType));
    }
    ...
    public <T> MappingIterator<T> readValues(byte[] bArr, int i, int i2) {
        JsonParser mo40303createJsonParser = this._jsonFactory.mo40303createJsonParser(bArr, i, i2);
        if (this._schema != null) {
            mo40303createJsonParser.setSchema(this._schema);
        }
        return new MappingIterator<>(this._valueType, mo40303createJsonParser, _createDeserializationContext(mo40303createJsonParser, this._config), _findRootDeserializer(this._config, this._valueType));
    }
