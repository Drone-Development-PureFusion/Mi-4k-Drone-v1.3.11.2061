...
public abstract class DOMDeserializer<T> extends FromStringDeserializer<T> {
    ...
    public static class DocumentDeserializer extends DOMDeserializer<Document> {
        ...
        public Document mo40259_deserialize(String str, DeserializationContext deserializationContext) {
            return parse(str);
        }
    }
    ...
    public static class NodeDeserializer extends DOMDeserializer<Node> {
        ...
        @Override // org.codehaus.jackson.map.ext.DOMDeserializer, org.codehaus.jackson.map.deser.FromStringDeserializer
        /* renamed from: _deserialize  reason: collision with other method in class */
        public Node mo40259_deserialize(String str, DeserializationContext deserializationContext) {
            return parse(str);
        }
    }
    ...
    public abstract T mo40259_deserialize(String str, DeserializationContext deserializationContext);
