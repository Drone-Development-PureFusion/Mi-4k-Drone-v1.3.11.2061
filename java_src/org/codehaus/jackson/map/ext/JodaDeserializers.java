...
public class JodaDeserializers implements Provider<StdDeserializer<?>> {
    ...
    public static class DateMidnightDeserializer extends JodaDeserializer<DateMidnight> {
        ...
        public DateMidnight mo40306deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
    ...
    public static class DateTimeDeserializer<T extends ReadableInstant> extends JodaDeserializer<T> {
        ...
        @Override // org.codehaus.jackson.map.JsonDeserializer
        /* renamed from: deserialize  reason: collision with other method in class */
        public T mo40306deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
    ...
    public static class LocalDateDeserializer extends JodaDeserializer<LocalDate> {
        ...
        @Override // org.codehaus.jackson.map.JsonDeserializer
        /* renamed from: deserialize  reason: collision with other method in class */
        public LocalDate mo40306deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
            if (!jsonParser.isExpectedStartArrayToken()) {
                switch (jsonParser.getCurrentToken()) {
                    case VALUE_NUMBER_INT:
    ...
    public static class LocalDateTimeDeserializer extends JodaDeserializer<LocalDateTime> {
        ...
        @Override // org.codehaus.jackson.map.JsonDeserializer
        /* renamed from: deserialize  reason: collision with other method in class */
        public LocalDateTime mo40306deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
            if (!jsonParser.isExpectedStartArrayToken()) {
                switch (jsonParser.getCurrentToken()) {
                    case VALUE_NUMBER_INT:
