...
public interface VisibilityChecker<T extends VisibilityChecker<T>> {
    ...
    public static class Std implements VisibilityChecker<Std> {
        ...
        public boolean isFieldVisible(AnnotatedField annotatedField) {
            return isFieldVisible(annotatedField.mo40267getAnnotated());
        }
        ...
        public boolean isGetterVisible(AnnotatedMethod annotatedMethod) {
            return isGetterVisible(annotatedMethod.mo40267getAnnotated());
        }
        ...
        public boolean isIsGetterVisible(AnnotatedMethod annotatedMethod) {
            return isIsGetterVisible(annotatedMethod.mo40267getAnnotated());
        }
        ...
        public boolean isSetterVisible(AnnotatedMethod annotatedMethod) {
            return isSetterVisible(annotatedMethod.mo40267getAnnotated());
        }
        ...
        @Override // org.codehaus.jackson.map.introspect.VisibilityChecker
        /* renamed from: with */
        public Std mo40269with(JsonAutoDetect jsonAutoDetect) {
            if (jsonAutoDetect == null) {
                return this;
            }
            JsonMethod[] value = jsonAutoDetect.value();
            return mo40272withGetterVisibility(hasMethod(value, JsonMethod.GETTER) ? jsonAutoDetect.getterVisibility() : JsonAutoDetect.Visibility.NONE).mo40273withIsGetterVisibility(hasMethod(value, JsonMethod.IS_GETTER) ? jsonAutoDetect.isGetterVisibility() : JsonAutoDetect.Visibility.NONE).mo40274withSetterVisibility(hasMethod(value, JsonMethod.SETTER) ? jsonAutoDetect.setterVisibility() : JsonAutoDetect.Visibility.NONE).mo40270withCreatorVisibility(hasMethod(value, JsonMethod.CREATOR) ? jsonAutoDetect.creatorVisibility() : JsonAutoDetect.Visibility.NONE).mo40271withFieldVisibility(hasMethod(value, JsonMethod.FIELD) ? jsonAutoDetect.fieldVisibility() : JsonAutoDetect.Visibility.NONE);
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // org.codehaus.jackson.map.introspect.VisibilityChecker
        /* renamed from: withCreatorVisibility */
        public Std mo40270withCreatorVisibility(JsonAutoDetect.Visibility visibility) {
        ...
        public Std mo40271withFieldVisibility(JsonAutoDetect.Visibility visibility) {
        ...
        public Std mo40272withGetterVisibility(JsonAutoDetect.Visibility visibility) {
        ...
        public Std mo40273withIsGetterVisibility(JsonAutoDetect.Visibility visibility) {
        ...
        public Std mo40274withSetterVisibility(JsonAutoDetect.Visibility visibility) {
    ...
    /* renamed from: with */
    T mo40269with(JsonAutoDetect jsonAutoDetect);

    /* renamed from: withCreatorVisibility */
    T mo40270withCreatorVisibility(JsonAutoDetect.Visibility visibility);

    /* renamed from: withFieldVisibility */
    T mo40271withFieldVisibility(JsonAutoDetect.Visibility visibility);

    /* renamed from: withGetterVisibility */
    T mo40272withGetterVisibility(JsonAutoDetect.Visibility visibility);

    /* renamed from: withIsGetterVisibility */
    T mo40273withIsGetterVisibility(JsonAutoDetect.Visibility visibility);

    /* renamed from: withSetterVisibility */
    T mo40274withSetterVisibility(JsonAutoDetect.Visibility visibility);
}
