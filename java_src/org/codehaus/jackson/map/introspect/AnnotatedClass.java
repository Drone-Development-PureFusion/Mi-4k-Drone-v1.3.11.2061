...
public final class AnnotatedClass extends Annotated {
                ...
                default:
                    if (memberKeyArr2 == null) {
                        ...
                        for (int i = 0; i < size; i++) {
                            memberKeyArr[i] = new MemberKey(this._constructors.get(i).mo40267getAnnotated());
                        }
                    } else {
        ...
        for (Method method : cls.getDeclaredMethods()) {
            if (Modifier.isStatic(method.getModifiers()) && method.getParameterTypes().length != 0) {
                if (memberKeyArr2 == null) {
                    memberKeyArr = new MemberKey[size];
                    for (int i = 0; i < size; i++) {
                        memberKeyArr[i] = new MemberKey(this._creatorMethods.get(i).mo40267getAnnotated());
                    }
                } else {
                    memberKeyArr = memberKeyArr2;
                }
        ...
        for (Method method : cls.getDeclaredMethods()) {
            if (_isIncludableMethod(method, methodFilter)) {
                ...
                if (find == null) {
                    ...
                    if (remove != null) {
                        _addMixOvers(remove.mo40267getAnnotated(), _constructMethod, false);
                    }
                } else {
    ...
    public Class<?> mo40267getAnnotated() {
        return this._class;
    }
                ...
                while (it2.hasNext()) {
                    ...
                    try {
                        ...
                        if (declaredMethod != null) {
                            ...
                            _addMixOvers(next.mo40267getAnnotated(), _constructMethod, false);
