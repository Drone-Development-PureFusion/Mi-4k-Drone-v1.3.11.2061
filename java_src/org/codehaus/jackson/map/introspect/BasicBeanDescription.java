...
public class BasicBeanDescription extends BeanDescription {
    ...
    */
    ...
    public Constructor<?> findDefaultConstructor() {
        ...
        return defaultConstructor.mo40267getAnnotated();
    }
            ...
            if (isFactoryMethod(annotatedMethod)) {
                ...
                for (Class<?> cls : clsArr) {
                    if (parameterClass.isAssignableFrom(cls)) {
                        return annotatedMethod.mo40267getAnnotated();
                    }
                }
                continue;
            }
    ...
    public AnnotatedMethod findJsonValueMethod() {
        ...
        for (AnnotatedMethod annotatedMethod2 : this._classInfo.memberMethods()) {
            if (this._annotationIntrospector.hasAsValueAnnotation(annotatedMethod2)) {
                ...
                if (!ClassUtil.hasGetterSignature(annotatedMethod2.mo40267getAnnotated())) {
    ...
    */
            ...
            if (annotatedConstructor.getParameterCount() == 1) {
                ...
                for (Class<?> cls : clsArr) {
                    if (cls == parameterClass) {
                        return annotatedConstructor.mo40267getAnnotated();
                    }
                }
                continue;
            }
    ...
    public Object instantiateBean(boolean z) {
        ...
        try {
            return defaultConstructor.mo40267getAnnotated().newInstance(new Object[0]);
        } catch (Exception e) {
            e = e;
            ...
            if (!(e instanceof RuntimeException)) {
                throw new IllegalArgumentException("Failed to instantiate bean of type " + this._classInfo.mo40267getAnnotated().getName() + ": (" + e.getClass().getName() + ") " + e.getMessage(), e);
            }
    ...
    protected boolean isFactoryMethod(AnnotatedMethod annotatedMethod) {
        ...
        return this._annotationIntrospector.hasCreatorAnnotation(annotatedMethod) || C0494h.f725m.equals(annotatedMethod.getName());
    }
