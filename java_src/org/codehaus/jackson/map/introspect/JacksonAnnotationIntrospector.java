...
public class JacksonAnnotationIntrospector extends AnnotationIntrospector {
    ...
    protected TypeResolverBuilder<?> _findTypeResolver(MapperConfig<?> mapperConfig, Annotated annotated, JavaType javaType) {
        ...
        } else if (jsonTypeInfo == null || jsonTypeInfo.use() == JsonTypeInfo.EnumC11699Id.NONE) {
            return null;
        } else {
    ...
    public VisibilityChecker<?> findAutoDetectVisibility(AnnotatedClass annotatedClass, VisibilityChecker<?> visibilityChecker) {
        ...
        return jsonAutoDetect == null ? visibilityChecker : visibilityChecker.mo40269with(jsonAutoDetect);
    }
    ...
    public Class<? extends JsonDeserializer<?>> mo40307findDeserializer(Annotated annotated, BeanProperty beanProperty) {
