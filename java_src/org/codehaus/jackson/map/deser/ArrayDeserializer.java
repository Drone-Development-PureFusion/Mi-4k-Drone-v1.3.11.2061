...
public class ArrayDeserializer extends ContainerDeserializer<Object[]> {
    ...
    private final Object[] handleNonArray(JsonParser jsonParser, DeserializationContext deserializationContext) {
        ...
        Object mo40306deserialize = jsonParser.getCurrentToken() == JsonToken.VALUE_NULL ? null : this._elementTypeDeserializer == null ? this._elementDeserializer.mo40306deserialize(jsonParser, deserializationContext) : this._elementDeserializer.mo40244deserializeWithType(jsonParser, deserializationContext, this._elementTypeDeserializer);
        Object[] objArr = this._untyped ? new Object[1] : (Object[]) Array.newInstance(this._elementClass, 1);
        objArr[0] = mo40306deserialize;
        return objArr;
    }

    @Override // org.codehaus.jackson.map.JsonDeserializer
    /* renamed from: deserialize  reason: collision with other method in class */
    public Object[] mo40306deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
        int i;
        ...
        while (true) {
            ...
            Object mo40306deserialize = nextToken == JsonToken.VALUE_NULL ? null : typeDeserializer == null ? this._elementDeserializer.mo40306deserialize(jsonParser, deserializationContext) : this._elementDeserializer.mo40244deserializeWithType(jsonParser, deserializationContext, typeDeserializer);
            if (i2 >= objArr.length) {
