...
public final class EnumSetDeserializer extends StdDeserializer<EnumSet<?>> {
    ...
    public EnumSet<?> mo40306deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
        ...
        while (true) {
            ...
            constructSet.add(this._enumDeserializer.mo40306deserialize(jsonParser, deserializationContext));
        }
    }
