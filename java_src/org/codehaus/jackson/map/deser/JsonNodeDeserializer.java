...
public class JsonNodeDeserializer extends BaseNodeDeserializer<JsonNode> {
    ...
    static final class ArrayDeserializer extends BaseNodeDeserializer<ArrayNode> {
        ...
        public ArrayNode mo40306deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
    ...
    static final class ObjectDeserializer extends BaseNodeDeserializer<ObjectNode> {
        ...
        @Override // org.codehaus.jackson.map.JsonDeserializer
        /* renamed from: deserialize  reason: collision with other method in class */
        public ObjectNode mo40306deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
    ...
    @Override // org.codehaus.jackson.map.JsonDeserializer
    /* renamed from: deserialize  reason: collision with other method in class */
    public JsonNode mo40306deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
    ...
    public /* bridge */ /* synthetic */ Object mo40244deserializeWithType(JsonParser jsonParser, DeserializationContext deserializationContext, TypeDeserializer typeDeserializer) {
        return super.mo40244deserializeWithType(jsonParser, deserializationContext, typeDeserializer);
    }
}
