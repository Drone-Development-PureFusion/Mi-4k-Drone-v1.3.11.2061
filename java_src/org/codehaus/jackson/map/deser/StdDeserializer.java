...
import org.codehaus.jackson.p354io.NumberInput;
...
public abstract class StdDeserializer<T> extends JsonDeserializer<T> {
    ...
    public static final class AtomicBooleanDeserializer extends StdScalarDeserializer<AtomicBoolean> {
        ...
        public AtomicBoolean mo40306deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
    ...
    public static class AtomicReferenceDeserializer extends StdScalarDeserializer<AtomicReference<?>> implements ResolvableDeserializer {
        ...
        @Override // org.codehaus.jackson.map.JsonDeserializer
        /* renamed from: deserialize  reason: collision with other method in class */
        public AtomicReference<?> mo40306deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
            return new AtomicReference<>(this._valueDeserializer.mo40306deserialize(jsonParser, deserializationContext));
        }
    ...
    public static class BigDecimalDeserializer extends StdScalarDeserializer<BigDecimal> {
        ...
        @Override // org.codehaus.jackson.map.JsonDeserializer
        /* renamed from: deserialize  reason: collision with other method in class */
        public BigDecimal mo40306deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
    ...
    public static class BigIntegerDeserializer extends StdScalarDeserializer<BigInteger> {
        ...
        @Override // org.codehaus.jackson.map.JsonDeserializer
        /* renamed from: deserialize  reason: collision with other method in class */
        public BigInteger mo40306deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
            JsonToken currentToken = jsonParser.getCurrentToken();
    ...
    public static final class BooleanDeserializer extends PrimitiveOrWrapperDeserializer<Boolean> {
        ...
        public Boolean mo40306deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
        ...
        public Boolean mo40244deserializeWithType(JsonParser jsonParser, DeserializationContext deserializationContext, TypeDeserializer typeDeserializer) {
            return _parseBoolean(jsonParser, deserializationContext);
        }
    }
    ...
    public static final class ByteDeserializer extends PrimitiveOrWrapperDeserializer<Byte> {
        ...
        @Override // org.codehaus.jackson.map.JsonDeserializer
        /* renamed from: deserialize */
        public Byte mo40306deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
    ...
    public static class CalendarDeserializer extends StdScalarDeserializer<Calendar> {
        ...
        @Override // org.codehaus.jackson.map.JsonDeserializer
        /* renamed from: deserialize  reason: collision with other method in class */
        public Calendar mo40306deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
    ...
    public static final class CharacterDeserializer extends PrimitiveOrWrapperDeserializer<Character> {
        ...
        @Override // org.codehaus.jackson.map.JsonDeserializer
        /* renamed from: deserialize */
        public Character mo40306deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
            JsonToken currentToken = jsonParser.getCurrentToken();
            if (currentToken == JsonToken.VALUE_NUMBER_INT) {
    ...
    public static final class ClassDeserializer extends StdScalarDeserializer<Class<?>> {
        ...
        @Override // org.codehaus.jackson.map.JsonDeserializer
        /* renamed from: deserialize */
        public Class<?> mo40306deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
    ...
    public static final class DoubleDeserializer extends PrimitiveOrWrapperDeserializer<Double> {
        ...
        @Override // org.codehaus.jackson.map.JsonDeserializer
        /* renamed from: deserialize */
        public Double mo40306deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
            return _parseDouble(jsonParser, deserializationContext);
        }

        @Override // org.codehaus.jackson.map.deser.StdScalarDeserializer, org.codehaus.jackson.map.deser.StdDeserializer, org.codehaus.jackson.map.JsonDeserializer
        /* renamed from: deserializeWithType */
        public Double mo40244deserializeWithType(JsonParser jsonParser, DeserializationContext deserializationContext, TypeDeserializer typeDeserializer) {
            return _parseDouble(jsonParser, deserializationContext);
        }
    }
    ...
    public static final class FloatDeserializer extends PrimitiveOrWrapperDeserializer<Float> {
        ...
        @Override // org.codehaus.jackson.map.JsonDeserializer
        /* renamed from: deserialize */
        public Float mo40306deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
    ...
    public static final class IntegerDeserializer extends PrimitiveOrWrapperDeserializer<Integer> {
        ...
        @Override // org.codehaus.jackson.map.JsonDeserializer
        /* renamed from: deserialize */
        public Integer mo40306deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
            return _parseInteger(jsonParser, deserializationContext);
        }

        @Override // org.codehaus.jackson.map.deser.StdScalarDeserializer, org.codehaus.jackson.map.deser.StdDeserializer, org.codehaus.jackson.map.JsonDeserializer
        /* renamed from: deserializeWithType */
        public Integer mo40244deserializeWithType(JsonParser jsonParser, DeserializationContext deserializationContext, TypeDeserializer typeDeserializer) {
            return _parseInteger(jsonParser, deserializationContext);
        }
    }
    ...
    public static final class LongDeserializer extends PrimitiveOrWrapperDeserializer<Long> {
        ...
        @Override // org.codehaus.jackson.map.JsonDeserializer
        /* renamed from: deserialize */
        public Long mo40306deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
    ...
    public static final class NumberDeserializer extends StdScalarDeserializer<Number> {
        ...
        @Override // org.codehaus.jackson.map.JsonDeserializer
        /* renamed from: deserialize */
        public Number mo40306deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
            Number valueOf;
            JsonToken currentToken = jsonParser.getCurrentToken();
            if (currentToken == JsonToken.VALUE_NUMBER_INT) {
        ...
        @Override // org.codehaus.jackson.map.deser.StdScalarDeserializer, org.codehaus.jackson.map.deser.StdDeserializer, org.codehaus.jackson.map.JsonDeserializer
        /* renamed from: deserializeWithType */
        public Object mo40244deserializeWithType(JsonParser jsonParser, DeserializationContext deserializationContext, TypeDeserializer typeDeserializer) {
            switch (jsonParser.getCurrentToken()) {
                case VALUE_NUMBER_INT:
                case VALUE_NUMBER_FLOAT:
                case VALUE_STRING:
                    return mo40306deserialize(jsonParser, deserializationContext);
                default:
    ...
    public static final class ShortDeserializer extends PrimitiveOrWrapperDeserializer<Short> {
        ...
        @Override // org.codehaus.jackson.map.JsonDeserializer
        /* renamed from: deserialize  reason: collision with other method in class */
        public Short mo40306deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
    ...
    public static class SqlDateDeserializer extends StdScalarDeserializer<java.sql.Date> {
        ...
        @Override // org.codehaus.jackson.map.JsonDeserializer
        /* renamed from: deserialize  reason: collision with other method in class */
        public java.sql.Date mo40306deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
            Date _parseDate = _parseDate(jsonParser, deserializationContext);
            if (_parseDate == null) {
                return null;
            }
    ...
    public static class StackTraceElementDeserializer extends StdScalarDeserializer<StackTraceElement> {
        ...
        @Override // org.codehaus.jackson.map.JsonDeserializer
        /* renamed from: deserialize  reason: collision with other method in class */
        public StackTraceElement mo40306deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
    ...
    public static final class StringDeserializer extends StdScalarDeserializer<String> {
        ...
        @Override // org.codehaus.jackson.map.JsonDeserializer
        /* renamed from: deserialize  reason: collision with other method in class */
        public String mo40306deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
            JsonToken currentToken = jsonParser.getCurrentToken();
            if (currentToken == JsonToken.VALUE_STRING) {
        ...
        public String mo40244deserializeWithType(JsonParser jsonParser, DeserializationContext deserializationContext, TypeDeserializer typeDeserializer) {
            return mo40306deserialize(jsonParser, deserializationContext);
        }
    }
    ...
    public static class TokenBufferDeserializer extends StdScalarDeserializer<TokenBuffer> {
        ...
        @Override // org.codehaus.jackson.map.JsonDeserializer
        /* renamed from: deserialize  reason: collision with other method in class */
        public TokenBuffer mo40306deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
