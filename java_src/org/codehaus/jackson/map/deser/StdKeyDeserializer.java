...
public abstract class StdKeyDeserializer extends KeyDeserializer {
    ...
    static final class BoolKD extends StdKeyDeserializer {
        ...
        /* renamed from: _parse */
        public Boolean mo40254_parse(String str, DeserializationContext deserializationContext) {
            if ("true".equals(str)) {
                return Boolean.TRUE;
            }
            if (!"false".equals(str)) {
    ...
    static final class ByteKD extends StdKeyDeserializer {
        ...
        @Override // org.codehaus.jackson.map.deser.StdKeyDeserializer
        /* renamed from: _parse */
        public Byte mo40254_parse(String str, DeserializationContext deserializationContext) {
    ...
    static final class CharKD extends StdKeyDeserializer {
        ...
        @Override // org.codehaus.jackson.map.deser.StdKeyDeserializer
        /* renamed from: _parse */
        public Character mo40254_parse(String str, DeserializationContext deserializationContext) {
            if (str.length() == 1) {
    ...
    static final class DoubleKD extends StdKeyDeserializer {
        ...
        @Override // org.codehaus.jackson.map.deser.StdKeyDeserializer
        /* renamed from: _parse */
        public Double mo40254_parse(String str, DeserializationContext deserializationContext) {
    ...
    static final class EnumKD extends StdKeyDeserializer {
        ...
        @Override // org.codehaus.jackson.map.deser.StdKeyDeserializer
        /* renamed from: _parse */
        public Enum<?> mo40254_parse(String str, DeserializationContext deserializationContext) {
    ...
    static final class FloatKD extends StdKeyDeserializer {
        ...
        @Override // org.codehaus.jackson.map.deser.StdKeyDeserializer
        /* renamed from: _parse */
        public Float mo40254_parse(String str, DeserializationContext deserializationContext) {
    ...
    static final class IntKD extends StdKeyDeserializer {
        ...
        @Override // org.codehaus.jackson.map.deser.StdKeyDeserializer
        /* renamed from: _parse */
        public Integer mo40254_parse(String str, DeserializationContext deserializationContext) {
    ...
    static final class LongKD extends StdKeyDeserializer {
        ...
        @Override // org.codehaus.jackson.map.deser.StdKeyDeserializer
        /* renamed from: _parse */
        public Long mo40254_parse(String str, DeserializationContext deserializationContext) {
    ...
    static final class ShortKD extends StdKeyDeserializer {
        ...
        public Short mo40254_parse(String str, DeserializationContext deserializationContext) {
            int _parseInt = _parseInt(str);
    ...
    static final class StringCtorKeyDeserializer extends StdKeyDeserializer {
        ...
        @Override // org.codehaus.jackson.map.deser.StdKeyDeserializer
        /* renamed from: _parse */
        public Object mo40254_parse(String str, DeserializationContext deserializationContext) {
    ...
    /* renamed from: _parse */
    protected abstract Object mo40254_parse(String str, DeserializationContext deserializationContext);
    ...
    public final Object deserializeKey(String str, DeserializationContext deserializationContext) {
        ...
        try {
            Object mo40254_parse = mo40254_parse(str, deserializationContext);
            if (mo40254_parse != null) {
                return mo40254_parse;
            }
