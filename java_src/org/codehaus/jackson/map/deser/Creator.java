...
abstract class Creator {
    ...
    public static final class Delegating {
        ...
        public Delegating(BasicBeanDescription basicBeanDescription, AnnotatedConstructor annotatedConstructor, AnnotatedMethod annotatedMethod) {
            ...
            if (annotatedConstructor != null) {
                ...
                this._ctor = annotatedConstructor.mo40267getAnnotated();
                ...
                this._ctor = null;
                this._factoryMethod = annotatedMethod.mo40267getAnnotated();
        ...
        public Object deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
            Object obj = null;
            Object mo40306deserialize = this._deserializer.mo40306deserialize(jsonParser, deserializationContext);
            try {
                obj = this._ctor != null ? this._ctor.newInstance(mo40306deserialize) : this._factoryMethod.invoke(null, mo40306deserialize);
            } catch (Exception e) {
    ...
    public static final class NumberBased {
        ...
        public NumberBased(Class<?> cls, AnnotatedConstructor annotatedConstructor, AnnotatedMethod annotatedMethod, AnnotatedConstructor annotatedConstructor2, AnnotatedMethod annotatedMethod2) {
            ...
            this._intCtor = annotatedConstructor == null ? null : annotatedConstructor.mo40267getAnnotated();
            this._longCtor = annotatedConstructor2 == null ? null : annotatedConstructor2.mo40267getAnnotated();
            this._intFactoryMethod = annotatedMethod == null ? null : annotatedMethod.mo40267getAnnotated();
            this._longFactoryMethod = annotatedMethod2 != null ? annotatedMethod2.mo40267getAnnotated() : method;
        }
    ...
    public static final class StringBased {
        ...
        public StringBased(Class<?> cls, AnnotatedConstructor annotatedConstructor, AnnotatedMethod annotatedMethod) {
            Method method = null;
            this._valueClass = cls;
            this._ctor = annotatedConstructor == null ? null : annotatedConstructor.mo40267getAnnotated();
            this._factoryMethod = annotatedMethod != null ? annotatedMethod.mo40267getAnnotated() : method;
        }
