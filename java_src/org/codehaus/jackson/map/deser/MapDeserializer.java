...
public class MapDeserializer extends ContainerDeserializer<Map<Object, Object>> implements ResolvableDeserializer {
        ...
        while (currentToken == JsonToken.FIELD_NAME) {
            ...
            if (this._ignorableProperties == null || !this._ignorableProperties.contains(currentName)) {
                ...
                if (findCreatorProperty != null) {
                    ...
                    startBuilding.bufferMapProperty(str, nextToken == JsonToken.VALUE_NULL ? null : typeDeserializer == null ? jsonDeserializer.mo40306deserialize(jsonParser, deserializationContext) : jsonDeserializer.mo40244deserializeWithType(jsonParser, deserializationContext, typeDeserializer));
                }
            } else {
    ...
    protected final void _readAndBind(JsonParser jsonParser, DeserializationContext deserializationContext, Map<Object, Object> map) {
        ...
        while (currentToken == JsonToken.FIELD_NAME) {
            ...
            JsonToken nextToken = jsonParser.nextToken();
            if (this._ignorableProperties == null || !this._ignorableProperties.contains(currentName)) {
                map.put(deserializeKey, nextToken == JsonToken.VALUE_NULL ? null : typeDeserializer == null ? jsonDeserializer.mo40306deserialize(jsonParser, deserializationContext) : jsonDeserializer.mo40244deserializeWithType(jsonParser, deserializationContext, typeDeserializer));
            } else {
                jsonParser.skipChildren();
            }
            currentToken = jsonParser.nextToken();
    ...
    public Map<Object, Object> mo40306deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
        JsonToken currentToken = jsonParser.getCurrentToken();
