...
public final class EnumMapDeserializer extends StdDeserializer<EnumMap<?, ?>> {
    ...
    public EnumMap<?, ?> mo40306deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
        ...
        while (jsonParser.nextToken() != JsonToken.END_OBJECT) {
            ...
            constructMap.put((EnumMap<?, ?>) findEnum, (Object) (jsonParser.nextToken() == JsonToken.VALUE_NULL ? null : this._valueDeserializer.mo40306deserialize(jsonParser, deserializationContext)));
        }
        return constructMap;
    }
