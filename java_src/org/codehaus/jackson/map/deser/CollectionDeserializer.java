...
public class CollectionDeserializer extends ContainerDeserializer<Collection<Object>> {
    ...
    private final Collection<Object> handleNonArray(JsonParser jsonParser, DeserializationContext deserializationContext, Collection<Object> collection) {
        ...
        collection.add(jsonParser.getCurrentToken() == JsonToken.VALUE_NULL ? null : typeDeserializer == null ? jsonDeserializer.mo40306deserialize(jsonParser, deserializationContext) : jsonDeserializer.mo40244deserializeWithType(jsonParser, deserializationContext, typeDeserializer));
        return collection;
    }

    @Override // org.codehaus.jackson.map.JsonDeserializer
    /* renamed from: deserialize  reason: collision with other method in class */
    public Collection<Object> mo40306deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
        try {
    ...
    public Collection<Object> deserialize(JsonParser jsonParser, DeserializationContext deserializationContext, Collection<Object> collection) {
        ...
        while (true) {
            ...
            collection.add(nextToken == JsonToken.VALUE_NULL ? null : typeDeserializer == null ? jsonDeserializer.mo40306deserialize(jsonParser, deserializationContext) : jsonDeserializer.mo40244deserializeWithType(jsonParser, deserializationContext, typeDeserializer));
        }
    }
