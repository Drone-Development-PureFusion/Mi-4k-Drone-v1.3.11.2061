...
public final class StringCollectionDeserializer extends ContainerDeserializer<Collection<String>> {
    ...
    private Collection<String> deserializeUsingCustom(JsonParser jsonParser, DeserializationContext deserializationContext, Collection<String> collection) {
        ...
        while (true) {
            ...
            if (nextToken != JsonToken.END_ARRAY) {
                collection.add(nextToken == JsonToken.VALUE_NULL ? null : jsonDeserializer.mo40306deserialize(jsonParser, deserializationContext));
            } else {
                return collection;
            }
        }
    ...
    private final Collection<String> handleNonArray(JsonParser jsonParser, DeserializationContext deserializationContext, Collection<String> collection) {
        ...
        JsonDeserializer<String> jsonDeserializer = this._valueDeserializer;
        collection.add(jsonParser.getCurrentToken() == JsonToken.VALUE_NULL ? null : jsonDeserializer == null ? jsonParser.getText() : jsonDeserializer.mo40306deserialize(jsonParser, deserializationContext));
        return collection;
    }

    @Override // org.codehaus.jackson.map.JsonDeserializer
    /* renamed from: deserialize  reason: collision with other method in class */
    public Collection<String> mo40306deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
        try {
