...
public abstract class FromStringDeserializer<T> extends StdScalarDeserializer<T> {
    ...
    public static class CurrencyDeserializer extends FromStringDeserializer<Currency> {
        ...
        public Currency mo40259_deserialize(String str, DeserializationContext deserializationContext) {
    ...
    protected static class InetAddressDeserializer extends FromStringDeserializer<InetAddress> {
        ...
        @Override // org.codehaus.jackson.map.deser.FromStringDeserializer
        /* renamed from: _deserialize  reason: avoid collision after fix types in other method */
        public InetAddress mo40259_deserialize(String str, DeserializationContext deserializationContext) {
    ...
    protected static class LocaleDeserializer extends FromStringDeserializer<Locale> {
        ...
        @Override // org.codehaus.jackson.map.deser.FromStringDeserializer
        /* renamed from: _deserialize  reason: avoid collision after fix types in other method */
        public Locale mo40259_deserialize(String str, DeserializationContext deserializationContext) {
    ...
    public static class PatternDeserializer extends FromStringDeserializer<Pattern> {
        ...
        @Override // org.codehaus.jackson.map.deser.FromStringDeserializer
        /* renamed from: _deserialize  reason: avoid collision after fix types in other method */
        public Pattern mo40259_deserialize(String str, DeserializationContext deserializationContext) {
    ...
    protected static class TimeZoneDeserializer extends FromStringDeserializer<TimeZone> {
        ...
        @Override // org.codehaus.jackson.map.deser.FromStringDeserializer
        /* renamed from: _deserialize  reason: avoid collision after fix types in other method */
        public TimeZone mo40259_deserialize(String str, DeserializationContext deserializationContext) {
    ...
    public static class URIDeserializer extends FromStringDeserializer<URI> {
        ...
        @Override // org.codehaus.jackson.map.deser.FromStringDeserializer
        /* renamed from: _deserialize  reason: avoid collision after fix types in other method */
        public URI mo40259_deserialize(String str, DeserializationContext deserializationContext) {
    ...
    public static class URLDeserializer extends FromStringDeserializer<URL> {
        ...
        @Override // org.codehaus.jackson.map.deser.FromStringDeserializer
        /* renamed from: _deserialize  reason: avoid collision after fix types in other method */
        public URL mo40259_deserialize(String str, DeserializationContext deserializationContext) {
            return new URL(str);
        }
    }
    ...
    public static class UUIDDeserializer extends FromStringDeserializer<UUID> {
        ...
        @Override // org.codehaus.jackson.map.deser.FromStringDeserializer
        /* renamed from: _deserialize  reason: avoid collision after fix types in other method */
        public UUID mo40259_deserialize(String str, DeserializationContext deserializationContext) {
    ...
    protected abstract T mo40259_deserialize(String str, DeserializationContext deserializationContext);
    ...
    public final T mo40306deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
        ...
        try {
            T mo40259_deserialize = mo40259_deserialize(trim, deserializationContext);
            if (mo40259_deserialize != null) {
                return mo40259_deserialize;
            }
