...
public abstract class AnnotationIntrospector {
    ...
    public static class Pair extends AnnotationIntrospector {
        ...
        public Object mo40307findDeserializer(Annotated annotated, BeanProperty beanProperty) {
            Object mo40307findDeserializer = this._primary.mo40307findDeserializer(annotated, beanProperty);
            return mo40307findDeserializer == null ? this._secondary.mo40307findDeserializer(annotated, beanProperty) : mo40307findDeserializer;
        }
        ...
        public Object mo40308findSerializer(Annotated annotated, BeanProperty beanProperty) {
            Object mo40308findSerializer = this._primary.mo40308findSerializer(annotated, beanProperty);
            return mo40308findSerializer == null ? this._secondary.mo40308findSerializer(annotated, beanProperty) : mo40308findSerializer;
        }
    ...
    public Object findDeserializer(Annotated annotated) {
        return mo40307findDeserializer(annotated, null);
    }
    ...
    public Object findSerializer(Annotated annotated) {
        return mo40308findSerializer(annotated, null);
    }
