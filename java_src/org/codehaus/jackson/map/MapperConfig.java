...
public abstract class MapperConfig<T extends MapperConfig<T>> implements ClassIntrospector.MixInResolver {
    ...
    public abstract T mo40192createUnshared(SubtypeResolver subtypeResolver);

    @Deprecated
    /* renamed from: createUnshared */
    public abstract T mo40193createUnshared(TypeResolverBuilder<?> typeResolverBuilder, VisibilityChecker<?> visibilityChecker, SubtypeResolver subtypeResolver);
    ...
    public abstract T mo40194withAnnotationIntrospector(AnnotationIntrospector annotationIntrospector);

    /* renamed from: withClassIntrospector */
    public abstract T mo40195withClassIntrospector(ClassIntrospector<? extends BeanDescription> classIntrospector);

    /* renamed from: withDateFormat */
    public abstract T mo40196withDateFormat(DateFormat dateFormat);

    /* renamed from: withHandlerInstantiator */
    public abstract T mo40197withHandlerInstantiator(HandlerInstantiator handlerInstantiator);

    /* renamed from: withPropertyNamingStrategy */
    public abstract T mo40198withPropertyNamingStrategy(PropertyNamingStrategy propertyNamingStrategy);

    /* renamed from: withSubtypeResolver */
    public abstract T mo40199withSubtypeResolver(SubtypeResolver subtypeResolver);

    /* renamed from: withTypeFactory */
    public abstract T mo40200withTypeFactory(TypeFactory typeFactory);

    /* renamed from: withTypeResolverBuilder */
    public abstract T mo40201withTypeResolverBuilder(TypeResolverBuilder<?> typeResolverBuilder);

    /* renamed from: withVisibilityChecker */
    public abstract T mo40202withVisibilityChecker(VisibilityChecker<?> visibilityChecker);
}
