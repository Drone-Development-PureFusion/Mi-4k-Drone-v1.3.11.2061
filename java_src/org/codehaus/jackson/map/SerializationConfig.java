...
public class SerializationConfig extends MapperConfig<SerializationConfig> {
    ...
    public /* bridge */ /* synthetic */ SerializationConfig mo40193createUnshared(TypeResolverBuilder typeResolverBuilder, VisibilityChecker visibilityChecker, SubtypeResolver subtypeResolver) {
    ...
    public SerializationConfig mo40192createUnshared(SubtypeResolver subtypeResolver) {
    ...
    @Deprecated
    /* renamed from: createUnshared  reason: collision with other method in class */
    public SerializationConfig mo40193createUnshared(TypeResolverBuilder<?> typeResolverBuilder, VisibilityChecker<?> visibilityChecker, SubtypeResolver subtypeResolver) {
    ...
    public SerializationConfig mo40194withAnnotationIntrospector(AnnotationIntrospector annotationIntrospector) {
    ...
    public /* bridge */ /* synthetic */ SerializationConfig mo40195withClassIntrospector(ClassIntrospector classIntrospector) {
    ...
    public SerializationConfig mo40195withClassIntrospector(ClassIntrospector<? extends BeanDescription> classIntrospector) {
    ...
    public SerializationConfig mo40196withDateFormat(DateFormat dateFormat) {
    ...
    public SerializationConfig mo40197withHandlerInstantiator(HandlerInstantiator handlerInstantiator) {
    ...
    public SerializationConfig mo40198withPropertyNamingStrategy(PropertyNamingStrategy propertyNamingStrategy) {
    ...
    public SerializationConfig mo40199withSubtypeResolver(SubtypeResolver subtypeResolver) {
    ...
    public SerializationConfig mo40200withTypeFactory(TypeFactory typeFactory) {
        return new SerializationConfig(this, this._base.withTypeFactory(typeFactory));
    }

    @Override // org.codehaus.jackson.map.MapperConfig
    /* renamed from: withTypeResolverBuilder */
    public /* bridge */ /* synthetic */ SerializationConfig mo40201withTypeResolverBuilder(TypeResolverBuilder typeResolverBuilder) {
    ...
    public SerializationConfig mo40201withTypeResolverBuilder(TypeResolverBuilder<?> typeResolverBuilder) {
    ...
    public /* bridge */ /* synthetic */ SerializationConfig mo40202withVisibilityChecker(VisibilityChecker visibilityChecker) {
    ...
    public SerializationConfig mo40202withVisibilityChecker(VisibilityChecker<?> visibilityChecker) {
