...
public class DeserializationConfig extends MapperConfig<DeserializationConfig> {
    ...
    public DeserializationConfig mo40192createUnshared(SubtypeResolver subtypeResolver) {
    ...
    @Deprecated
    /* renamed from: createUnshared */
    public DeserializationConfig mo40193createUnshared(TypeResolverBuilder<?> typeResolverBuilder, VisibilityChecker<?> visibilityChecker, SubtypeResolver subtypeResolver) {
        return mo40192createUnshared(subtypeResolver).mo40201withTypeResolverBuilder(typeResolverBuilder).mo40202withVisibilityChecker(visibilityChecker);
    }

    @Override // org.codehaus.jackson.map.MapperConfig
    /* renamed from: createUnshared  reason: collision with other method in class */
    public /* bridge */ /* synthetic */ DeserializationConfig mo40193createUnshared(TypeResolverBuilder typeResolverBuilder, VisibilityChecker visibilityChecker, SubtypeResolver subtypeResolver) {
        return mo40193createUnshared((TypeResolverBuilder<?>) typeResolverBuilder, (VisibilityChecker<?>) visibilityChecker, subtypeResolver);
    }
    ...
    public DeserializationConfig mo40194withAnnotationIntrospector(AnnotationIntrospector annotationIntrospector) {
    ...
    public DeserializationConfig mo40195withClassIntrospector(ClassIntrospector<? extends BeanDescription> classIntrospector) {
    ...
    public /* bridge */ /* synthetic */ DeserializationConfig mo40195withClassIntrospector(ClassIntrospector classIntrospector) {
        return mo40195withClassIntrospector((ClassIntrospector<? extends BeanDescription>) classIntrospector);
    }

    /* JADX WARN: Can't rename method to resolve collision */
    @Override // org.codehaus.jackson.map.MapperConfig
    /* renamed from: withDateFormat */
    public DeserializationConfig mo40196withDateFormat(DateFormat dateFormat) {
    ...
    public DeserializationConfig mo40197withHandlerInstantiator(HandlerInstantiator handlerInstantiator) {
    ...
    public DeserializationConfig mo40198withPropertyNamingStrategy(PropertyNamingStrategy propertyNamingStrategy) {
    ...
    public DeserializationConfig mo40199withSubtypeResolver(SubtypeResolver subtypeResolver) {
    ...
    public DeserializationConfig mo40200withTypeFactory(TypeFactory typeFactory) {
    ...
    public DeserializationConfig mo40201withTypeResolverBuilder(TypeResolverBuilder<?> typeResolverBuilder) {
    ...
    public /* bridge */ /* synthetic */ DeserializationConfig mo40201withTypeResolverBuilder(TypeResolverBuilder typeResolverBuilder) {
        return mo40201withTypeResolverBuilder((TypeResolverBuilder<?>) typeResolverBuilder);
    }

    /* JADX WARN: Can't rename method to resolve collision */
    @Override // org.codehaus.jackson.map.MapperConfig
    /* renamed from: withVisibilityChecker */
    public DeserializationConfig mo40202withVisibilityChecker(VisibilityChecker<?> visibilityChecker) {
    ...
    public /* bridge */ /* synthetic */ DeserializationConfig mo40202withVisibilityChecker(VisibilityChecker visibilityChecker) {
        return mo40202withVisibilityChecker((VisibilityChecker<?>) visibilityChecker);
    }
}
