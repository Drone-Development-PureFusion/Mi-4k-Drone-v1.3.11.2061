...
public class JacksonJsonProvider implements MessageBodyReader<Object>, MessageBodyWriter<Object>, Versioned {
    ...
    public Object readFrom(Class<Object> cls, Type type, Annotation[] annotationArr, MediaType mediaType, MultivaluedMap<String, String> multivaluedMap, InputStream inputStream) {
        ObjectMapper locateMapper = locateMapper(cls, mediaType);
        JsonParser mo40300createJsonParser = locateMapper.getJsonFactory().mo40300createJsonParser(inputStream);
        mo40300createJsonParser.disable(JsonParser.Feature.AUTO_CLOSE_SOURCE);
        return locateMapper.readValue(mo40300createJsonParser, locateMapper.constructType(type));
    }
    ...
    public void writeTo(Object obj, Class<?> cls, Type type, Annotation[] annotationArr, MediaType mediaType, MultivaluedMap<String, Object> multivaluedMap, OutputStream outputStream) {
        ...
        ObjectMapper locateMapper = locateMapper(cls, mediaType);
        JsonGenerator mo40298createJsonGenerator = locateMapper.getJsonFactory().mo40298createJsonGenerator(outputStream, findEncoding(mediaType, multivaluedMap));
        mo40298createJsonGenerator.disable(JsonGenerator.Feature.AUTO_CLOSE_TARGET);
        if (locateMapper.getSerializationConfig().isEnabled(SerializationConfig.Feature.INDENT_OUTPUT)) {
            mo40298createJsonGenerator.useDefaultPrettyPrinter();
        }
        ...
        if (this._jsonpFunctionName != null) {
            locateMapper.writeValue(mo40298createJsonGenerator, new JSONPObject(this._jsonpFunctionName, obj, javaType));
        } else if (javaType != null) {
            locateMapper.typedWriter(javaType).writeValue(mo40298createJsonGenerator, obj);
        } else {
            locateMapper.writeValue(mo40298createJsonGenerator, obj);
        }
    }
}
