...
import org.codehaus.jackson.p354io.CharacterEscapes;
import org.codehaus.jackson.p354io.IOContext;
import org.codehaus.jackson.p354io.InputDecorator;
import org.codehaus.jackson.p354io.OutputDecorator;
import org.codehaus.jackson.p354io.UTF8Writer;
...
public class JsonFactory implements Versioned {
    ...
    protected JsonParser mo40295_createJsonParser(InputStream inputStream, IOContext iOContext) {
    ...
    /* renamed from: _createJsonParser */
    protected JsonParser mo40296_createJsonParser(byte[] bArr, int i, int i2, IOContext iOContext) {
    ...
    public JsonGenerator mo40297createJsonGenerator(OutputStream outputStream) {
        return mo40298createJsonGenerator(outputStream, JsonEncoding.UTF8);
    }

    /* renamed from: createJsonGenerator */
    public JsonGenerator mo40298createJsonGenerator(OutputStream outputStream, JsonEncoding jsonEncoding) {
    ...
    public JsonParser mo40299createJsonParser(File file) {
        ...
        return mo40295_createJsonParser(fileInputStream, _createContext);
    }

    /* renamed from: createJsonParser */
    public JsonParser mo40300createJsonParser(InputStream inputStream) {
        ...
        return mo40295_createJsonParser(inputStream, _createContext);
    }
    ...
    /* renamed from: createJsonParser */
    public JsonParser mo40301createJsonParser(URL url) {
        ...
        return mo40295_createJsonParser(_optimizedStreamFromURL, _createContext);
    }

    /* renamed from: createJsonParser */
    public JsonParser mo40302createJsonParser(byte[] bArr) {
        InputStream decorate;
        IOContext _createContext = _createContext(bArr, true);
        return (this._inputDecorator == null || (decorate = this._inputDecorator.decorate(_createContext, bArr, 0, bArr.length)) == null) ? mo40296_createJsonParser(bArr, 0, bArr.length, _createContext) : mo40295_createJsonParser(decorate, _createContext);
    }

    /* renamed from: createJsonParser */
    public JsonParser mo40303createJsonParser(byte[] bArr, int i, int i2) {
        InputStream decorate;
        IOContext _createContext = _createContext(bArr, true);
        return (this._inputDecorator == null || (decorate = this._inputDecorator.decorate(_createContext, bArr, i, i2)) == null) ? mo40296_createJsonParser(bArr, i, i2, _createContext) : mo40295_createJsonParser(decorate, _createContext);
    }
    ...
    public ObjectCodec mo40189getCodec() {
