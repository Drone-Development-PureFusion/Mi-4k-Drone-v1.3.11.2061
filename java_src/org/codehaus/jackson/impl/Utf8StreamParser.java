                    ...
                    if (iArr[i5] != 0) {
                        ...
                        switch (iArr[i5]) {
                            ...
                            case 4:
                                ...
                                i = i6;
                                i5 = (_decodeUtf8_4 & AbstractC8240d.f27013bp) | 56320;
                                break;
                            default:
                                if (i5 >= 32) {
        ...
        while (i11 < i9) {
            ...
            if (i12 > 127) {
                ...
                if (i8 > 2) {
                    ...
                    int i18 = (i17 & AbstractC8240d.f27013bp) | 56320;
                    i5 = i13;
                    i6 = i10 + 1;
                ...
                if (i6 != 39 && iArr[i6] == 0) {
                    ...
                    switch (iArr[i6]) {
                        ...
                        case 4:
                            ...
                            i = 56320 | (_decodeUtf8_4 & AbstractC8240d.f27013bp);
                            break;
                        default:
                            if (i6 < 32) {
    ...
    public JsonToken nextToken() {
        ...
        if (_skipWSOrEnd == 93) {
            if (!this._parsingContext.inArray()) {
                _reportMismatchedEndMarker(_skipWSOrEnd, C0494h.f735w);
            }
