...
public final class UTF32Reader extends BaseReader {
    ...
    @Override // org.codehaus.jackson.p354io.BaseReader, java.io.Reader, java.io.Closeable, java.lang.AutoCloseable
    public /* bridge */ /* synthetic */ void close() {
        super.close();
    }

    @Override // org.codehaus.jackson.p354io.BaseReader, java.io.Reader
    ...
    public int read(char[] cArr, int i, int i2) {
        ...
        while (true) {
            ...
            if (i5 > 65535) {
                ...
                i5 = (i9 & AbstractC8240d.f27013bp) | 56320;
                if (i4 >= i6) {
