package org.codehaus.jackson.p355xc;
...
public class JaxbAnnotationIntrospector extends AnnotationIntrospector implements Versioned {
    ...
    /* loaded from: classes3.dex */
    public static /* synthetic */ class C117231 {
    ...
    public static class AnnotatedProperty implements AnnotatedElement {
        ...
        /* renamed from: pd */
        private final PropertyDescriptor f37004pd;

        private AnnotatedProperty(PropertyDescriptor propertyDescriptor) {
            this.f37004pd = propertyDescriptor;
        }

        /* synthetic */ AnnotatedProperty(PropertyDescriptor propertyDescriptor, C117231 c117231) {
        ...
        public <T extends Annotation> T getAnnotation(Class<T> cls) {
            T t;
            Method readMethod = this.f37004pd.getReadMethod();
            if (readMethod == null || (t = (T) readMethod.getAnnotation(cls)) == null) {
                Method writeMethod = this.f37004pd.getWriteMethod();
                if (writeMethod == null) {
                    return null;
                }
    ...
    protected TypeResolverBuilder<?> _typeResolverFromXmlElements(AnnotatedMember annotatedMember) {
        ...
        return new StdTypeResolverBuilder().init(JsonTypeInfo.EnumC11699Id.NAME, (TypeIdResolver) null).inclusion(JsonTypeInfo.EnumC11698As.WRAPPER_OBJECT);
    }
    ...
    protected XmlAdapter<Object, Object> findAdapter(Annotated annotated, boolean z) {
        ...
        Member member = (Member) annotated.mo40267getAnnotated();
    ...
    protected XmlAdapter<Object, Object> findAdapterForClass(AnnotatedClass annotatedClass, boolean z) {
        XmlJavaTypeAdapter annotation = annotatedClass.mo40267getAnnotated().getAnnotation(XmlJavaTypeAdapter.class);
        if (annotation != null) {
    ...
    protected <A extends Annotation> A findAnnotation(Class<A> cls, Annotated annotated, boolean z, boolean z2, boolean z3) {
        ...
        if (!(annotated instanceof AnnotatedMethod) || (findPropertyDescriptor = findPropertyDescriptor((AnnotatedMethod) annotated)) == null || (a2 = (A) new AnnotatedProperty(findPropertyDescriptor, null).getAnnotation(cls)) == null) {
            AnnotatedElement mo40267getAnnotated = annotated.mo40267getAnnotated();
            if (annotated instanceof AnnotatedParameter) {
                ...
                A a4 = (A) mo40267getAnnotated.getAnnotation(cls);
                if (a4 != null) {
                    return a4;
                }
                if (mo40267getAnnotated instanceof Member) {
                    Class<?> declaringClass = ((Member) mo40267getAnnotated).getDeclaringClass();
                    if (z2 && (a = (A) declaringClass.getAnnotation(cls)) != null) {
                        return a;
                    }
                    cls2 = declaringClass;
                } else if (!(mo40267getAnnotated instanceof Class)) {
                    throw new IllegalStateException("Unsupported annotated member: " + annotated.getClass().getName());
                } else {
                    cls2 = (Class) mo40267getAnnotated;
                }
            }
            if (cls2 != null) {
                if (z3) {
    ...
    public VisibilityChecker<?> findAutoDetectVisibility(AnnotatedClass annotatedClass, VisibilityChecker<?> visibilityChecker) {
        ...
        switch (C117231.$SwitchMap$javax$xml$bind$annotation$XmlAccessType[findAccessType.ordinal()]) {
            case 1:
                return visibilityChecker.mo40271withFieldVisibility(JsonAutoDetect.Visibility.ANY).mo40274withSetterVisibility(JsonAutoDetect.Visibility.NONE).mo40272withGetterVisibility(JsonAutoDetect.Visibility.NONE).mo40273withIsGetterVisibility(JsonAutoDetect.Visibility.NONE);
            case 2:
                return visibilityChecker.mo40271withFieldVisibility(JsonAutoDetect.Visibility.NONE).mo40274withSetterVisibility(JsonAutoDetect.Visibility.NONE).mo40272withGetterVisibility(JsonAutoDetect.Visibility.NONE).mo40273withIsGetterVisibility(JsonAutoDetect.Visibility.NONE);
            case 3:
                return visibilityChecker.mo40271withFieldVisibility(JsonAutoDetect.Visibility.NONE).mo40274withSetterVisibility(JsonAutoDetect.Visibility.PUBLIC_ONLY).mo40272withGetterVisibility(JsonAutoDetect.Visibility.PUBLIC_ONLY).mo40273withIsGetterVisibility(JsonAutoDetect.Visibility.PUBLIC_ONLY);
            case 4:
                return visibilityChecker.mo40271withFieldVisibility(JsonAutoDetect.Visibility.PUBLIC_ONLY).mo40274withSetterVisibility(JsonAutoDetect.Visibility.PUBLIC_ONLY).mo40272withGetterVisibility(JsonAutoDetect.Visibility.PUBLIC_ONLY).mo40273withIsGetterVisibility(JsonAutoDetect.Visibility.PUBLIC_ONLY);
            default:
                return visibilityChecker;
        }
    }
    ...
    public String findDeserializablePropertyName(AnnotatedField annotatedField) {
        ...
        Field mo40267getAnnotated = annotatedField.mo40267getAnnotated();
        String findJaxbPropertyName = findJaxbPropertyName(mo40267getAnnotated, mo40267getAnnotated.getType(), "");
        return findJaxbPropertyName == null ? mo40267getAnnotated.getName() : findJaxbPropertyName;
    }
    ...
    public JsonDeserializer<?> mo40307findDeserializer(Annotated annotated, BeanProperty beanProperty) {
    ...
    public JsonSerializer<?> mo40308findSerializer(Annotated annotated, BeanProperty beanProperty) {
    ...
    protected boolean isInvisible(AnnotatedField annotatedField) {
        boolean z = true;
        for (Annotation annotation : annotatedField.mo40267getAnnotated().getDeclaredAnnotations()) {
        ...
        if (z) {
            ...
            return value != XmlAccessType.FIELD && (value != XmlAccessType.PUBLIC_MEMBER || !Modifier.isPublic(annotatedField.mo40267getAnnotated().getModifiers()));
        }
        return z;
    }
