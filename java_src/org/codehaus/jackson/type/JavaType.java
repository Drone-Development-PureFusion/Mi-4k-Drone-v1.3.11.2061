...
public abstract class JavaType {
    ...
    public final JavaType forcedNarrowBy(Class<?> cls) {
        ...
        if (this._typeHandler != null) {
            _narrow = _narrow.mo40285withTypeHandler(this._typeHandler);
        }
        return _narrow;
    }
    ...
    public abstract JavaType mo40283withContentTypeHandler(Object obj);

    /* renamed from: withTypeHandler */
    public abstract JavaType mo40285withTypeHandler(Object obj);
}
