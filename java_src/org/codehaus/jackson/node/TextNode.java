...
public final class TextNode extends ValueNode {
    ...
    protected void _reportBase64EOF() {
        throw new JsonParseException("Unexpected end-of-String when base64 content", JsonLocation.f36846NA);
    }
    ...
    protected void _reportInvalidBase64(Base64Variant base64Variant, char c, int i, String str) {
        ...
        throw new JsonParseException(str2, JsonLocation.f36846NA);
    }
