...
import org.codehaus.jackson.p354io.SerializedString;
...
public class TokenBuffer extends JsonGenerator {
    ...
    public static final class Parser extends JsonParserMinimalBase {
        ...
        */
        ...
        public JsonLocation getCurrentLocation() {
            return this._location == null ? JsonLocation.f36846NA : this._location;
        }
        ...
        public JsonStreamContext mo40171getParsingContext() {
        ...
        public JsonToken nextToken() {
            ...
            if (this._currToken == JsonToken.FIELD_NAME) {
                ...
                this._parsingContext = this._parsingContext.mo40291getParent();
    ...
    public final JsonWriteContext mo40304getOutputContext() {
    ...
    public final void writeEndArray() {
        ...
        JsonWriteContext mo40291getParent = this._writeContext.mo40291getParent();
        if (mo40291getParent != null) {
            this._writeContext = mo40291getParent;
        }
    }
