...
import org.codehaus.jackson.p354io.MergedStream;
...
public class DataFormatMatcher {
    ...
    public JsonParser createParserWithMatch() {
        ...
        return this._originalStream == null ? this._match.mo40303createJsonParser(this._bufferedData, 0, this._bufferedLength) : this._match.mo40300createJsonParser(getDataStream());
    }
