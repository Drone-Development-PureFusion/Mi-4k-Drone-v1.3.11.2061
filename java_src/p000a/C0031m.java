...
public class C0031m implements AbstractC0009e {
    ...
    /* renamed from: a */
    private static Uri m39884a(String str) {
        if (str == null) {
            return null;
        }
    ...
    /* renamed from: a */
    private static List<Map<String, Object>> m39881a(Map<String, Object> map, String str) {
    ...
    /* renamed from: b */
    public static C0004c m39878b(Map<String, Object> map, Uri uri) {
        Uri uri2;
        ...
        for (Map map2 : list) {
            List<Map<String, Object>> m39881a = m39881a(map2, "url");
            List<Map<String, Object>> m39881a2 = m39881a(map2, f97h);
            List<Map<String, Object>> m39881a3 = m39881a(map2, "class");
            List<Map<String, Object>> m39881a4 = m39881a(map2, "app_name");
            int max = Math.max(m39881a.size(), Math.max(m39881a2.size(), Math.max(m39881a3.size(), m39881a4.size())));
            int i = 0;
            while (i < max) {
                arrayList.add(new C0004c.C0005a((String) (m39881a2.size() > i ? m39881a2.get(i).get("value") : null), (String) (m39881a3.size() > i ? m39881a3.get(i).get("value") : null), m39884a((String) (m39881a.size() > i ? m39881a.get(i).get("value") : null)), (String) (m39881a4.size() > i ? m39881a4.get(i).get("value") : null)));
                i++;
            }
        }
        ...
        if (list2 == null || list2.size() <= 0) {
            ...
            if (uri2 != null && list3 != null && list3.size() > 0) {
                uri2 = m39884a((String) ((Map) list3.get(0)).get("value"));
            }
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: b */
    public static String m39879b(URLConnection uRLConnection) {
    ...
    /* renamed from: b */
    public static Map<String, Object> m39877b(JSONArray jSONArray) {
        ArrayList arrayList;
    ...
    /* renamed from: a */
    public C0018l<C0004c> mo39885a(final Uri uri) {
        final C0015i c0015i = new C0015i();
        final C0015i c0015i2 = new C0015i();
        return C0018l.m39928a((Callable) new Callable<Void>() { // from class: a.m.3
            ...
            public Void call() {
                ...
                while (url2 != null) {
                    ...
                    if (openConnection instanceof HttpURLConnection) {
                        ...
                        if (httpURLConnection2.getResponseCode() < 300 || httpURLConnection2.getResponseCode() >= 400) {
                            ...
                            URL url3 = new URL(httpURLConnection2.getHeaderField(C11086e.f35686H));
                ...
                try {
                    c0015i.m39944a(C0031m.m39879b(httpURLConnection));
                    c0015i2.m39944a(httpURLConnection.getContentType());
                    return null;
                } finally {
        ...
        }).m39910d(new AbstractC0016j<Void, C0018l<JSONArray>>() { // from class: a.m.2
            @Override // p000a.AbstractC0016j
            /* renamed from: a */
            public C0018l<JSONArray> mo40096then(C0018l<Void> c0018l) {
                final C0018l.C0030a m39939a = C0018l.m39939a();
                ...
                webView.setWebViewClient(new WebViewClient() { // from class: a.m.2.1
                    ...
                    /* renamed from: a */
                    private void m39874a(WebView webView2) {
                        if (!this.f111b) {
                            this.f111b = true;
                ...
                webView.addJavascriptInterface(new Object() { // from class: a.m.2.2
                    ...
                    public void setValue(String str) {
                        try {
                            m39939a.m39891a((C0018l.C0030a) new JSONArray(str));
                        } catch (JSONException e) {
                            m39939a.m39892a((Exception) e);
                        }
                    }
                }, "boltsWebViewAppLinkResolverResult");
                webView.loadDataWithBaseURL(uri.toString(), (String) c0015i.m39945a(), c0015i2.m39945a() != null ? ((String) c0015i2.m39945a()).split(";")[0] : null, null, null);
                return m39939a.m39893a();
            }
        }, C0018l.f50b).m39916c(new AbstractC0016j<JSONArray, C0004c>() { // from class: a.m.1
            @Override // p000a.AbstractC0016j
            /* renamed from: a */
            public C0004c mo40096then(C0018l<JSONArray> c0018l) {
                return C0031m.m39878b(C0031m.m39877b(c0018l.m39908e()), uri);
            }
        });
    }
}
