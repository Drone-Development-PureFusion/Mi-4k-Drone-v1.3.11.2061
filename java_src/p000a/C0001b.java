...
final class C0001b {
    ...
    /* renamed from: a */
    public static ExecutorService m39986a() {
        ThreadPoolExecutor threadPoolExecutor = new ThreadPoolExecutor(f1a, f2b, 1L, TimeUnit.SECONDS, new LinkedBlockingQueue());
        m39984a(threadPoolExecutor, true);
        return threadPoolExecutor;
    }

    /* renamed from: a */
    public static ExecutorService m39985a(ThreadFactory threadFactory) {
    ...
    @SuppressLint({"NewApi"})
    /* renamed from: a */
    public static void m39984a(ThreadPoolExecutor threadPoolExecutor, boolean z) {
    ...
    /* renamed from: b */
    public static Executor m39983b() {
        return f4d.f6e;
    }
}
