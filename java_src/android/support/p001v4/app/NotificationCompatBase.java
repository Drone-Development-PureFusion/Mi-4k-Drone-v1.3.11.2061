...
class NotificationCompatBase {
    ...
    public static abstract class Action {
        ...
        public interface Factory {
            /* renamed from: build */
            Action mo40002build(int i, CharSequence charSequence, PendingIntent pendingIntent, Bundle bundle, RemoteInputCompatBase.RemoteInput[] remoteInputArr);

            /* renamed from: newArray */
            Action[] mo40003newArray(int i);
        }
        ...
        public abstract RemoteInputCompatBase.RemoteInput[] mo40001getRemoteInputs();
