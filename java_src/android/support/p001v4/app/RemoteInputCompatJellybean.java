...
class RemoteInputCompatJellybean {
    ...
    static RemoteInputCompatBase.RemoteInput fromBundle(Bundle bundle, RemoteInputCompatBase.RemoteInput.Factory factory) {
        return factory.mo40006build(bundle.getString(KEY_RESULT_KEY), bundle.getCharSequence("label"), bundle.getCharSequenceArray(KEY_CHOICES), bundle.getBoolean(KEY_ALLOW_FREE_FORM_INPUT), bundle.getBundle(KEY_EXTRAS));
    }
    ...
    public static RemoteInputCompatBase.RemoteInput[] fromBundleArray(Bundle[] bundleArr, RemoteInputCompatBase.RemoteInput.Factory factory) {
        ...
        RemoteInputCompatBase.RemoteInput[] mo40007newArray = factory.mo40007newArray(bundleArr.length);
        for (int i = 0; i < bundleArr.length; i++) {
            mo40007newArray[i] = fromBundle(bundleArr[i], factory);
        }
        return mo40007newArray;
    }
