...
class RemoteInputCompatApi20 {
    ...
    public static RemoteInputCompatBase.RemoteInput[] toCompat(RemoteInput[] remoteInputArr, RemoteInputCompatBase.RemoteInput.Factory factory) {
        ...
        RemoteInputCompatBase.RemoteInput[] mo40007newArray = factory.mo40007newArray(remoteInputArr.length);
        int i = 0;
        while (true) {
            int i2 = i;
            ...
            mo40007newArray[i2] = factory.mo40006build(remoteInput.getResultKey(), remoteInput.getLabel(), remoteInput.getChoices(), remoteInput.getAllowFreeFormInput(), remoteInput.getExtras());
            i = i2 + 1;
        }
    }
}
