...
public class NotificationCompatJellybean {
    ...
    private static NotificationCompatBase.Action getActionFromBundle(Bundle bundle, NotificationCompatBase.Action.Factory factory, RemoteInputCompatBase.RemoteInput.Factory factory2) {
        return factory.mo40002build(bundle.getInt(KEY_ICON), bundle.getCharSequence("title"), (PendingIntent) bundle.getParcelable(KEY_ACTION_INTENT), bundle.getBundle(KEY_EXTRAS), RemoteInputCompatJellybean.fromBundleArray(BundleUtil.getBundleArrayFromBundle(bundle, KEY_REMOTE_INPUTS), factory2));
    }
    ...
    public static NotificationCompatBase.Action[] getActionsFromParcelableArrayList(ArrayList<Parcelable> arrayList, NotificationCompatBase.Action.Factory factory, RemoteInputCompatBase.RemoteInput.Factory factory2) {
        ...
        NotificationCompatBase.Action[] mo40003newArray = factory.mo40003newArray(arrayList.size());
        int i = 0;
        while (true) {
            int i2 = i;
            if (i2 >= mo40003newArray.length) {
                return mo40003newArray;
            }
            mo40003newArray[i2] = getActionFromBundle((Bundle) arrayList.get(i2), factory, factory2);
            i = i2 + 1;
        }
    }
    ...
    private static Bundle getBundleForAction(NotificationCompatBase.Action action) {
        ...
        bundle.putParcelableArray(KEY_REMOTE_INPUTS, RemoteInputCompatJellybean.toBundleArray(action.mo40001getRemoteInputs()));
        return bundle;
    }
    ...
    public static NotificationCompatBase.Action readAction(NotificationCompatBase.Action.Factory factory, RemoteInputCompatBase.RemoteInput.Factory factory2, int i, CharSequence charSequence, PendingIntent pendingIntent, Bundle bundle) {
        ...
        return factory.mo40002build(i, charSequence, pendingIntent, bundle, remoteInputArr);
    }
    ...
    public static Bundle writeActionAndGetExtras(Notification.Builder builder, NotificationCompatBase.Action action) {
        ...
        if (action.mo40001getRemoteInputs() != null) {
            bundle.putParcelableArray("android.support.remoteInputs", RemoteInputCompatJellybean.toBundleArray(action.mo40001getRemoteInputs()));
        }
        return bundle;
    }
}
