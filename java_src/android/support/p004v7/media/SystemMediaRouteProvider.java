...
import android.support.p004v7.media.MediaRouteDescriptor;
import android.support.p004v7.media.MediaRouteProvider;
import android.support.p004v7.media.MediaRouteProviderDescriptor;
import android.support.p004v7.media.MediaRouter;
import android.support.p004v7.media.MediaRouterApi24;
import android.support.p004v7.media.MediaRouterJellybean;
import android.support.p004v7.media.MediaRouterJellybeanMr1;
import android.support.p004v7.media.MediaRouterJellybeanMr2;
...
public abstract class SystemMediaRouteProvider extends MediaRouteProvider {
    ...
    /* renamed from: android.support.v7.media.SystemMediaRouteProvider$Api24Impl */
    /* loaded from: classes.dex */
    public static class Api24Impl extends JellybeanMr2Impl {
        ...
        @Override // android.support.p004v7.media.SystemMediaRouteProvider.JellybeanMr2Impl, android.support.p004v7.media.SystemMediaRouteProvider.JellybeanMr1Impl, android.support.p004v7.media.SystemMediaRouteProvider.JellybeanImpl
    ...
    public static class JellybeanImpl extends SystemMediaRouteProvider implements MediaRouterJellybean.Callback, MediaRouterJellybean.VolumeCallback {
        ...
        public JellybeanImpl(Context context, SyncCallback syncCallback) {
            ...
            this.mUserRouteCategoryObj = MediaRouterJellybean.createRouteCategory(this.mRouterObj, context.getResources().getString(C0203R.C0206string.mr_user_route_category_name), false);
            updateSystemRoutes();
        }
        ...
        @Override // android.support.p004v7.media.MediaRouterJellybean.Callback
        ...
        public void onRouteSelected(int i, Object obj) {
            MediaRouter.RouteInfo systemRouteByDescriptorId;
            ...
            if (findSystemRouteRecord < 0 || (systemRouteByDescriptorId = this.mSyncCallback.getSystemRouteByDescriptorId(this.mSystemRouteRecords.get(findSystemRouteRecord).mRouteDescriptorId)) == null) {
                return;
            }
        ...
        @Override // android.support.p004v7.media.SystemMediaRouteProvider
    ...
    public static class JellybeanMr1Impl extends JellybeanImpl implements MediaRouterJellybeanMr1.Callback {
        ...
        @Override // android.support.p004v7.media.SystemMediaRouteProvider.JellybeanImpl
        protected Object createCallbackObj() {
        ...
        @Override // android.support.p004v7.media.MediaRouterJellybeanMr1.Callback
    ...
    public static class JellybeanMr2Impl extends JellybeanMr1Impl {
        ...
        @Override // android.support.p004v7.media.SystemMediaRouteProvider.JellybeanMr1Impl
        protected boolean isConnecting(JellybeanImpl.SystemRouteRecord systemRouteRecord) {
            return MediaRouterJellybeanMr2.RouteInfo.isConnecting(systemRouteRecord.mRouteObj);
        }

        @Override // android.support.p004v7.media.SystemMediaRouteProvider.JellybeanMr1Impl, android.support.p004v7.media.SystemMediaRouteProvider.JellybeanImpl
        protected void onBuildSystemRouteDescriptor(JellybeanImpl.SystemRouteRecord systemRouteRecord, MediaRouteDescriptor.Builder builder) {
            super.onBuildSystemRouteDescriptor(systemRouteRecord, builder);
    ...
    public static class LegacyImpl extends SystemMediaRouteProvider {
        ...
        public void publishRoutes() {
            ...
            setDescriptor(new MediaRouteProviderDescriptor.Builder().addRoute(new MediaRouteDescriptor.Builder(SystemMediaRouteProvider.DEFAULT_ROUTE_ID, resources.getString(C0203R.C0206string.mr_system_route_name)).addControlFilters(CONTROL_FILTERS).setPlaybackStream(3).setPlaybackType(0).setVolumeHandling(1).setVolumeMax(streamMaxVolume).setVolume(this.mLastReportedVolume).build()).build());
        }
