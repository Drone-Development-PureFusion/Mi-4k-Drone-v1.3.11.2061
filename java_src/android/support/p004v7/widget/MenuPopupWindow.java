    ...
    public static class MenuDropDownListView extends DropDownListView {
        ...
        public boolean onHoverEvent(MotionEvent motionEvent) {
            ...
            if (this.mHoverListener != null) {
                ...
                MenuItemImpl mo40025getItem = (motionEvent.getAction() == 10 || (pointToPosition = pointToPosition((int) motionEvent.getX(), (int) motionEvent.getY())) == -1 || (i2 = pointToPosition - i) < 0 || i2 >= menuAdapter.getCount()) ? null : menuAdapter.mo40025getItem(i2);
                MenuItem menuItem = this.mHoveredMenuItem;
                if (menuItem != mo40025getItem) {
                    MenuBuilder adapterMenu = menuAdapter.getAdapterMenu();
                    if (menuItem != null) {
                        this.mHoverListener.onItemHoverExit(adapterMenu, menuItem);
                    }
                    this.mHoveredMenuItem = mo40025getItem;
                    if (mo40025getItem != null) {
                        this.mHoverListener.onItemHoverEnter(adapterMenu, mo40025getItem);
                    }
                }
            }
