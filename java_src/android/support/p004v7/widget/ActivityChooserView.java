...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            switch (getItemViewType(i)) {
                ...
                case 1:
                    ...
                    inflate.setId(1);
                    ((TextView) inflate.findViewById(C0176R.C0178id.title)).setText(ActivityChooserView.this.getContext().getString(C0176R.C0179string.abc_activity_chooser_view_see_all));
                    return inflate;
                default:
                    throw new IllegalArgumentException();
            }
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i) {
        ...
        obtainStyledAttributes.recycle();
        LayoutInflater.from(getContext()).inflate(C0176R.layout.abc_activity_chooser_view, (ViewGroup) this, true);
    ...
    public void showPopupUnchecked(int i) {
        ...
        listPopupWindow.getListView().setContentDescription(getContext().getString(C0176R.C0179string.abc_activitychooserview_choose_application));
    }
