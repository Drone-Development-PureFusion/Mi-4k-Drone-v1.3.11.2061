...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    public SupportMenuItem mo40026setActionView(int i) {
        Context context = this.mMenu.getContext();
        mo40027setActionView(LayoutInflater.from(context).inflate(i, (ViewGroup) new LinearLayout(context), false));
        return this;
    }

    @Override // android.support.p001v4.internal.view.SupportMenuItem, android.view.MenuItem
    /* renamed from: setActionView */
    public SupportMenuItem mo40027setActionView(View view) {
    ...
    public SupportMenuItem mo40028setShowAsActionFlags(int i) {
        setShowAsAction(i);
        return this;
    }
