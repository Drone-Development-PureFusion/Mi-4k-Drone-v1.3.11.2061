...
public class DrawerArrowDrawable extends Drawable {
    ...
    public DrawerArrowDrawable(Context context) {
        ...
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(null, C0176R.styleable.DrawerArrowToggle, C0176R.attr.drawerArrowStyle, C0176R.style.Base_Widget_AppCompat_DrawerArrowToggle);
        ...
        setGapSize(Math.round(obtainStyledAttributes.getDimension(C0176R.styleable.DrawerArrowToggle_gapBetweenBars, 0.0f)));
        this.mSize = obtainStyledAttributes.getDimensionPixelSize(C0176R.styleable.DrawerArrowToggle_drawableSize, 0);
        this.mBarLength = Math.round(obtainStyledAttributes.getDimension(C0176R.styleable.DrawerArrowToggle_barLength, 0.0f));
        this.mArrowHeadLength = Math.round(obtainStyledAttributes.getDimension(C0176R.styleable.DrawerArrowToggle_arrowHeadLength, 0.0f));
