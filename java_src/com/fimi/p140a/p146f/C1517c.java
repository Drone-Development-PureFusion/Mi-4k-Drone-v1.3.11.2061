...
/* renamed from: com.fimi.a.f.c */
/* loaded from: classes.dex */
public class C1517c {
    /* renamed from: a */
    public static long m35391a(int[] iArr, int i) {
        long j = -1;
        int i2 = 0;
        while (true) {
            int i3 = i - 1;
    ...
    /* renamed from: a */
    public static byte[] m35394a(int i) {
    ...
    /* renamed from: a */
    public static byte[] m35393a(long j) {
        byte[] bArr = new byte[4];
    ...
    /* renamed from: a */
    public static byte[] m35392a(short s) {
