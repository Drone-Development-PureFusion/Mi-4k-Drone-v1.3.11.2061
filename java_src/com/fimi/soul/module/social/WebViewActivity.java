...
public class WebViewActivity extends Activity {
    ...
    private class HelloWebViewClient extends WebViewClient {
        ...
        public void onPageStarted(WebView webView, String str, Bitmap bitmap) {
            ...
            if (WebViewActivity.this.temp_url.equals(WebViewActivity.this.main_url)) {
                WebViewActivity.this.back_btn.setImageResource(C1704R.C1705drawable.btn_setting_back_selector);
            } else {
                WebViewActivity.this.back_btn.setImageResource(C1704R.C1705drawable.btn_insurance_close_selector);
            }
        }
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(C1704R.layout.web_view_url);
        this.back_btn = (ImageView) findViewById(C1704R.C1706id.back_btn);
        this.right_bt = (Button) findViewById(C1704R.C1706id.right_bt);
        this.title = (TextView) findViewById(C1704R.C1706id.title);
        C3103au.m29232a(getAssets(), this.title, this.right_bt);
        loadFiileJS();
        ...
        this.mWebView = (WebView) findViewById(C1704R.C1706id.web_view);
