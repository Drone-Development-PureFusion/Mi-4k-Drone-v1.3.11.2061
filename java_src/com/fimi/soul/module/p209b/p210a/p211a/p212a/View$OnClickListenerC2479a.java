...
import java.io.File;
/* renamed from: com.fimi.soul.module.b.a.a.a.a */
/* loaded from: classes.dex */
public class View$OnClickListenerC2479a extends View$OnClickListenerC2484b implements TextWatcher, View.OnClickListener, Runnable {

    /* renamed from: q */
    private static final int f8036q = 720;

    /* renamed from: r */
    private static final int f8037r = 75;

    /* renamed from: s */
    private static final int f8038s = 40;

    /* renamed from: t */
    private static final int f8039t = 70;

    /* renamed from: u */
    private static final int f8040u = 280;

    /* renamed from: v */
    private static final int f8041v = 60;

    public View$OnClickListenerC2479a(AbstractC2513e abstractC2513e) {
        super(abstractC2513e);
    }

    /* renamed from: a */
    private void m31536a(LinearLayout linearLayout, float f) {
        ...
        this.f8063n.setTextSize(2, 18.0f);
    ...
    /* renamed from: a */
    private void m31535a(RelativeLayout relativeLayout, float f) {
    ...
    /* renamed from: a */
    private void m31533a(AsyncImageView asyncImageView) {
    ...
    /* renamed from: b */
    private void m31532b(LinearLayout linearLayout, float f) {
    ...
    /* renamed from: b */
    private void m31531b(RelativeLayout relativeLayout, float f) {
        ...
        layoutParams.weight = 1.0f;
        linearLayout.addView(this.f8055f, layoutParams);
        ...
        linearLayout.addView(this.f8058i, layoutParams2);
        this.f8059j = new AsyncImageView(this.activity) { // from class: com.fimi.soul.module.b.a.a.a.a.1
            ...
            public void onImageGot(String str, Bitmap bitmap) {
                View$OnClickListenerC2479a.this.f8064o = bitmap;
        ...
        this.f8058i.addView(this.f8060k, layoutParams3);
    ...
    public void onCreate() {
        super.onCreate();
        float screenHeight = C10109R.getScreenHeight(this.activity) / 720.0f;
        this.f8065p = 0;
        ...
        this.f8052c.addView(this.f8053d, new LinearLayout.LayoutParams(-1, (int) (70.0f * screenHeight)));
        m31535a(this.f8053d, screenHeight);
        RelativeLayout relativeLayout = new RelativeLayout(this.activity);
        relativeLayout.setBackgroundColor(-1);
        this.f8052c.addView(relativeLayout, new LinearLayout.LayoutParams(-1, -2));
        m31531b(relativeLayout, screenHeight);
        LinearLayout linearLayout = new LinearLayout(this.activity);
        linearLayout.setOrientation(1);
        relativeLayout.addView(linearLayout, new RelativeLayout.LayoutParams(-1, -2));
        m31532b(linearLayout, screenHeight);
        ...
        m31536a(this.f8061l, screenHeight);
    }
}
