...
public class C2277a {
    /* renamed from: a */
    public static int[] m32462a(byte[] bArr) {
        ...
        for (int i = 0; i < bArr.length; i += 4) {
            ...
            arrayList.add(m32461b(bArr2));
            bArr2 = new byte[4];
        }
        int[] iArr = new int[arrayList.size()];
        for (int i2 = 0; i2 < arrayList.size(); i2++) {
            iArr[i2] = m32460c((byte[]) arrayList.get(i2));
        }
        return iArr;
    }

    /* renamed from: b */
    public static byte[] m32461b(byte[] bArr) {
        byte[] bArr2 = new byte[4];
    ...
    /* renamed from: c */
    public static int m32460c(byte[] bArr) {
