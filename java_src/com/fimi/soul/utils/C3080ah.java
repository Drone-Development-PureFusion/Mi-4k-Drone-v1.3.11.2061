...
public class C3080ah {
    ...
    */
    public static int m29334a(String str, String str2, String str3, int i, Handler handler) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            long j2 = 0;
                            while (C9755a.f30449c <= 100.0d && inputStream != null && (read = inputStream.read(bArr)) > 0) {
    ...
    /* renamed from: a */
    public static int m29333a(String str, String str2, String str3, Handler handler) {
        return m29334a(str, str2, str3, 0, handler);
    }
}
