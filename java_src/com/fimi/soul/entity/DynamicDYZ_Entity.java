...
public class DynamicDYZ_Entity implements Serializable {
    ...
    public String toString() {
        return "DynamicDYZ_Entity{warinRadius=" + this.warinRadius + ", limitRadius=" + this.limitRadius + ", limitHeight=" + this.limitHeight + ", encryptValue='" + this.encryptValue + C0494h.f738z + ", logitude=" + this.logitude + ", endDate=" + this.endDate + ", latitude=" + this.latitude + ", insertDate=" + this.insertDate + ", id=" + this.f7781id + ", radius=" + this.radius + ", encryptKey='" + this.encryptKey + C0494h.f738z + ", type=" + this.type + ", startDate=" + this.startDate + ", status=" + this.status + ", remarks='" + this.remarks + C0494h.f738z + ", deviceType=" + this.deviceType + ", distance=" + this.distance + ", noFlyType=" + this.noFlyType + ", currentVersion=" + this.currentVersion + ", pushType=" + this.pushType + ", fcIds='" + this.fcIds + C0494h.f738z + ", whileRange='" + this.whileRange + C0494h.f738z + C0494h.f735w;
    }
}
