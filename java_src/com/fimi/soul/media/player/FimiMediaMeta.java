...
public class FimiMediaMeta {
    ...
    public static class IjkStreamMeta {
        ...
        public String getBitrateInline() {
            return this.mBitrate <= 0 ? C2954b.f10832au : this.mBitrate < 1000 ? String.format(Locale.US, "%d bit/s", Long.valueOf(this.mBitrate)) : String.format(Locale.US, "%d kb/s", Long.valueOf(this.mBitrate / 1000));
        }

        public String getChannelLayoutInline() {
            return this.mChannelLayout <= 0 ? C2954b.f10832au : this.mChannelLayout == 4 ? "mono" : this.mChannelLayout == 3 ? "stereo" : String.format(Locale.US, "%x", Long.valueOf(this.mChannelLayout));
        }

        public String getCodecLongNameInline() {
            return !TextUtils.isEmpty(this.mCodecLongName) ? this.mCodecLongName : !TextUtils.isEmpty(this.mCodecName) ? this.mCodecName : C2954b.f10832au;
        }

        public String getFpsInline() {
            return (this.mFpsNum <= 0 || this.mFpsDen <= 0) ? C2954b.f10832au : String.valueOf(this.mFpsNum / this.mFpsDen);
        }
