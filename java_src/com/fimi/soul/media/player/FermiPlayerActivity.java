...
public class FermiPlayerActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initMediaContoller() {
        this.bottom_layout = (PercentRelativeLayout) findViewById(C1704R.C1706id.bottom_layout);
        this.mEndTime = (TextView) this.bottom_layout.findViewById(C1704R.C1706id.time);
        this.mCurrentTime = (TextView) this.bottom_layout.findViewById(C1704R.C1706id.time_current);
        this.playBtn = (ImageButton) this.bottom_layout.findViewById(C1704R.C1706id.pause);
        this.mProgress = (SeekBar) this.bottom_layout.findViewById(C1704R.C1706id.fmmediacontroller_progress);
        ...
        this.mProgress.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: com.fimi.soul.media.player.FermiPlayerActivity.7
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                ...
                if (FermiPlayerActivity.this.player.isPlaying()) {
                    ...
                    FermiPlayerActivity.this.preferencesUtil.m34544a(progress);
    ...
    private void initPlay() {
        ...
        this.player.setOnPreparedListener(new IMediaPlayer.OnPreparedListener() { // from class: com.fimi.soul.media.player.FermiPlayerActivity.4
            ...
            public void onPrepared(IMediaPlayer iMediaPlayer) {
                ...
                FermiPlayerActivity.this.player.seekTo((int) FermiPlayerActivity.this.preferencesUtil.m34500q());
            }
    ...
    private void play() {
        if (!this.player.isPlaying()) {
            this.player.start();
            this.playBtn.setBackgroundResource(C1704R.C1705drawable.drone_stop);
            setPlay(true);
        }
    }
    ...
    private void showVideoThumbnail(Bitmap bitmap) {
        if (bitmap != null) {
            this.videoThumbnail.setBackground(C1678s.m34590a(bitmap));
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case C1704R.C1706id.mBplayButton /* 2131755414 */:
                play();
                return;
            case C1704R.C1706id.iv_close /* 2131755416 */:
                finish();
                return;
            case C1704R.C1706id.pause /* 2131755833 */:
                if (this.player.isPlaying()) {
                    this.player.pause();
                    this.playBtn.setBackgroundResource(C1704R.C1705drawable.drone_play);
                    setPlay(false);
                    return;
                }
                if (this.finishPlay) {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(C1704R.layout.activity_player);
        initMediaContoller();
        this.videoThumbnail = (ImageView) findViewById(C1704R.C1706id.videoThumbnail);
        this.btnClose = (ImageButton) getWindow().findViewById(C1704R.C1706id.iv_close);
        ...
        this.preferencesUtil.m34544a(0L);
        this.top_layout = findViewById(C1704R.C1706id.rl_topView);
        this.mNameText = (TextView) findViewById(C1704R.C1706id.iv_name);
        ...
        this.player.setOnErrorListener(new IMediaPlayer.OnErrorListener() { // from class: com.fimi.soul.media.player.FermiPlayerActivity.2
            ...
            public boolean onError(IMediaPlayer iMediaPlayer, int i, int i2) {
                ...
                C1688z.m34450a(FermiPlayerActivity.this, (int) C1704R.C1707string.file_error);
        ...
        this.player.setOnCompletionListener(new IMediaPlayer.OnCompletionListener() { // from class: com.fimi.soul.media.player.FermiPlayerActivity.3
            ...
            public void onCompletion(IMediaPlayer iMediaPlayer, int i) {
                ...
                FermiPlayerActivity.this.preferencesUtil.m34544a(0L);
                FermiPlayerActivity.this.playBtn.setBackgroundResource(C1704R.C1705drawable.drone_play);
    ...
    public void onSaveInstanceState(Bundle bundle) {
        this.preferencesUtil.m34544a(this.current_position);
