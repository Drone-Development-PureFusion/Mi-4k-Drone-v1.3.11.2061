...
public final class FimiMediaPlayer extends AbstractMediaPlayer {
    ...
    public static class EventHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            if (fimiMediaPlayer == null || fimiMediaPlayer.mNativeMediaPlayer == 0) {
                DebugLog.m31599w(FimiMediaPlayer.TAG, "FimiMediaPlayer went away with unhandled events");
                return;
            }
            switch (message.what) {
                case 0:
                ...
                case 7:
                    ...
                    return;
                case 100:
                    DebugLog.m31605e(FimiMediaPlayer.TAG, "Error (" + message.arg1 + Constants.ACCEPT_TIME_SEPARATOR_SP + message.arg2 + ")");
                ...
                case 200:
                    switch (message.arg1) {
                        case 3:
                            DebugLog.m31603i(FimiMediaPlayer.TAG, "Info: MEDIA_INFO_VIDEO_RENDERING_START\n");
                            break;
                    }
                ...
                case 10001:
                    ...
                    return;
                default:
                    DebugLog.m31605e(FimiMediaPlayer.TAG, "Unknown message type " + message.what);
                    return;
            }
        }
    }
    ...
    private static void initNativeOnce() {
        synchronized (FimiMediaPlayer.class) {
            ...
            if (!mIsNativeInitialized) {
                ...
                DebugLog.m31599w(TAG, "aizj version=" + lastModified);
            }
        }
    }
    ...
    public void setScreenOnWhilePlaying(boolean z) {
        if (this.mScreenOnWhilePlaying != z) {
            if (z && this.mSurfaceHolder == null) {
                DebugLog.m31599w(TAG, "setScreenOnWhilePlaying(true) is ineffective without a SurfaceHolder");
            }
    ...
    public void setSurface(Surface surface) {
        if (this.mScreenOnWhilePlaying && surface != null) {
            DebugLog.m31599w(TAG, "setScreenOnWhilePlaying(true) is ineffective for Surface");
        }
