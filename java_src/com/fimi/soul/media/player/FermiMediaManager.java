...
public final class FermiMediaManager {
    ...
    public void showPopVideoView(String str) {
        final FermiPlayerDialog fermiPlayerDialog = new FermiPlayerDialog(getContext(), C1704R.style.videoDialog);
        ...
        fermiPlayerDialog.setContentView(FermiPlayerViewBuilder.Builder(getContext(), C1704R.layout.layout_videoview_popup).setFermiMediaPlayer(createFermiMediaPlayer).setOnClickCloseListenner(new FermiPlayerViewBuilder.OnClickCloseListener() { // from class: com.fimi.soul.media.player.FermiMediaManager.4
    ...
    public void showPopVideoViewWithNoSeekBar(String str) {
        this.dialog = new FermiPlayerDialog(getContext(), C1704R.style.videoDialog);
        final IFermiMediaPlayer createFermiMediaPlayer = createFermiMediaPlayer(FermiMediaPlayerType.SystemMediaPlayer);
        createFermiMediaPlayer.setAutoPlay(true);
        this.dialog.setContentView(FermiPlayerViewBuilder.Builder(getContext(), C1704R.layout.layout_videoview_popup).setFermiMediaPlayer(createFermiMediaPlayer).setOnClickCloseListenner(new FermiPlayerViewBuilder.OnClickCloseListener() { // from class: com.fimi.soul.media.player.FermiMediaManager.2
            @Override // com.fimi.soul.media.player.FermiPlayerViewBuilder.OnClickCloseListener
            public void onClose(View view) {
                createFermiMediaPlayer.stop();
