...
final class FermiPlayerViewBuilder {
    ...
    private void buildWindow() {
        ...
        this.btnPlay = (Button) this.popupView.findViewById(C1704R.C1706id.iv_play);
        this.btnClose = (Button) this.popupView.findViewById(C1704R.C1706id.iv_close);
        this.btnPause = (Button) this.popupView.findViewById(C1704R.C1706id.iv_pause);
        this.btnFullscreen = (Button) this.popupView.findViewById(C1704R.C1706id.btn_fullScreen);
        this.seekBar = (SeekBar) this.popupView.findViewById(C1704R.C1706id.sb_seekbar);
        this.tvCurrentPosition = (TextView) this.popupView.findViewById(C1704R.C1706id.tv_position);
        this.tvDuration = (TextView) this.popupView.findViewById(C1704R.C1706id.tv_duration);
        this.surfaceView = (SurfaceView) this.popupView.findViewById(C1704R.C1706id.sf_video);
        this.surfaceView.setZOrderMediaOverlay(true);
        this.sfThumbnail = (SurfaceView) this.popupView.findViewById(C1704R.C1706id.sf_video_thumbnail);
