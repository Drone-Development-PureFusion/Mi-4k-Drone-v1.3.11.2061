...
public class FmMediaController extends FrameLayout {
    ...
    public FmMediaController(Context context, AttributeSet attributeSet) {
                ...
                switch (message.what) {
                    case 0:
                        if (FmMediaController.this.mPlayer.isPlaying()) {
                            FmMediaController.this.mPauseButton.setBackgroundResource(C1704R.C1705drawable.drone_stop);
                            return;
                        } else {
                            FmMediaController.this.mPauseButton.setBackgroundResource(C1704R.C1705drawable.drone_play);
                            return;
                        }
                    case 1:
                        FmMediaController.this.hide();
        ...
        this.mSeekListener = new SeekBar.OnSeekBarChangeListener() { // from class: com.fimi.soul.media.player.widget.FmMediaController.5
            ...
            public void onStartTrackingTouch(SeekBar seekBar) {
                ...
                FmMediaController.this.show(C0494h.f704Y);
        ...
        this.mRewListener = new View.OnClickListener() { // from class: com.fimi.soul.media.player.widget.FmMediaController.6
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                FmMediaController.this.mPlayer.seekTo(FmMediaController.this.mPlayer.getCurrentPosition() + C5171e.f18819a);
                FmMediaController.this.setProgress();
                FmMediaController.this.show(3000);
            }
        };
    ...
    private void initControllerView(View view) {
        this.mPauseButton = (ImageButton) view.findViewById(C1704R.C1706id.pause);
        if (this.mPauseButton != null) {
            this.mPauseButton.requestFocus();
            this.mPauseButton.setOnClickListener(this.mPauseListener);
        }
        this.mFfwdButton = (ImageButton) view.findViewById(C1704R.C1706id.ffwd);
        ...
        this.mRewButton = (ImageButton) view.findViewById(C1704R.C1706id.rew);
        ...
        this.mNextButton = (ImageButton) view.findViewById(C1704R.C1706id.next);
        if (this.mNextButton != null && !this.mFromXml && !this.mListenersSet) {
            this.mNextButton.setVisibility(8);
        }
        this.mPrevButton = (ImageButton) view.findViewById(C1704R.C1706id.prev);
        if (this.mPrevButton != null && !this.mFromXml && !this.mListenersSet) {
            this.mPrevButton.setVisibility(8);
        }
        this.mProgress = (SeekBar) view.findViewById(C1704R.C1706id.fmmediacontroller_progress);
        ...
        this.mEndTime = (TextView) view.findViewById(C1704R.C1706id.time);
        this.mCurrentTime = (TextView) view.findViewById(C1704R.C1706id.time_current);
        this.mFormatBuilder = new StringBuilder();
        this.mFormatter = new Formatter(this.mFormatBuilder, Locale.getDefault());
        C3103au.m29232a(((Activity) this.mContext).getAssets(), this.mEndTime, this.mCurrentTime);
    ...
    private void initFloatingWindow() {
        ...
        this.mWindow.setBackgroundDrawableResource(AsyncImageView.f35337a);
    ...
    public void updatePausePlay() {
        ...
        if (this.mPlayer.isPlaying()) {
            this.mPauseButton.setBackgroundResource(C1704R.C1705drawable.drone_stop);
        } else {
            this.mPauseButton.setBackgroundResource(C1704R.C1705drawable.drone_play);
        }
    ...
    protected View makeControllerView() {
        this.mRoot = ((LayoutInflater) this.mContext.getSystemService("layout_inflater")).inflate(C1704R.layout.fm_media_controller, (ViewGroup) null);
