...
public class X11SystemConfig {
    ...
    public String getX11DeviceName() {
        return this.x11DeviceInfo != null ? this.x11DeviceInfo.getChip() : C1831e.f4964j;
    }
    ...
    public boolean isContinueCaptureMode() {
        return this.captureMode != null && this.captureMode.contains(C1831e.f4916cJ);
    }

    public boolean isPrecisePhotoMode() {
        return this.captureMode != null && this.captureMode.contains(C1831e.f4917cK);
    }
