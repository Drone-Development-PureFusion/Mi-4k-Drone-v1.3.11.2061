...
public class X11RespCmd<T> implements Serializable {
    ...
    public String toString() {
        return "X11RespCmd{rval=" + this.rval + ", msg_id=" + this.msg_id + ", type='" + this.type + C0494h.f738z + ", param=" + this.param + ", settable='" + this.settable + C0494h.f738z + ", readonly='" + this.readonly + C0494h.f738z + ", listing=" + this.listing + ", pwd='" + this.pwd + C0494h.f738z + ", notificationType=" + this.notificationType + ", duration='" + this.duration + C0494h.f738z + ", options=" + Arrays.toString(this.options) + ", permission='" + this.permission + C0494h.f738z + ", brand='" + this.brand + C0494h.f738z + ", model='" + this.model + C0494h.f738z + ", api_ver='" + this.api_ver + C0494h.f738z + ", fw_ver='" + this.fw_ver + C0494h.f738z + ", app_type='" + this.app_type + C0494h.f738z + ", logo='" + this.logo + C0494h.f738z + ", chip='" + this.chip + C0494h.f738z + ", http='" + this.http + C0494h.f738z + ", card_status='" + this.card_status + C0494h.f738z + ", cam_status='" + this.cam_status + C0494h.f738z + ", thumb_file='" + this.thumb_file + C0494h.f738z + ", size=" + this.size + ", md5sum='" + this.md5sum + C0494h.f738z + C0494h.f735w;
    }
}
