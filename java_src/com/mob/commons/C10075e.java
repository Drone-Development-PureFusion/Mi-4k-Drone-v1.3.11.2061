...
public class C10075e {

    /* renamed from: a */
    private static final String[] f31109a = {ShareSDK.SDK_TAG, "SMSSDK", "SHAREREC", "MOBAPI", "MOBLINK"};

    /* renamed from: b */
    private static final HashMap<String, MobProduct> f31110b = new HashMap<>();

    /* renamed from: a */
    public static final synchronized String m6263a(Context context, ArrayList<MobProduct> arrayList) {
        String str;
        synchronized (C10075e.class) {
            try {
            ...
            try {
                ...
                while (true) {
                    ...
                    try {
                        ...
                        if (mobProduct2 != null) {
                            f31110b.put(mobProduct2.getProductTag(), mobProduct2);
                        }
                    } catch (Throwable th2) {
                    }
                    i = i2 + 1;
                ...
                for (Map.Entry<String, MobProduct> entry : f31110b.entrySet()) {
    ...
    /* renamed from: a */
    public static final synchronized void m6262a(MobProduct mobProduct) {
        synchronized (C10075e.class) {
            if (mobProduct != null) {
                if (!f31110b.containsKey(mobProduct.getProductTag())) {
                    f31110b.put(mobProduct.getProductTag(), mobProduct);
                }
            }
        }
