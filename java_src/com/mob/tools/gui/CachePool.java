            ...
            if (k != null) {
                if (this.capacity > 0) {
                    ...
                    while (this.size >= this.capacity) {
                        node = this.tail;
                        if (node == null) {
                            MobLog.getInstance().m6188w("size != 0 but tail == null, this must meet any mistake! fix me!!", new Object[0]);
                    ...
                    if (this.size == 0) {
                        ...
                        MobLog.getInstance().m6188w("size != 0 but head == null, this must meet any mistake! fix me!!", new Object[0]);
                        this.tail = node;
                        this.size = 0;
                    }
                    this.head = node;
