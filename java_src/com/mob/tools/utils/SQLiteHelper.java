...
public class SQLiteHelper {
    ...
    public static class SingleTableDB {
        ...
        /* renamed from: db */
        private SQLiteDatabase f31140db;
        ...
        public void open() {
            if (this.f31140db == null) {
                this.f31140db = SQLiteDatabase.openOrCreateDatabase(new File(this.path), (SQLiteDatabase.CursorFactory) null);
                Cursor rawQuery = this.f31140db.rawQuery("select count(*) from sqlite_master where type ='table' and name ='" + this.name + "' ", null);
                boolean z = true;
                if (rawQuery != null) {
                ...
                this.f31140db.execSQL(sb.toString());
            }
        }
    ...
    public static int delete(SingleTableDB singleTableDB, String str, String[] strArr) {
        singleTableDB.open();
        return singleTableDB.f31140db.delete(singleTableDB.getName(), str, strArr);
    }

    public static void execSQL(SingleTableDB singleTableDB, String str) {
        singleTableDB.open();
        singleTableDB.f31140db.beginTransaction();
        try {
            singleTableDB.f31140db.execSQL(str);
            singleTableDB.f31140db.setTransactionSuccessful();
        } finally {
        }
    }
    ...
    public static int getSize(SingleTableDB singleTableDB) {
        ...
        singleTableDB.open();
        try {
            cursor = singleTableDB.f31140db.rawQuery("select count(*) from " + singleTableDB.getName(), null);
    ...
    public static long insert(SingleTableDB singleTableDB, ContentValues contentValues) {
        singleTableDB.open();
        return singleTableDB.f31140db.replace(singleTableDB.getName(), null, contentValues);
    }

    public static Cursor query(SingleTableDB singleTableDB, String[] strArr, String str, String[] strArr2, String str2) {
        singleTableDB.open();
        return singleTableDB.f31140db.query(singleTableDB.getName(), strArr, str, strArr2, null, null, str2);
    }

    public static Cursor rawQuery(SingleTableDB singleTableDB, String str, String[] strArr) {
        singleTableDB.open();
        return singleTableDB.f31140db.rawQuery(str, strArr);
    }

    public static int update(SingleTableDB singleTableDB, ContentValues contentValues, String str, String[] strArr) {
        singleTableDB.open();
        return singleTableDB.f31140db.update(singleTableDB.getName(), contentValues, str, strArr);
    }
}
