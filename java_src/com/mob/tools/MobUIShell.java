...
public class MobUIShell extends Activity {
    ...
    static {
        MobLog.getInstance().m6200d("===============================", new Object[0]);
        MobLog.getInstance().m6200d("MobTools " + "2017-02-05".replace("-0", Constants.ACCEPT_TIME_SEPARATOR_SERVER).replace(Constants.ACCEPT_TIME_SEPARATOR_SERVER, "."), new Object[0]);
        MobLog.getInstance().m6200d("===============================", new Object[0]);
    }
        ...
        try {
            ...
            if (this.executor == null) {
                ...
                if (this.executor == null) {
                    ...
                    if (this.executor == null) {
                        MobLog.getInstance().m6187w(new RuntimeException("Executor lost! launchTime = " + stringExtra + ", executorName: " + stringExtra2));
            ...
            MobLog.getInstance().m6194i("MobUIShell found executor: " + this.executor.getClass(), new Object[0]);
            this.executor.setActivity(this);
            super.onCreate(bundle);
            MobLog.getInstance().m6200d(this.executor.getClass().getSimpleName() + " onCreate", new Object[0]);
    ...
    protected void onDestroy() {
        if (this.executor != null) {
            ...
            MobLog.getInstance().m6200d(this.executor.getClass().getSimpleName() + " onDestroy", new Object[0]);
    ...
    protected void onPause() {
        if (this.executor != null) {
            MobLog.getInstance().m6200d(this.executor.getClass().getSimpleName() + " onPause", new Object[0]);
    ...
    protected void onRestart() {
        if (this.executor != null) {
            MobLog.getInstance().m6200d(this.executor.getClass().getSimpleName() + " onRestart", new Object[0]);
    ...
    protected void onResume() {
        if (this.executor != null) {
            MobLog.getInstance().m6200d(this.executor.getClass().getSimpleName() + " onResume", new Object[0]);
    ...
    protected void onStart() {
        if (this.executor != null) {
            MobLog.getInstance().m6200d(this.executor.getClass().getSimpleName() + " onStart", new Object[0]);
    ...
    protected void onStop() {
        if (this.executor != null) {
            MobLog.getInstance().m6200d(this.executor.getClass().getSimpleName() + " onStop", new Object[0]);
