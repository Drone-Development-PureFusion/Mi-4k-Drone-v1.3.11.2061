...
public class Base64 {
    ...
    public static class Encoder extends Coder {
        private static final byte[] ENCODE = {65, 66, DroneMap.f9378o, 68, 69, 70, 71, 72, 73, 74, 75, 76, 77, 78, 79, DroneMap.f9376m, 81, DroneMap.f9377n, 83, 84, C2955c.f10865f, 86, 87, 88, 89, 90, 97, 98, 99, 100, 101, 102, 103, 104, 105, 106, 107, 108, 109, 110, 111, 112, 113, 114, C2186r.f6822a, 116, 117, 118, 119, 120, 121, 122, 48, 49, 50, 51, SmileConstants.TOKEN_KEY_LONG_STRING, 53, 54, 55, 56, 57, 43, 47};
        private static final byte[] ENCODE_WEBSAFE = {65, 66, DroneMap.f9378o, 68, 69, 70, 71, 72, 73, 74, 75, 76, 77, 78, 79, DroneMap.f9376m, 81, DroneMap.f9377n, 83, 84, C2955c.f10865f, 86, 87, 88, 89, 90, 97, 98, 99, 100, 101, 102, 103, 104, 105, 106, 107, 108, 109, 110, 111, 112, 113, 114, C2186r.f6822a, 116, 117, 118, 119, 120, 121, 122, 48, 49, 50, 51, SmileConstants.TOKEN_KEY_LONG_STRING, 53, 54, 55, 56, 57, 45, 95};
    ...
    public static byte[] decode(byte[] bArr, int i, int i2, int i3) {
        ...
        if (decoder.f3055op == decoder.output.length) {
            return decoder.output;
        }
        byte[] bArr2 = new byte[decoder.f3055op];
        System.arraycopy(decoder.output, 0, bArr2, 0, decoder.f3055op);
        return bArr2;
    }
