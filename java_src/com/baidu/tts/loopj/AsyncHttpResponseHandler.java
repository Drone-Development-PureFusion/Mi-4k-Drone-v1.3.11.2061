...
public abstract class AsyncHttpResponseHandler implements ResponseHandlerInterface {
            ...
            switch (message.what) {
                case 0:
                    ...
                    if (objArr != null && objArr.length >= 3) {
                        ...
                        AsyncHttpClient.log.mo36209e(LOG_TAG, "SUCCESS_MESSAGE didn't got enough params");
                        break;
                    }
                case 1:
                    ...
                    if (objArr2 != null && objArr2.length >= 4) {
                        ...
                        AsyncHttpClient.log.mo36209e(LOG_TAG, "FAILURE_MESSAGE didn't got enough params");
                        break;
                    }
                    break;
                case 2:
                ...
                case 4:
                    ...
                    if (objArr3 != null && objArr3.length >= 2) {
                        ...
                        AsyncHttpClient.log.mo36209e(LOG_TAG, "PROGRESS_MESSAGE didn't got enough params");
                        break;
                    }
                    break;
                case 5:
                    ...
                    if (objArr4 != null && objArr4.length == 1) {
                        ...
                        AsyncHttpClient.log.mo36209e(LOG_TAG, "RETRY_MESSAGE didn't get enough params");
                        break;
                    }
                    break;
                case 6:
    ...
    public void onCancel() {
        AsyncHttpClient.log.mo36211d(LOG_TAG, "Request got cancelled");
    }
    ...
    public void onProgress(long j, long j2) {
        ...
        logInterface.mo36205v(LOG_TAG, String.format("Progress %d from %d (%2.0f%%)", objArr));
    }

    public void onRetry(int i) {
        AsyncHttpClient.log.mo36211d(LOG_TAG, String.format("Request retry no. %d", Integer.valueOf(i)));
    }
    ...
    public void onUserException(Throwable th) {
        AsyncHttpClient.log.mo36208e(LOG_TAG, "User-space exception detected!", th);
    ...
    public void setUseSynchronousMode(boolean z) {
        if (!z && this.looper == null) {
            z = true;
            AsyncHttpClient.log.mo36203w(LOG_TAG, "Current thread has not called Looper.prepare(). Forcing synchronous mode.");
        }
