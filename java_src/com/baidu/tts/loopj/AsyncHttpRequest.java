...
public class AsyncHttpRequest implements Runnable {
    ...
    public AsyncHttpRequest(AbstractHttpClient abstractHttpClient, HttpContext httpContext, HttpUriRequest httpUriRequest, ResponseHandlerInterface responseHandlerInterface) {
        ...
        this.context = (HttpContext) Utils.notNull(httpContext, C0494h.f709ac);
                ...
                try {
                    try {
                        ...
                        try {
                            ...
                            AsyncHttpClient.log.mo36208e("AsyncHttpRequest", "Unhandled exception origin cause", e3);
    ...
    public void run() {
        ...
        try {
            ...
            if (!isCancelled()) {
                ...
                AsyncHttpClient.log.mo36208e("AsyncHttpRequest", "makeRequestWithRetries returned error", e);
            }
        }
        if (isCancelled()) {
            return;
