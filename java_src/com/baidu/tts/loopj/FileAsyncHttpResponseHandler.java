...
public abstract class FileAsyncHttpResponseHandler extends AsyncHttpResponseHandler {
    ...
    public FileAsyncHttpResponseHandler(File file, boolean z, boolean z2) {
        ...
        if (file.isDirectory() && !file.mkdirs()) {
            AsyncHttpClient.log.mo36211d(LOG_TAG, "Cannot create directories for requested Directory location, might not be a problem");
        }
        this.file = file;
        this.append = z;
    ...
    protected File getTemporaryFile(Context context) {
        ...
        try {
            ...
            AsyncHttpClient.log.mo36208e(LOG_TAG, "Cannot create temporary file", e);
            return null;
        }
    }
