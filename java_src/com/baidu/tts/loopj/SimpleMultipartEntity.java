...
public class SimpleMultipartEntity implements HttpEntity {
    ...
    public class FilePart {
        ...
        private byte[] createHeader(String str, String str2, String str3) {
            ...
            try {
                ...
                AsyncHttpClient.log.mo36208e(SimpleMultipartEntity.LOG_TAG, "createHeader ByteArrayOutputStream exception", e);
            }
    ...
    public void addPart(String str, String str2, String str3) {
        try {
            ...
            AsyncHttpClient.log.mo36208e(LOG_TAG, "addPart ByteArrayOutputStream exception", e);
        }
    }
