        ...
        Runnable runnable = new Runnable() { // from class: com.baidu.tts.loopj.BaseJsonHttpResponseHandler.2
            ...
            public void run() {
                try {
                    ...
                    AsyncHttpClient.log.mo36210d(BaseJsonHttpResponseHandler.LOG_TAG, "parseResponse thrown an problem", th2);
        ...
        Runnable runnable = new Runnable() { // from class: com.baidu.tts.loopj.BaseJsonHttpResponseHandler.1
            ...
            public void run() {
                try {
                    ...
                    AsyncHttpClient.log.mo36210d(BaseJsonHttpResponseHandler.LOG_TAG, "parseResponse thrown an problem", th);
