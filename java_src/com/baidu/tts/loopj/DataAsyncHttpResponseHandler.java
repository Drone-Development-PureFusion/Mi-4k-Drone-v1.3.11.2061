...
public abstract class DataAsyncHttpResponseHandler extends AsyncHttpResponseHandler {
        ...
        switch (message.what) {
            case 7:
                ...
                if (objArr == null || objArr.length < 1) {
                    AsyncHttpClient.log.mo36209e(LOG_TAG, "PROGRESS_DATA_MESSAGE didn't got enough params");
                    return;
                }
                try {
                    ...
                    AsyncHttpClient.log.mo36208e(LOG_TAG, "custom onProgressData contains an error", th);
                    return;
                }
            default:
                return;
    ...
    public void onProgressData(byte[] bArr) {
        AsyncHttpClient.log.mo36211d(LOG_TAG, "onProgressData(byte[]) was not overriden, but callback was received");
    }
