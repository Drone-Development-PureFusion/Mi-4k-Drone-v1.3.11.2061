...
public class C10268f extends SQLiteOpenHelper {

    /* renamed from: a */
    protected static final String f31935a = C10257f.f31917d + ".ReportDatabaseHelper";

    /* renamed from: b */
    protected static final String[] f31936b = {"key"};

    /* renamed from: c */
    protected static C10268f f31937c;

    public C10268f(Context context) {
        super(context, "sdk_report.db", (SQLiteDatabase.CursorFactory) null, 2);
    }

    /* renamed from: a */
    public static synchronized C10268f m5634a() {
        C10268f c10268f;
        synchronized (C10268f.class) {
            if (f31937c == null) {
                f31937c = new C10268f(Global.getContext());
            }
            c10268f = f31937c;
        }
        return c10268f;
    ...
    */
    public synchronized List<Serializable> m5633a(String str) {
        Cursor cursor;
        Cursor cursor2;
                ...
                try {
                    ...
                    if (cursor != null) {
                        try {
                            ...
                            cursor2 = cursor;
                            try {
                                C10257f.m5667e(f31935a, "getReportItemFromDB has exception.");
                                if (cursor2 != null) {
                                    cursor2.close();
                                }
                                if (0 != 0) {
    ...
    /* renamed from: a */
    public synchronized void m5632a(String str, List<Serializable> list) {
                ...
                if (!TextUtils.isEmpty(str)) {
                    ...
                    if (writableDatabase != null) {
                        ...
                        try {
                            ...
                            C10257f.m5667e(f31935a, "saveReportItemToDB has exception.");
                            writableDatabase.endTransaction();
                            if (writableDatabase != null) {
                                writableDatabase.close();
                            }
    ...
    /* renamed from: b */
    public synchronized void m5631b(String str) {
        ...
        if (!TextUtils.isEmpty(str) && (writableDatabase = getWritableDatabase()) != null) {
            try {
                ...
                C10257f.m5667e(f31935a, "clearReportItem has exception.");
                if (writableDatabase != null) {
                    writableDatabase.close();
                }
            }
