...
public final class ApkExternalInfoTool {
    ...
    /* renamed from: a */
    private static final ZipLong f31977a = new ZipLong(101010256);

    /* renamed from: b */
    private static final ZipShort f31978b = new ZipShort(38651);
    ...
    public static class ApkExternalInfo {
        ...
        private ApkExternalInfo() {
            this.f31979a = new Properties();
        }

        /* renamed from: a */
        void m5598a(byte[] bArr) {
            if (bArr == null) {
                return;
            }
            ByteBuffer wrap = ByteBuffer.wrap(bArr);
            int length = ApkExternalInfoTool.f31978b.getBytes().length;
            byte[] bArr2 = new byte[length];
            wrap.get(bArr2);
            if (!ApkExternalInfoTool.f31978b.equals(new ZipShort(bArr2))) {
            ...
            wrap.get(bArr4);
            this.f31979a.load(new ByteArrayInputStream(bArr4));
            int length2 = ((bArr.length - length) - value) - 2;
            if (length2 <= 0) {
                return;
            }
            this.f31980b = new byte[length2];
            wrap.get(this.f31980b);
        }

        public String toString() {
            return "ApkExternalInfo [p=" + this.f31979a + ", otherData=" + Arrays.toString(this.f31980b) + "]";
        }
    }

    /* renamed from: a */
    private static byte[] m5599a(RandomAccessFile randomAccessFile) {
        boolean z = true;
        long length = randomAccessFile.length() - 22;
        randomAccessFile.seek(length);
        byte[] bytes = f31977a.getBytes();
    ...
    public static String read(File file, String str) {
        ...
        try {
            ...
            try {
                byte[] m5599a = m5599a(randomAccessFile);
                if (m5599a != null) {
                    ApkExternalInfo apkExternalInfo = new ApkExternalInfo();
                    apkExternalInfo.m5598a(m5599a);
                    str2 = apkExternalInfo.f31979a.getProperty(str);
