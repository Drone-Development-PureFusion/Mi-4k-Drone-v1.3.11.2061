...
public class SystemUtils {
    ...
    /* renamed from: a */
    private static final String f32012a = C10257f.f31917d + ".SysUtils";

    /* renamed from: a */
    private static long m5578a(InputStream inputStream, OutputStream outputStream) {
        long j = 0;
        byte[] bArr = new byte[8192];
        while (true) {
            int read = inputStream.read(bArr, 0, bArr.length);
            if (read == -1) {
                C10257f.m5670c(f32012a, "-->copy, copyed size is: " + j);
                return j;
            }
    ...
    public static boolean checkMobileQQ(Context context) {
        ...
        if (packageInfo != null) {
            ...
            try {
                C10257f.m5673b("MobileQQ verson", str);
    ...
    */
    public static boolean extractSecureLib(String str, String str2, int i) {
        ...
        boolean z = false;
        C10257f.m5670c(f32012a, "-->extractSecureLib, libName: " + str);
        Context context = Global.getContext();
        if (context == null) {
            C10257f.m5670c(f32012a, "-->extractSecureLib, global context is null. ");
            return false;
        }
        ...
        if (!file.exists()) {
            ...
            C10257f.m5670c(f32012a, "-->extractSecureLib, libVersion: " + i + " | oldVersion: " + i2);
            iOException = i2;
            if (i == i2) {
                return true;
            }
        ...
        try {
            try {
                ...
                try {
                    ...
                    m5578a(iOException, fileOutputStream);
                    ...
                    e = e4;
                    C10257f.m5672b(f32012a, "-->extractSecureLib, when copy lib execption.", e);
                    if (iOException != null) {
                        try {
                            iOException.close();
    ...
    public static String getAppSignatureMD5(Context context, String str) {
        ...
        C10257f.m5676a(C10257f.f31917d, "OpenUi, getSignValidString");
        try {
            ...
            messageDigest.reset();
            C10257f.m5673b("SystemUtils", "-->sign: " + hexString);
        ...
        try {
            messageDigest.reset();
            C10257f.m5673b("SystemUtils", "-->signEncryped: " + str2);
        } catch (Exception e3) {
            e = e3;
            e.printStackTrace();
            C10257f.m5672b(C10257f.f31917d, "OpenUi, getSignValidString error", e);
            return str2;
        }
        return str2;
    }
    ...
    public static boolean isAppSignatureValid(Context context, String str, String str2) {
        C10257f.m5676a(C10257f.f31917d, "OpenUi, validateAppSignatureForPackage");
        try {
    ...
    public static boolean isLibExtracted(String str, int i) {
        Context context = Global.getContext();
        if (context == null) {
            C10257f.m5670c(f32012a, "-->isSecureLibExtracted, global context is null. ");
            return false;
        }
