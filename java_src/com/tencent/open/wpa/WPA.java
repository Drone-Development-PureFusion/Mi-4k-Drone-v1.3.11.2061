...
public class WPA extends BaseApi {
    ...
    public void getWPAUserOnlineState(String str, IUiListener iUiListener) {
        try {
            if (str == null) {
                C10266d.m5641a().m5639a(this.mToken.getOpenId(), this.mToken.getAppId(), Constants.VIA_WAP_STATE, Constants.VIA_REPORT_TYPE_WPA_STATE, "18", "1");
                ...
                C10266d.m5641a().m5639a(this.mToken.getOpenId(), this.mToken.getAppId(), Constants.VIA_WAP_STATE, Constants.VIA_REPORT_TYPE_WPA_STATE, "18", "0");
            }
        } catch (Exception e) {
            if (iUiListener != null) {
    ...
    public int startWPAConversation(Activity activity, String str, String str2) {
        ...
        if (TextUtils.isEmpty(str)) {
            C10266d.m5641a().m5639a(this.mToken.getOpenId(), this.mToken.getAppId(), Constants.VIA_START_WAP, Constants.VIA_REPORT_TYPE_START_WAP, "18", "1");
            return -1;
        } else if (str.length() < 5) {
            C10266d.m5641a().m5639a(this.mToken.getOpenId(), this.mToken.getAppId(), Constants.VIA_START_WAP, Constants.VIA_REPORT_TYPE_START_WAP, "18", "1");
            return -3;
            ...
            C10266d.m5641a().m5639a(this.mToken.getOpenId(), this.mToken.getAppId(), Constants.VIA_START_WAP, Constants.VIA_REPORT_TYPE_START_WAP, "18", "0");
            return i;
        }
    }
}
