...
public class MoreFloatingDialog extends Dialog {
    ...
    public MoreFloatingDialog(Context context) {
        ...
        C10257f.m5673b(C10257f.f31917d, "-->(MoreFloatingDialog) : density = " + this.density);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(-2, -2);
        this.mContentView = new RelativeLayout(context);
        this.mContentView.setLayoutParams(layoutParams);
        this.mContentView.setBackgroundDrawable(C10316a.m5544a(SOURCE_FLOATING_BG, context, this.ninePatchRect));
        this.mRootView = new LinearLayout(context);
        LinearLayout.LayoutParams layoutParams2 = new LinearLayout.LayoutParams(-1, -2);
        this.mRootView.setLayoutParams(layoutParams2);
        this.mShareItems.put(SOURCE_QQ_BG, addShareItemText(C10316a.m5544a(SOURCE_QQ_BG, getContext(), this.ninePatchRect), "QQ分享"));
        this.mShareItems.put(SOURCE_QZONE_BG, addShareItemText(C10316a.m5544a(SOURCE_QZONE_BG, getContext(), this.ninePatchRect), "空间分享"));
