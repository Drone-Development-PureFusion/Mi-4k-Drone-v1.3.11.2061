...
public class TitleBar extends RelativeLayout {
    ...
    public TitleBar(Context context) {
        ...
        setBackgroundDrawable(C10316a.m5545a(SOURCE_TITLEBAR, context));
        initBackLayout();
        initShareBtn();
    }
    ...
    private void initBackBtn() {
        ...
        this.backBtn.setBackgroundDrawable(C10316a.m5545a(SOURCE_BACK_BTN, getContext()));
    ...
    private void initShareBtn() {
        ...
        this.shareBtn.setBackgroundDrawable(C10316a.m5545a(SOURCE_MORE_BTN, getContext()));
