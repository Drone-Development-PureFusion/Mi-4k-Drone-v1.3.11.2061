...
public class Tencent {
    ...
    private static boolean checkManifestConfig(Context context, String str) {
        try {
            ...
            try {
                ...
                C10257f.m5667e("AndroidManifest.xml 没有检测到com.tencent.connect.common.AssistActivity", "没有在AndroidManifest.xml中检测到com.tencent.connect.common.AssistActivity,请加上com.tencent.connect.common.AssistActivity,详细信息请查看官网文档.\n配置示例如下: \n<activity\n     android:name=\"com.tencent.connect.common.AssistActivity\"\n     android:screenOrientation=\"portrait\"\n     android:theme=\"@android:style/Theme.Translucent.NoTitleBar\"\n     android:configChanges=\"orientation|keyboardHidden\">\n</activity>");
                return false;
            }
        } catch (PackageManager.NameNotFoundException e2) {
            C10257f.m5667e("AndroidManifest.xml 没有检测到com.tencent.tauth.AuthActivity", ("没有在AndroidManifest.xml中检测到com.tencent.tauth.AuthActivity,请加上com.tencent.open.AuthActivity,并配置<data android:scheme=\"tencent" + str + "\" />,详细信息请查看官网文档.") + "\n配置示例如下: \n<activity\n     android:name=\"com.tencent.connect.util.AuthActivity\"\n     android:noHistory=\"true\"\n     android:launchMode=\"singleTask\">\n<intent-filter>\n    <action android:name=\"android.intent.action.VIEW\" />\n     <category android:name=\"android.intent.category.DEFAULT\" />\n    <category android:name=\"android.intent.category.BROWSABLE\" />\n    <data android:scheme=\"tencent" + str + "\" />\n</intent-filter>\n</activity>");
            return false;
        }
    }
    ...
    public static synchronized Tencent createInstance(String str, Context context) {
        ...
        synchronized (Tencent.class) {
            C10257f.m5676a(C10257f.f31917d, "createInstance()  -- start");
            if (sInstance == null) {
            ...
            if (!checkManifestConfig(context, str)) {
                ...
                C10257f.m5676a(C10257f.f31917d, "createInstance()  -- end");
                tencent = sInstance;
            }
        }
        return tencent;
    ...
    public boolean joinQQGroup(Activity activity, String str) {
        ...
        try {
            ...
            C10266d.m5641a().m5639a(this.mQQAuth.getQQToken().getOpenId(), this.mQQAuth.getQQToken().getAppId(), Constants.VIA_JOIN_GROUP, "13", "18", "0");
            return true;
        } catch (Exception e) {
            C10266d.m5641a().m5639a(this.mQQAuth.getQQToken().getOpenId(), this.mQQAuth.getQQToken().getAppId(), Constants.VIA_JOIN_GROUP, "13", "18", "1");
            return false;
        }
    }
    ...
    public void setAccessToken(String str, String str2) {
        C10257f.m5676a(C10257f.f31917d, "setAccessToken(), expiresIn = " + str2 + "");
