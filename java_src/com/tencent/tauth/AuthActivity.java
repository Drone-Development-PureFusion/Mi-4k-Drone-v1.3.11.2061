...
public class AuthActivity extends Activity {
    ...
    private static final String TAG = C10257f.f31917d + ".AuthActivity";
    ...
    private void handleActionUri(Uri uri) {
        ...
        C10257f.m5673b(TAG, "-->handleActionUri, action: " + string);
        if (string == null) {
            ...
            try {
                ...
                C10257f.m5667e(TAG, "sharePrize parseJson has exception.");
            }
    ...
    protected void onCreate(Bundle bundle) {
        ...
        C10257f.m5673b(TAG, "-->onCreate, uri: " + data);
