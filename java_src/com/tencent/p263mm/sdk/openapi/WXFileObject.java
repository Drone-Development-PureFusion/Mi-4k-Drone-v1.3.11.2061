...
public class WXFileObject implements WXMediaMessage.IMediaObject {
    ...
    public boolean checkArgs() {
        ...
        if ((this.fileData == null || this.fileData.length == 0) && (this.filePath == null || this.filePath.length() == 0)) {
            Log.m5875e("MicroMsg.SDK.WXFileObject", "checkArgs fail, both arguments is null");
            return false;
        } else if (this.fileData != null && this.fileData.length > 10485760) {
            Log.m5875e("MicroMsg.SDK.WXFileObject", "checkArgs fail, fileData is too large");
            return false;
        } else {
            if (this.filePath != null) {
                ...
                if (i > 10485760) {
                    Log.m5875e("MicroMsg.SDK.WXFileObject", "checkArgs fail, fileSize is too large");
                    return false;
                }
            }
            return true;
