...
public final class WXMediaMessage {
    ...
    public static class Builder {
        ...
        public static WXMediaMessage fromBundle(Bundle bundle) {
            ...
            try {
                ...
                e.printStackTrace();
                Log.m5875e("MicroMsg.SDK.WXMediaMessage", "get media object from bundle failed: unknown ident " + string);
                return wXMediaMessage;
            }
        }
    ...
    public final boolean checkArgs() {
        if (getType() == 8 && (this.thumbData == null || this.thumbData.length == 0)) {
            Log.m5875e("MicroMsg.SDK.WXMediaMessage", "checkArgs fail, thumbData should not be null when send emoji");
            return false;
        } else if (this.thumbData != null && this.thumbData.length > 32768) {
            Log.m5875e("MicroMsg.SDK.WXMediaMessage", "checkArgs fail, thumbData is invalid");
            return false;
        } else if (this.title != null && this.title.length() > 512) {
            Log.m5875e("MicroMsg.SDK.WXMediaMessage", "checkArgs fail, title is invalid");
            return false;
        } else if (this.description != null && this.description.length() > 1024) {
            Log.m5875e("MicroMsg.SDK.WXMediaMessage", "checkArgs fail, description is invalid");
            return false;
        } else if (this.mediaObject != null) {
            return this.mediaObject.checkArgs();
        } else {
            Log.m5875e("MicroMsg.SDK.WXMediaMessage", "checkArgs fail, mediaObject is null");
            return false;
        }
    }
    ...
    public final void setThumbImage(Bitmap bitmap) {
        try {
            ...
            e.printStackTrace();
            Log.m5875e("MicroMsg.SDK.WXMediaMessage", "put thumb failed");
        }
    }
}
