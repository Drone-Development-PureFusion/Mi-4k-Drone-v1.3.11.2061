...
public class WXImageObject implements WXMediaMessage.IMediaObject {
    ...
    public boolean checkArgs() {
        ...
        if ((this.imageData == null || this.imageData.length == 0) && ((this.imagePath == null || this.imagePath.length() == 0) && (this.imageUrl == null || this.imageUrl.length() == 0))) {
            Log.m5875e("MicroMsg.SDK.WXImageObject", "checkArgs fail, all arguments are null");
            return false;
        } else if (this.imageData != null && this.imageData.length > 10485760) {
            Log.m5875e("MicroMsg.SDK.WXImageObject", "checkArgs fail, content is too large");
            return false;
        } else if (this.imagePath != null && this.imagePath.length() > 10240) {
            Log.m5875e("MicroMsg.SDK.WXImageObject", "checkArgs fail, path is invalid");
            return false;
        } else {
            if (this.imagePath != null) {
                ...
                if (i > 10485760) {
                    Log.m5875e("MicroMsg.SDK.WXImageObject", "checkArgs fail, image content is too large");
                    return false;
                }
            }
            ...
            Log.m5875e("MicroMsg.SDK.WXImageObject", "checkArgs fail, url is invalid");
            return false;
        }
    }
