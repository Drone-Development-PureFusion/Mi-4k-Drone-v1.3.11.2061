...
public final class SendAuth {
    ...
    public static class Req extends BaseReq {
        ...
        @Override // com.tencent.p263mm.sdk.openapi.BaseReq
        public final boolean checkArgs() {
            if (this.scope == null || this.scope.length() == 0 || this.scope.length() > 1024) {
                Log.m5875e("MicroMsg.SDK.SendAuth.Req", "checkArgs fail, scope is invalid");
                return false;
            } else if (this.state == null || this.state.length() <= 1024) {
                return true;
            } else {
                Log.m5875e("MicroMsg.SDK.SendAuth.Req", "checkArgs fail, state is invalid");
                return false;
            }
        }
    ...
    public static class Resp extends BaseResp {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        @Override // com.tencent.p263mm.sdk.openapi.BaseResp
        public final boolean checkArgs() {
            if (this.state == null || this.state.length() <= 1024) {
                return true;
            }
            Log.m5875e("MicroMsg.SDK.SendAuth.Resp", "checkArgs fail, state is invalid");
            return false;
        }
