...
public class WXAppExtendObject implements WXMediaMessage.IMediaObject {
    ...
    public boolean checkArgs() {
        ...
        if ((this.extInfo == null || this.extInfo.length() == 0) && ((this.filePath == null || this.filePath.length() == 0) && (this.fileData == null || this.fileData.length == 0))) {
            Log.m5875e("MicroMsg.SDK.WXAppExtendObject", "checkArgs fail, all arguments is null");
            return false;
        } else if (this.extInfo != null && this.extInfo.length() > 2048) {
            Log.m5875e("MicroMsg.SDK.WXAppExtendObject", "checkArgs fail, extInfo is invalid");
            return false;
        } else if (this.filePath != null && this.filePath.length() > 10240) {
            Log.m5875e("MicroMsg.SDK.WXAppExtendObject", "checkArgs fail, filePath is invalid");
            return false;
        } else {
            if (this.filePath != null) {
                ...
                if (i > 10485760) {
                    Log.m5875e("MicroMsg.SDK.WXAppExtendObject", "checkArgs fail, fileSize is too large");
                    return false;
                }
            }
            ...
            Log.m5875e("MicroMsg.SDK.WXAppExtendObject", "checkArgs fail, fileData is too large");
            return false;
        }
    }
