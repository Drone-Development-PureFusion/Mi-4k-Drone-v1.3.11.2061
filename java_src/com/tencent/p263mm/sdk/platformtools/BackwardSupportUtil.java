...
public class BackwardSupportUtil {
    ...
    public static class BitmapFactory {
        ...
        public static Bitmap getBitmapFromURL(String str) {
            try {
                Log.m5877d("MicroMsg.SDK.BackwardSupportUtil", "get bitmap from url:" + str);
                ...
                Log.m5875e("MicroMsg.SDK.BackwardSupportUtil", "get bitmap from url failed");
                e.printStackTrace();
                return null;
            }
        }
    ...
    public static class ExifHelper {
        public static int getExifOrientation(String str) {
            ...
            try {
                ...
                Log.m5875e("MicroMsg.SDK.BackwardSupportUtil", "cannot read exif" + e);
                exifInterface = null;
            }
