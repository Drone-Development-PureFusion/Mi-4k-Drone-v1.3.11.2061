...
public class NetStatusUtil {
    ...
    /* renamed from: a */
    private static Intent m5864a(Context context, String str) {
        try {
            PackageManager packageManager = context.getPackageManager();
            List<PackageInfo> installedPackages = packageManager.getInstalledPackages(0);
            if (installedPackages != null && installedPackages.size() > 0) {
                Log.m5875e("MicroMsg.NetStatusUtil", "package  size" + installedPackages.size());
                for (int i = 0; i < installedPackages.size(); i++) {
                    try {
                        Log.m5875e("MicroMsg.NetStatusUtil", "package " + installedPackages.get(i).packageName);
                        ...
                        if (size > 0) {
                            try {
                                Log.m5875e("MicroMsg.NetStatusUtil", "activityName count " + size);
    ...
    public static boolean checkFromXml(int i) {
        try {
            ...
            for (int i2 = 0; i2 < elementsByTagName.getLength(); i2++) {
                ...
                Log.m5875e("MicroMsg.NetStatusUtil", "uid is " + attribute + "  policy is " + attribute2);
    ...
    public static void dumpNetStatus(Context context) {
        try {
            ...
            Log.m5875e("MicroMsg.NetStatusUtil", "isAvailable " + activeNetworkInfo.isAvailable());
            Log.m5875e("MicroMsg.NetStatusUtil", "isConnected " + activeNetworkInfo.isConnected());
            Log.m5875e("MicroMsg.NetStatusUtil", "isRoaming " + activeNetworkInfo.isRoaming());
            Log.m5875e("MicroMsg.NetStatusUtil", "isFailover " + activeNetworkInfo.isFailover());
            Log.m5875e("MicroMsg.NetStatusUtil", "getSubtypeName " + activeNetworkInfo.getSubtypeName());
            Log.m5875e("MicroMsg.NetStatusUtil", "getExtraInfo " + activeNetworkInfo.getExtraInfo());
            Log.m5875e("MicroMsg.NetStatusUtil", "activeNetInfo " + activeNetworkInfo.toString());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static int getNetType(Context context) {
        ...
        if (connectivityManager != null && (activeNetworkInfo = connectivityManager.getActiveNetworkInfo()) != null) {
            ...
            Log.m5877d("MicroMsg.NetStatusUtil", "activeNetInfo.getExtraInfo()  " + activeNetworkInfo.getExtraInfo());
            Log.m5877d("MicroMsg.NetStatusUtil", "activeNetInfo.getType()  " + activeNetworkInfo.getType());
    ...
    */
    ...
    public static boolean isRestrictBacground(Context context) {
        ...
        try {
            ...
            Log.m5875e("MicroMsg.NetStatusUtil", "policy is " + intValue);
        } catch (Exception e) {
            e.printStackTrace();
        }
        if (intValue == 1) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    process = exec;
                    try {
                        Log.m5877d("MicroMsg.NetStatusUtil", "the device is not rooted， error message： " + e.getMessage());
        ...
        switch (i) {
            ...
            case 1:
                try {
                    ...
                    m5864a(context, "DevelopmentSettings");
                    return;
                }
            case 2:
                try {
                    ...
                    try {
                        ...
                        m5864a(context, "ManageAccountsSettings");
                        return;
                    }
                }
            case 3:
                try {
                    ...
                    m5864a(context, "AdvancedSettings");
                    return;
                }
        }
    }
