...
public class MMessageAct {
    ...
    public static boolean send(Context context, String str, String str2, String str3, Bundle bundle) {
        if (context == null || str == null || str.length() == 0 || str2 == null || str2.length() == 0) {
            Log.m5875e("MicroMsg.SDK.MMessageAct", "send fail, invalid arguments");
            return false;
        }
        ...
        intent.addFlags(AbstractC4808e.f17570a_).addFlags(134217728);
        try {
            context.startActivity(intent);
            Log.m5877d("MicroMsg.SDK.MMessageAct", "send mm message, intent=" + intent);
            return true;
        } catch (ActivityNotFoundException e) {
            Log.m5875e("MicroMsg.SDK.MMessageAct", "send fail, target ActivityNotFound");
            return false;
        }
    }
