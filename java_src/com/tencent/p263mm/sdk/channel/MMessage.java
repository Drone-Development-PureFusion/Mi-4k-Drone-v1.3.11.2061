package com.tencent.p263mm.sdk.channel;
...
public class MMessage {
    ...
    public static final class Receiver extends BroadcastReceiver {
        ...
        /* renamed from: o */
        private final CallBack f31555o;
        ...
        public final void onReceive(Context context, Intent intent) {
            Log.m5877d("MicroMsg.SDK.MMessage", "receive intent=" + intent);
            if (this.f31555o != null) {
                this.f31555o.handleMessage(intent);
                Log.m5877d("MicroMsg.SDK.MMessage", "mm message self-handled");
                return;
            }
            ...
            Log.m5877d("MicroMsg.SDK.MMessage", "mm message handled");
        }
    }
    ...
    public static boolean send(Context context, String str, String str2, String str3, Bundle bundle) {
        ...
        intent.putExtra(ConstantsMMessage.CHECK_SUM, MMessageUtil.m5890a(str3, packageName));
        context.sendBroadcast(intent, str4);
        Log.m5877d("MicroMsg.SDK.MMessage", "send mm message, intent=" + intent + ", perm=" + str4);
        return true;
    }
}
