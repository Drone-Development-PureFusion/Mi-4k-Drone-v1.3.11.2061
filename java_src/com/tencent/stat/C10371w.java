...
public class C10371w extends SQLiteOpenHelper {
    public C10371w(Context context) {
        super(context, C10346k.m5393v(context), (SQLiteDatabase.CursorFactory) null, 3);
    }

    /* renamed from: a */
    private void m5336a(SQLiteDatabase sQLiteDatabase) {
        Cursor cursor;
        ...
        try {
            ...
            try {
                ...
                if (cursor.moveToNext()) {
                    ...
                    cursor.getString(2);
                    cursor.getLong(3);
                    contentValues.put("uid", C10346k.m5419c(str));
                }
                if (str != null) {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: BlockProcessor
        ...
        */
    /* renamed from: b */
    private void m5335b(android.database.sqlite.SQLiteDatabase r11) {
        /*
            r10 = this;
            r8 = 0
        ...
        L36:
            ...
            r1 = r7
        L38:
            com.tencent.stat.common.StatLogger r2 = com.tencent.stat.C10362n.m5341d()     // Catch: java.lang.Throwable -> L89
            r2.m5464e(r0)     // Catch: java.lang.Throwable -> L89
            if (r1 == 0) goto L44
            r1.close()
        L44:
            return
        ...
        L4e:
            ...
            com.tencent.stat.x r0 = (com.tencent.stat.C10372x) r0     // Catch: java.lang.Throwable -> L36
            java.lang.String r3 = "content"
            java.lang.String r4 = r0.f32312b     // Catch: java.lang.Throwable -> L36
            java.lang.String r4 = com.tencent.stat.common.C10346k.m5419c(r4)     // Catch: java.lang.Throwable -> L36
            ...
            r6 = 0
            long r8 = r0.f32311a     // Catch: java.lang.Throwable -> L36
        ...
        L8c:
            ...
            goto L38
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.stat.C10371w.m5335b(android.database.sqlite.SQLiteDatabase):void");
    }
    ...
    public void onUpgrade(SQLiteDatabase sQLiteDatabase, int i, int i2) {
        ...
        if (i == 1) {
            sQLiteDatabase.execSQL("create table if not exists keyvalues(key TEXT PRIMARY KEY NOT NULL, value TEXT)");
            m5336a(sQLiteDatabase);
            m5335b(sQLiteDatabase);
        }
        if (i == 2) {
            m5336a(sQLiteDatabase);
            m5335b(sQLiteDatabase);
