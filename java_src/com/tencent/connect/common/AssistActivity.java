...
public class AssistActivity extends Activity {
    ...
    private void openBrowser(Bundle bundle) {
        ...
        if (!Util.openBrowser(this, string3)) {
            ...
            C10266d.m5641a().m5637a(string4, string5, str, str2, "3", "1", string, "0", "2", "0");
            finish();
        } else {
            C10266d.m5641a().m5637a(string4, string5, str, str2, "3", "0", string, "0", "2", "0");
        }
    ...
    public static void setResultDataForLogin(Activity activity, Intent intent) {
        ...
        try {
            ...
            C10257f.m5673b(TAG, "AssistActivity--setResultDataForLogin-- " + stringExtra);
    ...
    protected void onActivityResult(int i, int i2, Intent intent) {
        C10257f.m5673b(TAG, "AssistActivity--onActivityResult--" + i2 + " data=" + intent);
        C10257f.m5673b(TAG, "--requestCode: " + i + " | resultCode: " + i2 + " | data: " + intent);
        ...
        if (this.mAPiObject != null) {
            C10257f.m5673b(TAG, "AssistActivity--onActivityResult-- mAPiObject != null");
    ...
    protected void onCreate(Bundle bundle) {
        ...
        C10257f.m5673b(TAG, "AssistActivity--onCreate--");
        if (sApiObject == null) {
            return;
        }
    ...
    protected void onNewIntent(Intent intent) {
        ...
        C10257f.m5673b(TAG, "AssistActivity--onNewIntent--" + (obj == null ? "mAPiObject = null" : "mAPiObject != null"));
    ...
    protected void onPause() {
        C10257f.m5673b(TAG, "-->onPause");
        super.onPause();
    }

    @Override // android.app.Activity
    protected void onResume() {
        C10257f.m5673b(TAG, "-->onResume");
        super.onResume();
    ...
    protected void onSaveInstanceState(Bundle bundle) {
        C10257f.m5673b(TAG, "AssistActivity--onSaveInstanceState--");
    ...
    protected void onStart() {
        C10257f.m5673b(TAG, "-->onStart");
        super.onStart();
    }

    @Override // android.app.Activity
    protected void onStop() {
        C10257f.m5673b(TAG, "-->onStop");
        super.onStop();
    }
}
