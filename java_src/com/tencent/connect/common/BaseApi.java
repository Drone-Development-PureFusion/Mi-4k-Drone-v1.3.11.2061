...
public abstract class BaseApi {
    ...
    public static void handleDataToListener(Intent intent, IUiListener iUiListener) {
        ...
        if (SystemUtils.ACTION_LOGIN.equals(stringExtra)) {
            ...
            if (intExtra != 0) {
                C10257f.m5667e(C10257f.f31917d, "OpenUi, onActivityResult, onError = " + intExtra + "");
            ...
            if (stringExtra2 == null) {
                C10257f.m5673b(C10257f.f31917d, "OpenUi, onActivityResult, onComplete");
            ...
            try {
                ...
                C10257f.m5672b(C10257f.f31917d, "OpenUi, onActivityResult, json error", e);
            }
    ...
    public void onActivityResult(Activity activity, int i, int i2, Intent intent) {
        ...
        if (iUiListener == null) {
            C10257f.m5673b(TAG, "BaseApi--onActivityResult-- listener == null");
