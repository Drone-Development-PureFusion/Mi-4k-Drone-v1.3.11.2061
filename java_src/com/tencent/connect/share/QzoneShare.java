    ...
    public void shareToQzone(final Activity activity, final Bundle bundle, final IUiListener iUiListener) {
        ...
        switch (i) {
            ...
            case 5:
                ...
                C10257f.m5667e(C10257f.f31917d, "shareToQzone() error--end暂不支持纯图片分享到空间，建议使用图文分享");
                C10266d.m5641a().m5640a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.mToken.getAppId(), String.valueOf(4), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "shareToQzone() 暂不支持纯图片分享到空间，建议使用图文分享");
                return;
            case 6:
        ...
        if (stringArrayList != null && (stringArrayList == null || stringArrayList.size() != 0)) {
            ...
            while (true) {
                ...
                if (i3 < stringArrayList.size()) {
                    ...
                    C10266d.m5641a().m5640a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.mToken.getAppId(), String.valueOf(4), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "shareToQzone() 非法的图片地址!");
                    return;
                } else {
        ...
        if (SystemUtils.compareQQVersion(activity, SystemUtils.QQ_VERSION_NAME_4_6_0) >= 0) {
            ...
            if (stringArrayList != null && stringArrayList.size() > 0) {
                ...
                if (i == 5 && !Util.fileExists(str4)) {
                    ...
                    C10257f.m5667e(C10257f.f31917d, "shareToQzone()手Q版本过低，纯图分享不支持网路图片");
                    C10266d.m5641a().m5640a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.mToken.getAppId(), String.valueOf(4), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "shareToQzone()手Q版本过低，纯图分享不支持网路图片");
                    return;
                }
