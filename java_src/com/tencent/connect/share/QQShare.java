...
public class QQShare extends BaseApi {
    ...
    /* renamed from: a */
    private static final String f31289a = C10257f.f31917d + ".QQShare";
    ...
    /* renamed from: a */
    private StringBuffer m6069a(StringBuffer stringBuffer, Bundle bundle) {
    ...
    /* renamed from: a */
    private void m6072a(final Activity activity, final Bundle bundle, final IUiListener iUiListener) {
        C10257f.m5670c(C10257f.f31917d, "shareToMobileQQ() -- start.");
        String string = bundle.getString("imageUrl");
        final String string2 = bundle.getString("title");
        final String string3 = bundle.getString("summary");
        C10257f.m5673b(f31289a, "shareToMobileQQ -- imageUrl: " + string);
        if (TextUtils.isEmpty(string)) {
            m6068b(activity, bundle, iUiListener);
        } else if (!Util.isValidUrl(string)) {
            bundle.putString("imageUrl", null);
            if (SystemUtils.compareQQVersion(activity, SystemUtils.QQ_VERSION_NAME_4_3_0) < 0) {
                C10257f.m5673b(f31289a, "shareToMobileQQ -- QQ Version is < 4.3.0 ");
                m6068b(activity, bundle, iUiListener);
            } else {
                C10257f.m5673b(f31289a, "shareToMobileQQ -- QQ Version is > 4.3.0 ");
                C10146a.m6061a(activity, string, new AsynLoadImgBack() { // from class: com.tencent.connect.share.QQShare.2
                    ...
                    public void saved(int i, String str) {
                        if (i == 0) {
                            ...
                            if (iUiListener != null) {
                                ...
                                C10257f.m5667e(QQShare.f31289a, "shareToMobileQQ -- error: 获取分享图片失败!");
                            }
                            C10266d.m5641a().m5640a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, QQShare.this.mToken.getAppId(), String.valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, Constants.MSG_SHARE_GETIMG_ERROR);
                            return;
                        }
                        QQShare.this.m6068b(activity, bundle, iUiListener);
                    }
                });
            }
        } else if (TextUtils.isEmpty(string2) && TextUtils.isEmpty(string3)) {
            if (iUiListener != null) {
                ...
                C10257f.m5667e(f31289a, Constants.MSG_SHARE_NOSD_ERROR);
            }
            C10266d.m5641a().m5640a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.mToken.getAppId(), String.valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, Constants.MSG_SHARE_NOSD_ERROR);
            return;
        ...
        C10257f.m5670c(C10257f.f31917d, "shareToMobileQQ() -- end");
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: b */
    public void m6068b(Activity activity, Bundle bundle, IUiListener iUiListener) {
        C10257f.m5670c(C10257f.f31917d, "doShareToQQ() -- start");
        ...
        C10257f.m5676a(f31289a, "doShareToQQ -- openid: " + openId);
        if (!TextUtils.isEmpty(string)) {
        ...
        C10257f.m5676a(f31289a, "doShareToQQ -- url: " + stringBuffer.toString());
        ...
        if (SystemUtils.compareQQVersion(activity, SystemUtils.QQ_VERSION_NAME_4_6_0) < 0) {
            C10257f.m5670c(f31289a, "doShareToQQ, qqver below 4.6.");
            ...
            if (obj != null) {
                ...
                C10257f.m5670c(f31289a, "doShareToQQ, last listener is not null, cancel it.");
            }
            if (hasActivityForIntent()) {
        ...
        if (hasActivityForIntent()) {
            C10266d.m5641a().m5637a(this.mToken.getOpenId(), this.mToken.getAppId(), Constants.VIA_SHARE_TO_QQ, "10", "3", "0", this.mViaShareQQType, "0", "1", "0");
            C10266d.m5641a().m5640a(0, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.mToken.getAppId(), String.valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "");
        } else {
            C10266d.m5641a().m5637a(this.mToken.getOpenId(), this.mToken.getAppId(), Constants.VIA_SHARE_TO_QQ, "10", "3", "1", this.mViaShareQQType, "0", "1", "0");
            C10266d.m5641a().m5640a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.mToken.getAppId(), String.valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "hasActivityForIntent fail");
        }
        C10257f.m5670c(C10257f.f31917d, "doShareToQQ() --end");
    }

    /* renamed from: c */
    private void m6066c(Activity activity, Bundle bundle, IUiListener iUiListener) {
        C10257f.m5670c(C10257f.f31917d, "shareToH5QQ() -- start");
        Object obj = TemporaryStorage.set(SystemUtils.QQ_SHARE_CALLBACK_ACTION, iUiListener);
        if (obj != null) {
            C10257f.m5670c(f31289a, "shareToH5QQ, last listener is not null, cancel it.");
            ((IUiListener) obj).onCancel();
        }
        ...
        StringBuffer m6069a = m6069a(stringBuffer, bundle);
        ...
        bundle2.putString("url", m6069a.toString());
        ...
        C10266d.m5641a().m5640a(0, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.mToken.getAppId(), String.valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "shareToH5QQ");
        C10257f.m5670c(C10257f.f31917d, "shareToH5QQ() --end");
    }
    ...
    public void shareToQQ(Activity activity, Bundle bundle, IUiListener iUiListener) {
        C10257f.m5670c(f31289a, "shareToQQ() -- start.");
        String string = bundle.getString("imageUrl");
        String string2 = bundle.getString("title");
        String string3 = bundle.getString("summary");
        String string4 = bundle.getString("targetUrl");
        ...
        int i = bundle.getInt("req_type", 1);
        C10257f.m5670c(f31289a, "shareToQQ -- type: " + i);
        switch (i) {
            case 1:
        ...
        if (i == 6) {
            if (SystemUtils.compareQQVersion(activity, SystemUtils.QQ_VERSION_NAME_5_0_0) < 0) {
                ...
                C10257f.m5667e(f31289a, "shareToQQ, app share is not support below qq5.0.");
                C10266d.m5641a().m5640a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.mToken.getAppId(), String.valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "shareToQQ, app share is not support below qq5.0.");
                return;
            }
        ...
        if (!Util.hasSDCard() && SystemUtils.compareQQVersion(activity, SystemUtils.QQ_VERSION_NAME_4_5_0) < 0) {
            iUiListener.onError(new UiError(-6, Constants.MSG_SHARE_NOSD_ERROR, null));
            C10257f.m5667e(f31289a, "shareToQQ sdcard is null--end");
            C10266d.m5641a().m5640a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.mToken.getAppId(), String.valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "shareToQQ sdcard is null");
            return;
        }
        if (i == 5) {
            if (SystemUtils.compareQQVersion(activity, SystemUtils.QQ_VERSION_NAME_4_3_0) < 0) {
                iUiListener.onError(new UiError(-6, Constants.MSG_PARAM_QQ_VERSION_ERROR, null));
                C10257f.m5667e(f31289a, "shareToQQ, version below 4.3 is not support.");
                C10266d.m5641a().m5640a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.mToken.getAppId(), String.valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "shareToQQ, version below 4.3 is not support.");
                return;
            } else if (!Util.fileExists(string5)) {
                iUiListener.onError(new UiError(-6, Constants.MSG_PARAM_IMAGE_URL_FORMAT_ERROR, null));
                C10257f.m5667e(f31289a, "shareToQQ -- error: 非法的图片地址!");
                C10266d.m5641a().m5640a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.mToken.getAppId(), String.valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, Constants.MSG_PARAM_IMAGE_URL_FORMAT_ERROR);
                return;
            }
        }
        if (i != 5) {
            if (TextUtils.isEmpty(string4) || (!string4.startsWith("http://") && !string4.startsWith("https://"))) {
                ...
                C10257f.m5667e(f31289a, "shareToQQ, targetUrl is empty or illegal..");
                C10266d.m5641a().m5640a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.mToken.getAppId(), String.valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "shareToQQ, targetUrl is empty or illegal..");
                return;
            } else if (TextUtils.isEmpty(string2)) {
                iUiListener.onError(new UiError(-6, Constants.MSG_PARAM_TITLE_NULL_ERROR, null));
                C10257f.m5667e(f31289a, "shareToQQ, title is empty.");
                C10266d.m5641a().m5640a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.mToken.getAppId(), String.valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "shareToQQ, title is empty.");
                return;
            }
        }
        if (!TextUtils.isEmpty(string) && !string.startsWith("http://") && !string.startsWith("https://") && !new File(string).exists()) {
            iUiListener.onError(new UiError(-6, Constants.MSG_PARAM_IMAGE_URL_FORMAT_ERROR, null));
            C10257f.m5667e(f31289a, " shareToQQ, image url is emprty or illegal.");
            C10266d.m5641a().m5640a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.mToken.getAppId(), String.valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "shareToQQ, image url is emprty or illegal.");
            return;
        }
        ...
        if (Util.isMobileQQSupportShare(activity)) {
            m6072a(activity, bundle, iUiListener);
        } else {
            m6066c(activity, bundle, iUiListener);
        }
        C10257f.m5670c(f31289a, "shareToQQ() -- end.");
    }
}
