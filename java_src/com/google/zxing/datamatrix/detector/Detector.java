...
public final class Detector {
    ...
    public static class ResultPointsAndTransitions {
        ...
        /* renamed from: to */
        private final ResultPoint f30879to;
        private final int transitions;

        private ResultPointsAndTransitions(ResultPoint resultPoint, ResultPoint resultPoint2, int i) {
            this.from = resultPoint;
            this.f30879to = resultPoint2;
            this.transitions = i;
        }

        ResultPointsAndTransitions(ResultPoint resultPoint, ResultPoint resultPoint2, int i, C100081 c100081) {
        ...
        public String toString() {
            return new StringBuffer().append(this.from).append("/").append(this.f30879to).append('/').append(this.transitions).toString();
        }
    }
    ...
    private static class ResultPointsAndTransitionsComparator implements Comparator {
        ...
        ResultPointsAndTransitionsComparator(C100081 c100081) {
            this();
        }
