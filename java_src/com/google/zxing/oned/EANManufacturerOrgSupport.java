...
final class EANManufacturerOrgSupport {
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{385}, "HR");
            add(new int[]{387}, "BA");
            add(new int[]{C2954b.f10826ao, 440}, "DE");
            add(new int[]{AbstractC10866e.f34847n, 459}, "JP");
            ...
            add(new int[]{759}, "VE");
            add(new int[]{760, C1831e.f4786M}, "CH");
            add(new int[]{C1831e.f4787N}, "CO");
            add(new int[]{773}, "UY");
            add(new int[]{775}, "PE");
            add(new int[]{777}, "BO");
            add(new int[]{779}, "AR");
