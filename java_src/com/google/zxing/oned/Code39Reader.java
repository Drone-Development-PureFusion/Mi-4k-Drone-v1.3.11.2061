...
public final class Code39Reader extends OneDReader {
    ...
    static final int[] CHARACTER_ENCODINGS = {52, 289, 97, 352, 49, 304, 112, 37, 292, 100, 265, 73, 328, 25, 280, 88, 13, 268, 76, 28, 259, 67, 322, 19, TiffUtil.TIFF_TAG_ORIENTATION, 82, 7, MediaRouter.GlobalMediaRouter.CallbackHandler.MSG_ROUTE_SELECTED, 70, 22, 385, 193, 448, 145, C2954b.f10826ao, JfifUtil.MARKER_RST0, 133, 388, SmileConstants.MIN_BUFFER_FOR_POSSIBLE_SHORT_STRING, 148, 168, Opcodes.IF_ICMPGE, 138, 42};
        ...
        while (i2 < length) {
            ...
            if (charAt == '+' || charAt == '$' || charAt == '%' || charAt == '/') {
                ...
                switch (charAt) {
                    ...
                    case '+':
                        if (charAt2 >= 'A' && charAt2 <= 'Z') {
                            c = (char) (charAt2 + C11125l.f35805c);
                            break;
                        } else {
                            throw FormatException.getFormatInstance();
                        }
