...
final class FieldParser {
    ...
    private static String processFixedAI(int i, int i2, String str) {
        ...
        return new StringBuffer().append(C0494h.f731s).append(substring).append(C0494h.f732t).append(str.substring(i, i + i2)).append(parseFieldsInGeneralPurpose(str.substring(i + i2))).toString();
    }

    private static String processVariableAI(int i, int i2, String str) {
        String substring = str.substring(0, i);
        int length = str.length() < i + i2 ? str.length() : i + i2;
        return new StringBuffer().append(C0494h.f731s).append(substring).append(C0494h.f732t).append(str.substring(i, length)).append(parseFieldsInGeneralPurpose(str.substring(length))).toString();
    }
}
