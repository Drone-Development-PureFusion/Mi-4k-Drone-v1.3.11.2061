...
public final class GeneralAppIdDecoder {
    ...
    private DecodedChar decodeAlphanumeric(int i) {
        ...
        if (extractNumericValueFromBitArray == 15) {
            return new DecodedChar(i + 5, C0494h.f688I);
        }
        ...
        switch (extractNumericValueFromBitArray2) {
            ...
            case 59:
                return new DecodedChar(i + 6, C0494h.f736x);
            case 60:
                return new DecodedChar(i + 6, '-');
            case 61:
                return new DecodedChar(i + 6, C0494h.f686G);
            case 62:
                return new DecodedChar(i + 6, '/');
            default:
    ...
    private DecodedChar decodeIsoIec646(int i) {
        ...
        switch (extractNumericValueFromBitArray3) {
            ...
            case 233:
                return new DecodedChar(i + 8, '\"');
            case 234:
                return new DecodedChar(i + 8, C0494h.f730r);
            case 235:
                return new DecodedChar(i + 8, '&');
            case SmileConstants.TOKEN_MISC_SHARED_STRING_LONG /* 236 */:
                return new DecodedChar(i + 8, C0494h.f738z);
            case 237:
                return new DecodedChar(i + 8, C0494h.f731s);
            case 238:
                return new DecodedChar(i + 8, C0494h.f732t);
            case 239:
                return new DecodedChar(i + 8, '*');
            case 240:
                return new DecodedChar(i + 8, SignatureVisitor.EXTENDS);
            case 241:
                return new DecodedChar(i + 8, C0494h.f736x);
            case 242:
                return new DecodedChar(i + 8, '-');
            case 243:
                return new DecodedChar(i + 8, C0494h.f686G);
            case 244:
                return new DecodedChar(i + 8, '/');
            case 245:
                return new DecodedChar(i + 8, C0494h.f680A);
            case 246:
                return new DecodedChar(i + 8, ';');
            case 247:
                return new DecodedChar(i + 8, '<');
