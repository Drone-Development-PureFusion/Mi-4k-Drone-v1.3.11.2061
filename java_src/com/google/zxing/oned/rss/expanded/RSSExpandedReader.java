...
public final class RSSExpandedReader extends AbstractRSSReader {
    ...
    private boolean checkChecksum() {
        ...
        return (checksumPortion % AbstractC10866e.f34855v) + ((i + (-4)) * AbstractC10866e.f34855v) == leftChar.getValue();
    }
