...
public class JsonReader implements Closeable {
    ...
    private boolean fillBuffer(int i) {
        ...
        this.pos = 0;
        do {
            int read = this.f30876in.read(cArr, this.limit, cArr.length - this.limit);
            if (read == -1) {
                return false;
            }
    ...
    */
    ...
    public double nextDouble() {
        ...
        if (i == 16) {
            ...
            this.peekedString = nextQuotedValue(i == 8 ? C0494h.f738z : '\"');
        } else if (i == 10) {
    ...
    public String nextName() {
        ...
        if (i == 14) {
            ...
            nextQuotedValue = nextQuotedValue(C0494h.f738z);
        } else if (i != 13) {
    ...
    public String nextString() {
        ...
        if (i == 10) {
            ...
            str = nextQuotedValue(C0494h.f738z);
        } else if (i == 9) {
            str = nextQuotedValue('\"');
        } else if (i == 11) {
