...
public final class MapTypeAdapterFactory implements TypeAdapterFactory {
    ...
    private final class Adapter<K, V> extends TypeAdapter<Map<K, V>> {
        ...
        public Map<K, V> mo40146read(JsonReader jsonReader) {
            ...
            if (peek != JsonToken.BEGIN_ARRAY) {
                ...
                while (jsonReader.hasNext()) {
                    ...
                    K mo40146read = this.keyTypeAdapter.mo40146read(jsonReader);
                    if (construct.put(mo40146read, this.valueTypeAdapter.mo40146read(jsonReader)) != null) {
                        throw new JsonSyntaxException("duplicate key: " + mo40146read);
                    }
                }
            ...
            while (jsonReader.hasNext()) {
                jsonReader.beginArray();
                K mo40146read2 = this.keyTypeAdapter.mo40146read(jsonReader);
                if (construct.put(mo40146read2, this.valueTypeAdapter.mo40146read(jsonReader)) != null) {
                    throw new JsonSyntaxException("duplicate key: " + mo40146read2);
                }
                jsonReader.endArray();
            }
            jsonReader.endArray();
