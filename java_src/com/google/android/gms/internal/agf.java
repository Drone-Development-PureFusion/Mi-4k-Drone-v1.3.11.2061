...
public class agf extends AbstractC4294a {
    ...
    /* renamed from: c */
    private final View.OnClickListener f21565c = new View.OnClickListener() { // from class: com.google.android.gms.internal.agf.1
    ...
    private void m17682e() {
        ...
        if (m24529g.m25042o() == 0) {
            ...
            z = m25052e != null && m25052e.intValue() < m24529g.m25040q() + (-1);
        } else {
            z = true;
        }
        if (!z || a.m24514u()) {
            this.f21563a.setVisibility(this.f21564b);
            this.f21563a.setClickable(false);
            this.f21563a.setEnabled(false);
            return;
        }
        this.f21563a.setVisibility(0);
        this.f21563a.setClickable(true);
        this.f21563a.setEnabled(true);
    }
    ...
    public void mo17672a(C4253d c4253d) {
        ...
        this.f21563a.setOnClickListener(this.f21565c);
        m17682e();
    }
    ...
    public void mo17671b() {
        this.f21563a.setOnClickListener(null);
        super.mo17671b();
    }
