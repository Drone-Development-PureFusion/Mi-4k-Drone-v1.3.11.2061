...
public class aqp extends aqg {
    ...
    protected AbstractC6880ea<?> mo13115a(apr aprVar, AbstractC6880ea<?>... abstractC6880eaArr) {
        ...
        for (int i = 0; i < size && i < c6887ef.mo16034b().size(); i++) {
            AbstractC6880ea<?> abstractC6880ea = null;
            if (c6887ef.m16048c(i)) {
                AbstractC6880ea<?> mo12846a_ = ((aqe) c6885ed.mo16034b()).mo12846a_(aprVar, mo16034b.get(i), new C6884ec(Double.valueOf(i)), c6887ef);
                C4588d.m23623a(!C6895ek.m16019d(mo12846a_));
