...
public class DefaultDiskStorage implements DiskStorage {
    ...
    public class EntryImpl implements DiskStorage.Entry {
        ...
        public FileBinaryResource mo40052getResource() {
    ...
    private DiskStorage.DiskDumpInfoEntry dumpCacheEntry(DiskStorage.Entry entry) {
        ...
        String str = "";
        byte[] read = entryImpl.mo40052getResource().read();
        ...
        return new DiskStorage.DiskDumpInfoEntry(entryImpl.mo40052getResource().getFile().getPath(), typeOfBytes, (float) entryImpl.getSize(), str);
    }
    ...
    public FileBinaryResource mo40048commit(String str, BinaryResource binaryResource, Object obj) {
    ...
    public FileBinaryResource mo40049createTemporary(String str, Object obj) {
    ...
    public DiskStorage.DiskDumpInfo getDumpInfo() {
        List<DiskStorage.Entry> mo40050getEntries = mo40050getEntries();
        DiskStorage.DiskDumpInfo diskDumpInfo = new DiskStorage.DiskDumpInfo();
        for (DiskStorage.Entry entry : mo40050getEntries) {
    ...
    public List<DiskStorage.Entry> mo40050getEntries() {
    ...
    @Override // com.facebook.cache.disk.DiskStorage
    /* renamed from: getResource  reason: collision with other method in class */
    public FileBinaryResource mo40051getResource(String str, Object obj) {
        File contentFileFor = getContentFileFor(str);
        if (contentFileFor.exists()) {
            contentFileFor.setLastModified(this.mClock.now());
            return FileBinaryResource.createOrNull(contentFileFor);
    ...
    public long remove(DiskStorage.Entry entry) {
        return doRemove(((EntryImpl) entry).mo40052getResource().getFile());
    }
