...
public class BouncyConversion {
    ...
    public BouncyConversion(double d, double d2) {
        this.mSpeed = d;
        this.mBounciness = d2;
        double project_normal = project_normal(normalize(d2 / 1.7d, C9755a.f30449c, 20.0d), C9755a.f30449c, 0.8d);
        this.mBouncyTension = project_normal(normalize(d / 1.7d, C9755a.f30449c, 20.0d), 0.5d, 200.0d);
