...
public class SimpleDraweeView extends GenericDraweeView {
    ...
    private void init() {
        ...
        this.mSimpleDraweeControllerBuilder = sDraweeControllerBuilderSupplier.mo40100get();
    }
    ...
    public void setImageURI(Uri uri, @Nullable Object obj) {
        setController(this.mSimpleDraweeControllerBuilder.mo40068setCallerContext(obj).mo40064setUri(uri).mo40069setOldController(getController()).mo40067build());
    }
}
