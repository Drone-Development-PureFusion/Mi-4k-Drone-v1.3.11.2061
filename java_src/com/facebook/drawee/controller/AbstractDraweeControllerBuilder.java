...
public abstract class AbstractDraweeControllerBuilder<BUILDER extends AbstractDraweeControllerBuilder<BUILDER, REQUEST, IMAGE, INFO>, REQUEST, IMAGE, INFO> implements SimpleDraweeControllerBuilder {
    ...
    /* renamed from: build */
    public AbstractDraweeController mo40067build() {
        validate();
    ...
    protected AbstractDraweeController buildController() {
        AbstractDraweeController mo40063obtainController = mo40063obtainController();
        mo40063obtainController.setRetainImageOnFailure(getRetainImageOnFailure());
        maybeBuildAndSetRetryManager(mo40063obtainController);
        maybeAttachListeners(mo40063obtainController);
        return mo40063obtainController;
    }
    ...
    protected Supplier<DataSource<IMAGE>> getDataSourceSupplierForRequest(final REQUEST request, final boolean z) {
        ...
        return new Supplier<DataSource<IMAGE>>() { // from class: com.facebook.drawee.controller.AbstractDraweeControllerBuilder.2
            ...
            /* renamed from: get */
            public DataSource<IMAGE> mo40100get() {
    ...
    protected abstract BUILDER mo40062getThis();
    ...
    protected abstract AbstractDraweeController mo40063obtainController();
    ...
    public BUILDER mo40068setCallerContext(Object obj) {
    ...
    public BUILDER mo40069setOldController(@Nullable DraweeController draweeController) {
