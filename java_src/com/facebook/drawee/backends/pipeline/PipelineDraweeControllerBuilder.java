...
public class PipelineDraweeControllerBuilder extends AbstractDraweeControllerBuilder<PipelineDraweeControllerBuilder, ImageRequest, CloseableReference<CloseableImage>, ImageInfo> {
    ...
    public PipelineDraweeControllerBuilder mo40062getThis() {
        return this;
    }
    ...
    public PipelineDraweeController mo40063obtainController() {
    ...
    /* renamed from: setUri */
    public PipelineDraweeControllerBuilder mo40064setUri(Uri uri) {
        return (PipelineDraweeControllerBuilder) super.setImageRequest(ImageRequest.fromUri(uri));
    }

    @Override // com.facebook.drawee.interfaces.SimpleDraweeControllerBuilder
    /* renamed from: setUri */
    public PipelineDraweeControllerBuilder mo40065setUri(@Nullable String str) {
