...
public class NativePooledByteBufferOutputStream extends PooledByteBufferOutputStream {
    ...
    public NativePooledByteBufferOutputStream(NativeMemoryChunkPool nativeMemoryChunkPool, int i) {
        ...
        this.mCount = 0;
        this.mBufRef = CloseableReference.m35506of(this.mPool.get(i), this.mPool);
    }
    ...
    void realloc(int i) {
        ...
        this.mBufRef.close();
        this.mBufRef = CloseableReference.m35506of(nativeMemoryChunk, this.mPool);
    }
    ...
    public NativePooledByteBuffer mo40094toByteBuffer() {
        ensureValid();
