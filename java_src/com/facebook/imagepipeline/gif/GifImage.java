...
public class GifImage implements AnimatedImage {
    ...
    public GifFrame mo40103getFrame(int i) {
    ...
    public AnimatedDrawableFrameInfo getFrameInfo(int i) {
        GifFrame mo40103getFrame = mo40103getFrame(i);
        try {
            return new AnimatedDrawableFrameInfo(i, mo40103getFrame.getXOffset(), mo40103getFrame.getYOffset(), mo40103getFrame.getWidth(), mo40103getFrame.getHeight(), true, fromGifDisposalMethod(mo40103getFrame.getDisposalMode()));
        } finally {
