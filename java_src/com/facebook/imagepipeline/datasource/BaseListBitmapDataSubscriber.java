...
public abstract class BaseListBitmapDataSubscriber extends BaseDataSubscriber<List<CloseableReference<CloseableImage>>> {
    ...
    public void onNewResultImpl(DataSource<List<CloseableReference<CloseableImage>>> dataSource) {
        ...
        List<CloseableReference<CloseableImage>> mo40083getResult = dataSource.mo40083getResult();
        if (mo40083getResult == null) {
            onNewResultListImpl(null);
            return;
        }
        try {
            ArrayList arrayList = new ArrayList(mo40083getResult.size());
            for (CloseableReference<CloseableImage> closeableReference : mo40083getResult) {
            ...
            for (CloseableReference<CloseableImage> next : mo40083getResult) {
