...
public class ResizeAndRotateProducer implements Producer<EncodedImage> {
    ...
    private class TransformingConsumer extends DelegatingConsumer<EncodedImage, EncodedImage> {
        ...
        public void doTransform(EncodedImage encodedImage, boolean z) {
            ...
            PooledByteBufferOutputStream mo40092newOutputStream = ResizeAndRotateProducer.this.mPooledByteBufferFactory.mo40092newOutputStream();
            try {
                try {
                    ...
                    try {
                        JpegTranscoder.transcodeJpeg(encodedImage.getInputStream(), mo40092newOutputStream, ResizeAndRotateProducer.getRotationAngle(imageRequest, encodedImage), scaleNumerator, 85);
                        CloseableReference m35507of = CloseableReference.m35507of(mo40092newOutputStream.mo40094toByteBuffer());
                        try {
                            EncodedImage encodedImage2 = new EncodedImage(m35507of);
        ...
        private Map<String, String> getExtraMap(EncodedImage encodedImage, ImageRequest imageRequest, int i) {
            ...
            return ImmutableMap.m35585of(ResizeAndRotateProducer.ORIGINAL_SIZE_KEY, encodedImage.getWidth() + "x" + encodedImage.getHeight(), ResizeAndRotateProducer.REQUESTED_SIZE_KEY, imageRequest.getResizeOptions() != null ? imageRequest.getResizeOptions().width + "x" + imageRequest.getResizeOptions().height : "Unspecified", ResizeAndRotateProducer.FRACTION_KEY, i > 0 ? i + "/8" : "", "queueTime", String.valueOf(this.mJobScheduler.getQueuedTime()));
        }
