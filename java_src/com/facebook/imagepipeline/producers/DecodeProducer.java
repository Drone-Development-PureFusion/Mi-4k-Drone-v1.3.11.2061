...
public class DecodeProducer implements Producer<CloseableReference<CloseableImage>> {
    ...
    private class LocalImagesProgressiveDecoder extends ProgressiveDecoder {
        ...
        protected QualityInfo getQualityInfo() {
            return ImmutableQualityInfo.m35502of(0, false, false);
        }
    ...
    private abstract class ProgressiveDecoder extends DelegatingConsumer<EncodedImage, CloseableReference<CloseableImage>> {
        ...
        private Map<String, String> getExtraMap(@Nullable CloseableImage closeableImage, long j, QualityInfo qualityInfo, boolean z) {
            ...
            if (!(closeableImage instanceof CloseableStaticBitmap)) {
                return ImmutableMap.m35586of("queueTime", valueOf, DecodeProducer.HAS_GOOD_QUALITY_KEY, valueOf2, DecodeProducer.IS_FINAL_KEY, valueOf3);
            }
            Bitmap underlyingBitmap = ((CloseableStaticBitmap) closeableImage).getUnderlyingBitmap();
            return ImmutableMap.m35585of(DecodeProducer.BITMAP_SIZE_KEY, underlyingBitmap.getWidth() + "x" + underlyingBitmap.getHeight(), "queueTime", valueOf, DecodeProducer.HAS_GOOD_QUALITY_KEY, valueOf2, DecodeProducer.IS_FINAL_KEY, valueOf3);
        }
        ...
        private void handleResult(CloseableImage closeableImage, boolean z) {
            CloseableReference<CloseableImage> m35507of = CloseableReference.m35507of(closeableImage);
            try {
                maybeFinish(z);
                getConsumer().onNewResult(m35507of, z);
            } finally {
