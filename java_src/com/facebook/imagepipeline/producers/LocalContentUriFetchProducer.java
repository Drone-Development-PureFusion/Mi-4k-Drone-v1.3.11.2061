...
public class LocalContentUriFetchProducer extends LocalFetchProducer {
    ...
    private static final String[] PROJECTION = {AbstractC10446k._ID, "_data"};
        ...
        if (query != null) {
            try {
                if (query.getCount() != 0) {
                    ...
                    if (resizeOptions != null && (thumbnail = getThumbnail(resizeOptions, query.getInt(query.getColumnIndex(AbstractC10446k._ID)))) != null) {
    ...
    private static int getRotationAngle(String str) {
        if (str != null) {
            try {
                ...
                FLog.m35562e(TAG, e, "Unable to retrieve thumbnail rotation for %s", str);
                return 0;
            }
        }
        return 0;
