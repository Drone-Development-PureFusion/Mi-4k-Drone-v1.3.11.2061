...
public class DiskCacheProducer implements Producer<EncodedImage> {
    ...
    static Map<String, String> getExtraMap(ProducerListener producerListener, String str, boolean z) {
        ...
        return ImmutableMap.m35588of(VALUE_FOUND, String.valueOf(z));
    }
    ...
    public void produceResults(final Consumer<EncodedImage> consumer, final ProducerContext producerContext) {
        ...
        AbstractC0016j abstractC0016j = new AbstractC0016j<EncodedImage, Void>() { // from class: com.facebook.imagepipeline.producers.DiskCacheProducer.1
            ...
            public Void mo40096then(C0018l<EncodedImage> c0018l) {
                if (c0018l.m39917c() || (c0018l.m39912d() && (c0018l.m39907f() instanceof CancellationException))) {
                    listener.onProducerFinishWithCancellation(id, DiskCacheProducer.PRODUCER_NAME, null);
                    consumer.onCancellation();
                } else if (c0018l.m39912d()) {
                    listener.onProducerFinishWithFailure(id, DiskCacheProducer.PRODUCER_NAME, c0018l.m39907f(), null);
                    ...
                    EncodedImage m39908e = c0018l.m39908e();
                    if (m39908e != null) {
                        ...
                        consumer.onNewResult(m39908e, true);
                        m39908e.close();
                    } else {
        ...
        bufferedDiskCache.get(encodedCacheKey, atomicBoolean).m39938a(abstractC0016j);
