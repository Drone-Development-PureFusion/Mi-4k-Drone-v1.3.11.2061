...
public class ImagePipeline {
    ...
    public Supplier<DataSource<CloseableReference<CloseableImage>>> getDataSourceSupplier(final ImageRequest imageRequest, final Object obj, final boolean z) {
        return new Supplier<DataSource<CloseableReference<CloseableImage>>>() { // from class: com.facebook.imagepipeline.core.ImagePipeline.1
            ...
            /* renamed from: get */
            public DataSource<CloseableReference<CloseableImage>> mo40100get() {
    ...
    public Supplier<DataSource<CloseableReference<PooledByteBuffer>>> getEncodedImageDataSourceSupplier(final ImageRequest imageRequest, final Object obj) {
        return new Supplier<DataSource<CloseableReference<PooledByteBuffer>>>() { // from class: com.facebook.imagepipeline.core.ImagePipeline.2
            ...
            @Override // com.facebook.common.internal.Supplier
            /* renamed from: get */
            public DataSource<CloseableReference<PooledByteBuffer>> mo40100get() {
    ...
    public DataSource<Boolean> isInDiskCache(ImageRequest imageRequest) {
        ...
        this.mMainBufferedDiskCache.contains(encodedCacheKey).m39923b(new AbstractC0016j<Boolean, C0018l<Boolean>>() { // from class: com.facebook.imagepipeline.core.ImagePipeline.6
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // p000a.AbstractC0016j
            /* renamed from: then */
            public C0018l<Boolean> mo40096then(C0018l<Boolean> c0018l) {
                return (c0018l.m39917c() || c0018l.m39912d() || !c0018l.m39908e().booleanValue()) ? ImagePipeline.this.mSmallImageBufferedDiskCache.contains(encodedCacheKey) : C0018l.m39930a(true);
            }
        }).m39938a((AbstractC0016j<TContinuationResult, TContinuationResult>) new AbstractC0016j<Boolean, Void>() { // from class: com.facebook.imagepipeline.core.ImagePipeline.5
            @Override // p000a.AbstractC0016j
            /* renamed from: then  reason: avoid collision after fix types in other method */
            public Void mo40096then(C0018l<Boolean> c0018l) {
                create.setResult(Boolean.valueOf(!c0018l.m39917c() && !c0018l.m39912d() && c0018l.m39908e().booleanValue()));
                return null;
            }
        });
        return create;
    ...
    public DataSource<Void> prefetchToBitmapCache(ImageRequest imageRequest, Object obj) {
        if (!this.mIsPrefetchEnabledSupplier.mo40100get().booleanValue()) {
