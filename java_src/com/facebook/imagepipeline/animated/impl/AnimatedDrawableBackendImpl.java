...
public class AnimatedDrawableBackendImpl implements AnimatedDrawableBackend {
    ...
    public AnimatedDrawableBackend mo40071forNewBounds(Rect rect) {
    ...
    public void renderFrame(int i, Canvas canvas) {
        AnimatedImageFrame mo40103getFrame = this.mAnimatedImage.mo40103getFrame(i);
        try {
            if (this.mAnimatedImage.doesRenderSupportScaling()) {
                renderImageSupportsScaling(canvas, mo40103getFrame);
            } else {
                renderImageDoesNotSupportScaling(canvas, mo40103getFrame);
            }
        } finally {
