...
public final class CloseableReference<T> implements Closeable, Cloneable {
    ...
    @Nullable
    /* renamed from: of */
    public static CloseableReference m35507of(@Nullable Closeable closeable) {
        if (closeable == null) {
            return null;
        }
    ...
    @Nullable
    /* renamed from: of */
    public static <T> CloseableReference<T> m35506of(@Nullable T t, ResourceReleaser<T> resourceReleaser) {
        if (t == null) {
            return null;
        }
    ...
    /* renamed from: clone */
    public synchronized CloseableReference<T> m40058clone() {
    ...
    protected void finalize() {
        try {
            synchronized (this) {
                ...
                FLog.m35523w(TAG, "Finalized without closing: %x %x (type = %s)", Integer.valueOf(System.identityHashCode(this)), Integer.valueOf(System.identityHashCode(this.mSharedReference)), this.mSharedReference.get().getClass().getSimpleName());
                close();
            }
        } finally {
            super.finalize();
