...
public class HandlerExecutorServiceImpl extends AbstractExecutorService implements HandlerExecutorService {
    ...
    public <T> ScheduledFutureImpl<T> mo40054newTaskFor(Callable<T> callable) {
        return new ScheduledFutureImpl<>(this.mHandler, callable);
    }

    @Override // java.util.concurrent.AbstractExecutorService
    /* renamed from: newTaskFor  reason: collision with other method in class */
    protected /* bridge */ /* synthetic */ RunnableFuture mo40053newTaskFor(Runnable runnable, Object obj) {
    ...
    public <V> ScheduledFuture<V> schedule(Callable<V> callable, long j, TimeUnit timeUnit) {
        ScheduledFutureImpl mo40054newTaskFor = mo40054newTaskFor((Callable) callable);
        this.mHandler.postDelayed(mo40054newTaskFor, timeUnit.toMillis(j));
        return mo40054newTaskFor;
    }
    ...
    public /* bridge */ /* synthetic */ Future submit(Runnable runnable, Object obj) {
        return mo40056submit(runnable, (Runnable) obj);
    }

    @Override // java.util.concurrent.AbstractExecutorService, java.util.concurrent.ExecutorService
    public ScheduledFuture<?> submit(Runnable runnable) {
        return mo40056submit(runnable, (Runnable) null);
    }

    @Override // java.util.concurrent.AbstractExecutorService, java.util.concurrent.ExecutorService
    /* renamed from: submit  reason: collision with other method in class */
    public <T> ScheduledFuture<T> mo40056submit(Runnable runnable, @Nullable T t) {
        if (runnable == null) {
    ...
    public <T> ScheduledFuture<T> submit(Callable<T> callable) {
        ...
        ScheduledFutureImpl<T> mo40054newTaskFor = mo40054newTaskFor((Callable) callable);
        execute(mo40054newTaskFor);
        return mo40054newTaskFor;
    }
}
