...
public class FirstAvailableDataSourceSupplier<T> implements Supplier<DataSource<T>> {
    ...
    public class FirstAvailableDataSource extends AbstractDataSource<T> {
        ...
        private boolean startNextDataSource() {
            ...
            DataSource<T> mo40100get = nextSupplier != null ? nextSupplier.mo40100get() : null;
            if (!setCurrentDataSource(mo40100get) || mo40100get == null) {
                closeSafely(mo40100get);
                return false;
            }
            mo40100get.subscribe(new InternalDataSubscriber(), CallerThreadExecutor.getInstance());
            return true;
        }
        ...
        public synchronized T mo40083getResult() {
            DataSource<T> dataSourceWithResult;
            dataSourceWithResult = getDataSourceWithResult();
            return dataSourceWithResult != null ? dataSourceWithResult.mo40083getResult() : null;
        }
    ...
    /* renamed from: get */
    public DataSource<T> mo40100get() {
