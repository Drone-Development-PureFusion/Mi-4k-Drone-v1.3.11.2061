...
public class C10612ah {

    /* renamed from: b */
    private static volatile C10612ah f32989b;

    /* renamed from: a */
    protected SharedPreferences f32990a;

    private C10612ah(Context context) {
        this.f32990a = context.getSharedPreferences(MiPushClient.PREF_EXTRA, 0);
    }

    /* renamed from: a */
    public static C10612ah m4394a(Context context) {
        if (f32989b == null) {
            synchronized (C10612ah.class) {
                if (f32989b == null) {
                    f32989b = new C10612ah(context);
                }
            }
        }
        return f32989b;
    ...
    public int m4397a(int i, int i2) {
        ...
        if (this.f32990a.contains(m4391b)) {
            return this.f32990a.getInt(m4391b, 0);
        }
        String m4398a = m4398a(i);
        return this.f32990a.contains(m4398a) ? this.f32990a.getInt(m4398a, 0) : i2;
    }
    ...
    public String m4396a(int i, String str) {
        String m4391b = m4391b(i);
        if (this.f32990a.contains(m4391b)) {
            return this.f32990a.getString(m4391b, null);
        }
        String m4398a = m4398a(i);
        return this.f32990a.contains(m4398a) ? this.f32990a.getString(m4398a, null) : str;
    }
    ...
    public boolean m4395a(int i, boolean z) {
        String m4391b = m4391b(i);
        if (this.f32990a.contains(m4391b)) {
            return this.f32990a.getBoolean(m4391b, false);
        }
        String m4398a = m4398a(i);
        return this.f32990a.contains(m4398a) ? this.f32990a.getBoolean(m4398a, false) : z;
    }
