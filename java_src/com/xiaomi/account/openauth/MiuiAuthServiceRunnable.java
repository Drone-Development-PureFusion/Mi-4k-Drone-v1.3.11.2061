...
abstract class MiuiAuthServiceRunnable<V> extends XiaomiOAuthRunnable<V> implements ServiceConnection {
    ...
    public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
        try {
            try {
                this.mFuture.set(mo40166talkWithMiuiV6(IXiaomiAuthService.Stub.asInterface(iBinder)));
                this.context.unbindService(this);
            } catch (SecurityException e) {
                try {
                    this.mFuture.set(mo40165talkWithMiuiV5(AbstractC10843a.AbstractBinderC10844a.m3152a(iBinder)));
    ...
    protected abstract V mo40165talkWithMiuiV5(AbstractC10843a abstractC10843a);

    /* renamed from: talkWithMiuiV6 */
    protected abstract V mo40166talkWithMiuiV6(IXiaomiAuthService iXiaomiAuthService);
}
