...
import p271d.p272a.AbstractC10843a;
...
public class XiaomiOAuthorize {
    ...
    public static /* synthetic */ class C103868 {

        /* renamed from: $SwitchMap$com$xiaomi$account$openauth$XiaomiOAuthorize$OAuthStage */
        static final /* synthetic */ int[] f32316x6d96e761 = new int[OAuthStage.values().length];

        static {
            try {
                f32316x6d96e761[OAuthStage.INIT.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f32316x6d96e761[OAuthStage.ADD_SYSTEM_ACCOUNT.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f32316x6d96e761[OAuthStage.OAUTH_FROM_MIUI.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f32316x6d96e761[OAuthStage.OAUTH_FROM_MIUI_WITH_RESPONSE.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f32316x6d96e761[OAuthStage.OAUTH_FROM_3RD_PARTY.ordinal()] = 5;
    ...
    public static class XiaomiTokenFuture extends FutureTask<Bundle> {
        ...
        /* renamed from: get */
        public Bundle mo40167get() {
            throw new IllegalStateException("this should never be called");
        }

        @Override // java.util.concurrent.FutureTask, java.util.concurrent.Future
        /* renamed from: get */
        public Bundle mo40168get(long j, TimeUnit timeUnit) {
            throw new IllegalStateException("this should never be called");
        }
    ...
    public static Bundle getAccessTokenFromMiui(Context context, Account account, Bundle bundle) {
        return new MiuiAuthServiceRunnable<Bundle>(context, account, bundle) { // from class: com.xiaomi.account.openauth.XiaomiOAuthorize.4
            ...
            public Bundle mo40165talkWithMiuiV5(AbstractC10843a abstractC10843a) {
                abstractC10843a.mo3147d(this.account, this.options);
                return abstractC10843a.mo3149b(this.account, this.options);
            }
            ...
            public Bundle mo40166talkWithMiuiV6(IXiaomiAuthService iXiaomiAuthService) {
    ...
    public static boolean isMiui(Context context) {
        try {
            return new MiuiAuthServiceRunnable<Boolean>(context, null, null) { // from class: com.xiaomi.account.openauth.XiaomiOAuthorize.5
                ...
                @Override // com.xiaomi.account.openauth.MiuiAuthServiceRunnable
                /* renamed from: talkWithMiuiV5 */
                public Boolean mo40165talkWithMiuiV5(AbstractC10843a abstractC10843a) {
                    return true;
                }
                ...
                @Override // com.xiaomi.account.openauth.MiuiAuthServiceRunnable
                /* renamed from: talkWithMiuiV6 */
                public Boolean mo40166talkWithMiuiV6(IXiaomiAuthService iXiaomiAuthService) {
                    return true;
                }
        ...
        if (!TextUtils.isEmpty(str)) {
            return new XiaomiOAuthRunnable<XiaomiOAuthResults>() { // from class: com.xiaomi.account.openauth.XiaomiOAuthorize.2
                ...
                private void run(XiaomiTokenFuture xiaomiTokenFuture) {
                    ...
                    while (true) {
                        switch (C103868.f32316x6d96e761[oAuthStage.ordinal()]) {
                            case 1:
            ...
            public void onPostExecute(XiaomiOAuthResults xiaomiOAuthResults) {
                ...
                if (xiaomiOAuthResults == null) {
                    if (this.f32315e == null) {
                        ...
                        bundle2.putString(XiaomiOAuthConstants.EXTRA_ERROR_DESCRIPTION_2, this.f32315e.getMessage());
                    }
