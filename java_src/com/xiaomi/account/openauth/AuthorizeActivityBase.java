...
public abstract class AuthorizeActivityBase extends Activity {
                ...
                if (indexOf > 0) {
                    ...
                    if (indexOf2 > 0) {
                        ...
                        if (substring2.startsWith("access_token=") || substring2.contains("&access_token=")) {
                            AuthorizeActivityBase.this.setResultAndFinish(AuthorizeActivityBase.RESULT_SUCCESS, str2.replace("#", C0363a.f360a));
                            return true;
                        } else if (substring2.startsWith("error=") || substring2.contains("&error=")) {
                            AuthorizeActivityBase.this.setResultAndFinish(AuthorizeActivityBase.RESULT_FAIL, str2.replace("#", C0363a.f360a));
                            return true;
                        }
                    }
                }
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.mUrl = AUTHORIZE_PATH + C0363a.f360a + parseBundle(addLocaleIfNeeded);
