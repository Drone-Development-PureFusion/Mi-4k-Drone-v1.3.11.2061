...
public class WXMusicObject implements WXMediaMessage.IMediaObject {
    ...
    public boolean checkArgs() {
        if (TextUtils.isEmpty(this.musicUrl) && TextUtils.isEmpty(this.musicLowBandUrl)) {
            C0831d.m37772a().m6200d("both musicUrl and musicLowBandUrl are null", new Object[0]);
            return false;
        } else if (this.musicUrl != null && this.musicUrl.length() > 10240) {
            C0831d.m37772a().m6200d("checkArgs fail, musicUrl is too long", new Object[0]);
            return false;
        } else if (this.musicLowBandUrl == null || this.musicLowBandUrl.length() <= 10240) {
            return true;
        } else {
            C0831d.m37772a().m6200d("checkArgs fail, musicLowBandUrl is too long", new Object[0]);
            return false;
        }
    }
